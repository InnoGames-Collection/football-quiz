...
import{c as Pe}from"./supabase-kic3bLQH.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))i(a);new MutationObserver(a=>{for(const r of a)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function t(a){const r={};return a.integrity&&(r.integrity=a.integrity),a.referrerPolicy&&(r.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?r.credentials="include":a.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(a){if(a.ep)return;a.ep=!0;const r=t(a);fetch(a.href,r)}})();const Re="modulepreload",Fe=function(p){return"/"+p},Te={},de=function(e,t,i){let a=Promise.resolve();if(t&&t.length>0){let n=function(c){return Promise.all(c.map(d=>Promise.resolve(d).then(h=>({status:"fulfilled",value:h}),h=>({status:"rejected",reason:h}))))};document.getElementsByTagName("link");const s=document.querySelector("meta[property=csp-nonce]"),l=s?.nonce||s?.getAttribute("nonce");a=n(t.map(c=>{if(c=Fe(c),c in Te)return;Te[c]=!0;const d=c.endsWith(".css"),h=d?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${h}`))return;const u=document.createElement("link");if(u.rel=d?"stylesheet":Re,d||(u.as="script"),u.crossOrigin="",u.href=c,l&&u.setAttribute("nonce",l),document.head.appendChild(u),d)return new Promise((f,x)=>{u.addEventListener("load",f),u.addEventListener("error",()=>x(new Error(`Unable to preload CSS for ${c}`)))})}))}function r(n){const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=n,window.dispatchEvent(s),!s.defaultPrevented)throw n}return a.then(n=>{for(const s of n||[])s.status==="rejected"&&r(s.reason);return e().catch(r)})};class De{_container;constructor(){let e=document.getElementById("ui-root");e||(e=document.createElement("div"),e.id="ui-root",e.style.position="absolute",e.style.top="0",e.style.left="0",e.style.width="100%",e.style.height="100%",e.style.pointerEvents="none",e.style.fontFamily="system-ui, -apple-system, sans-serif",document.body.appendChild(e)),this._container=e}get container(){return this._container}clear(){this._container.innerHTML="",this._container.classList.remove("page-transition-enter"),this._container.offsetWidth,this._container.classList.add("page-transition-enter")}}const Ie="https://eywvrsqiqvmiktovaxmq.supabase.co",Ne="sb_publishable_vSzKiN0dx8mgRRb3jsDonQ_BesE-gSx";class X{static _instance=null;_client=null;constructor(){try{this._client=Pe(Ie,Ne,{auth:{autoRefreshToken:!0,persistSession:!0,detectSessionInUrl:!0,storage:window.sessionStorage},realtime:{params:{eventsPerSecond:10}}}),console.log("[SupabaseClient] Initialized successfully with URL:",Ie)}catch(e){console.error("[SupabaseClient] Failed to initialize Supabase client:",e),this._client=null}}static getInstance(){return X._instance||(X._instance=new X),X._instance}get client(){return this._client}get isOnline(){return this._client!==null}}const _=X.getInstance(),m=_.client,He=Object.freeze(Object.defineProperty({__proto__:null,supabase:m,supabaseService:_},Symbol.toStringTag,{value:"Module"}));class Ce{_profile;_cloudUserId=null;constructor(){this._profile=this._defaultProfile()}get cloudUserId(){return this._cloudUserId}_defaultProfile(){return{username:"Player",coins:0,xp:0,highScores:{"football-quiz":0},unlockedItems:["default-ball","default-jersey"],eloRating:0,streakCount:0,totalMatches:0,totalWins:0}}syncWithCloudUser(e){this._cloudUserId=e.id,this._profile.username=e.username,this._profile.coins=e.coins,this._profile.xp=e.xp,this._profile.eloRating=e.elo_rating,this._profile.streakCount=e.streak_count,this._profile.totalMatches=e.total_matches,this._profile.totalWins=e.total_wins,e.phone&&(this._profile.phone=e.phone),this.save()}save(){const e=_.client;if(this._cloudUserId&&e){let t=0;if(this._profile.highScores)for(const i in this._profile.highScores)t+=this._profile.highScores[i];e.from("users").update({username:this._profile.username,coins:this._profile.coins,xp:this._profile.xp,score:t,elo_rating:this._profile.eloRating||0,streak_count:this._profile.streakCount||0,total_matches:this._profile.totalMatches||0,total_wins:this._profile.totalWins||0,last_active:new Date().toISOString()}).eq("id",this._cloudUserId).then(({error:i})=>{i&&console.error("[SaveManager] Error syncing profile to cloud:",i)})}}get profile(){return this._profile}updateUsername(e){this._profile.username=e,this.save()}updateHighScore(e,t){const i=this._profile.highScores[e]||0;return t>i?(this._profile.highScores[e]=t,this._profile.xp+=Math.floor(t*.5),this.save(),!0):!1}addCoins(e){this._profile.coins+=e,this.save()}addXp(e){this._profile.xp+=e,this.save()}incrementMatchStats(e){this._profile.totalMatches=(this._profile.totalMatches||0)+1,e&&(this._profile.totalWins=(this._profile.totalWins||0)+1),this.save()}updateStreak(e){this._profile.streakCount=e,this.save()}isAdmin(){return this._profile.role==="admin"}}class $e{_ctx=null;_isMuted=!1;_crowdGain=null;_crowdSource=null;_correctAnswerBuffer=null;_wrongAnswerBuffer=null;_answerSelectedBuffer=null;_finalWhistleBuffer=null;_questionArriveBuffer=null;_activeGameplaySound=null;constructor(){const e=localStorage.getItem("ETHIO_FOOTBALL_MUTED");e!==null&&(this._isMuted=e==="true"),typeof document<"u"&&document.addEventListener("visibilitychange",()=>{document.hidden&&this.stopAllGameplaySounds(.05)})}stopAllGameplaySounds(e=.08){if(this.stopCrowdAmbience(),!this._ctx||!this._activeGameplaySound)return;const t=this._activeGameplaySound;this._activeGameplaySound=null,t.timeoutId&&clearTimeout(t.timeoutId);const i=this._ctx.currentTime;try{t.gain.gain.cancelScheduledValues(i),t.gain.gain.setValueAtTime(t.gain.gain.value,i),t.gain.gain.linearRampToValueAtTime(.01,i+e),t.source.stop(i+e+.02)}catch{}}_playManagedSound(e,t,i,a=0){if(this.stopAllGameplaySounds(.02),!e||(this._initContext(),!this._ctx))return;const r=this._ctx.createBufferSource();r.buffer=e;const n=this._ctx.createGain();n.gain.value=t,r.connect(n),n.connect(this._ctx.destination),r.start(this._ctx.currentTime+a);const s={source:r,gain:n,timeoutId:void 0};this._activeGameplaySound=s,i&&(s.timeoutId=setTimeout(()=>{this._activeGameplaySound===s&&this.stopAllGameplaySounds(.08)},i))}_initContext(){if(!this._ctx){const e=window.AudioContext||window.webkitAudioContext;this._ctx=new e,console.log("[AudioManager] Football stadium Web AudioContext initialized.")}this._ctx.state==="suspended"&&this._ctx.resume()}_vibrate(e){if(!this._isMuted&&typeof navigator<"u"&&navigator.vibrate)try{navigator.vibrate(e)}catch{}}playClick(){if(this._isMuted||(this._vibrate(10),this._initContext(),!this._ctx))return;const e=this._ctx.createOscillator(),t=this._ctx.createGain();e.type="sine",e.frequency.setValueAtTime(800,this._ctx.currentTime),e.frequency.exponentialRampToValueAtTime(400,this._ctx.currentTime+.05),t.gain.setValueAtTime(.15,this._ctx.currentTime),t.gain.linearRampToValueAtTime(.01,this._ctx.currentTime+.05),e.connect(t),t.connect(this._ctx.destination),e.start(),e.stop(this._ctx.currentTime+.05)}playWhistle(){if(this._isMuted||(this._initContext(),!this._ctx))return;const e=this._ctx.createOscillator(),t=this._ctx.createOscillator(),i=this._ctx.createGain();e.type="sine",t.type="sine",e.frequency.setValueAtTime(2400,this._ctx.currentTime),t.frequency.setValueAtTime(2450,this._ctx.currentTime),i.gain.setValueAtTime(.18,this._ctx.currentTime),i.gain.linearRampToValueAtTime(.01,this._ctx.currentTime+.35),e.connect(i),t.connect(i),i.connect(this._ctx.destination),e.start(),t.start(),e.stop(this._ctx.currentTime+.35),t.stop(this._ctx.currentTime+.35)}playFullTimeWhistle(){if(!this._isMuted&&(this._vibrate([30,40,30]),this._initContext(),!!this._ctx)){if(!this._finalWhistleBuffer){const e=(i,a)=>{if(!this._ctx)return;const r=this._ctx.createOscillator(),n=this._ctx.createOscillator(),s=this._ctx.createGain();r.type="sine",n.type="sine",r.frequency.setValueAtTime(2400,i),n.frequency.setValueAtTime(2450,i),s.gain.setValueAtTime(0,i),s.gain.linearRampToValueAtTime(.18,i+.05),s.gain.setValueAtTime(.18,i+a-.1),s.gain.linearRampToValueAtTime(0,i+a),r.connect(s),n.connect(s),s.connect(this._ctx.destination),r.start(i),n.start(i),r.stop(i+a),n.stop(i+a)},t=this._ctx.currentTime;e(t,.25),e(t+.35,.25),e(t+.7,.6);return}this._playManagedSound(this._finalWhistleBuffer,.75,void 0,.15)}}playCrowdAmbience(){if(this._isMuted||(this._initContext(),!this._ctx||this._crowdSource))return;const e=this._ctx.sampleRate*2,t=this._ctx.createBuffer(1,e,this._ctx.sampleRate),i=t.getChannelData(0);let a=0,r=0,n=0;for(let s=0;s<e;s++){const l=Math.random()*2-1;a=.99886*a+l*.0555179,r=.99332*r+l*.0750759,n=.969*n+l*.153852,i[s]=(a+r+n)*.04}this._crowdSource=this._ctx.createBufferSource(),this._crowdSource.buffer=t,this._crowdSource.loop=!0,this._crowdGain=this._ctx.createGain(),this._crowdGain.gain.setValueAtTime(.04,this._ctx.currentTime),this._crowdSource.connect(this._crowdGain),this._crowdGain.connect(this._ctx.destination),this._crowdSource.start()}stopCrowdAmbience(){if(this._crowdSource){try{this._crowdSource.stop()}catch{}this._crowdSource=null}}playGoalCheer(){if(this._isMuted||(this._initContext(),!this._ctx))return;this.playWhistle();const e=this._ctx.createOscillator(),t=this._ctx.createGain();e.type="sine",e.frequency.setValueAtTime(140,this._ctx.currentTime),e.frequency.exponentialRampToValueAtTime(40,this._ctx.currentTime+.12),t.gain.setValueAtTime(.3,this._ctx.currentTime),t.gain.linearRampToValueAtTime(.01,this._ctx.currentTime+.12),e.connect(t),t.connect(this._ctx.destination),e.start(),e.stop(this._ctx.currentTime+.12),[523.25,659.25,783.99,1046.5].forEach((a,r)=>{if(!this._ctx)return;const n=this._ctx.createOscillator(),s=this._ctx.createGain();n.type="triangle",n.frequency.setValueAtTime(a,this._ctx.currentTime+r*.08),s.gain.setValueAtTime(.2,this._ctx.currentTime+r*.08),s.gain.linearRampToValueAtTime(.01,this._ctx.currentTime+r*.08+.3),n.connect(s),s.connect(this._ctx.destination),n.start(this._ctx.currentTime+r*.08),n.stop(this._ctx.currentTime+r*.08+.3)})}playWrongAnswer(e){this._isMuted||(this._vibrate([40,20,40]),this._wrongAnswerBuffer&&this._playManagedSound(this._wrongAnswerBuffer,.7,e))}playAnswerSelected(e){if(!this._isMuted){if(!this._answerSelectedBuffer){this.playClick();return}this._playManagedSound(this._answerSelectedBuffer,.4,e)}}playQuestionArrive(){this._isMuted||(this._vibrate([10]),this._questionArriveBuffer&&this._playManagedSound(this._questionArriveBuffer,.45))}playCountdownWarning(){if(this._isMuted||(this._initContext(),!this._ctx))return;const e=this._ctx.createOscillator(),t=this._ctx.createGain();e.type="sine",e.frequency.setValueAtTime(70,this._ctx.currentTime),e.frequency.exponentialRampToValueAtTime(30,this._ctx.currentTime+.08),t.gain.setValueAtTime(.3,this._ctx.currentTime),t.gain.linearRampToValueAtTime(.01,this._ctx.currentTime+.08),e.connect(t),t.connect(this._ctx.destination),e.start(),e.stop(this._ctx.currentTime+.08);const i=this._ctx.createOscillator(),a=this._ctx.createGain();i.type="triangle",i.frequency.setValueAtTime(1200,this._ctx.currentTime),a.gain.setValueAtTime(.12,this._ctx.currentTime),a.gain.linearRampToValueAtTime(.01,this._ctx.currentTime+.04),i.connect(a),a.connect(this._ctx.destination),i.start(),i.stop(this._ctx.currentTime+.04)}async preloadAssets(){if(!this._isMuted)try{const[e,t,i,a,r]=await Promise.all([fetch("/assets/audios/Righ%20Answer%20score%20goal.m4a"),fetch("/assets/audios/wrong%20answer.m4a"),fetch("/assets/audios/Answer%20selected.m4a"),fetch("/assets/audios/whistle%20when%20game%20ends%20or%20timout.m4a"),fetch("/assets/audios/question-arrive.mp3")]);if(!this._ctx){const n=window.AudioContext||window.webkitAudioContext;this._ctx=new n}if(e.ok){const n=await e.arrayBuffer();this._correctAnswerBuffer=await this._ctx.decodeAudioData(n)}if(t.ok){const n=await t.arrayBuffer();this._wrongAnswerBuffer=await this._ctx.decodeAudioData(n)}if(i.ok){const n=await i.arrayBuffer();this._answerSelectedBuffer=await this._ctx.decodeAudioData(n)}if(a.ok){const n=await a.arrayBuffer();this._finalWhistleBuffer=await this._ctx.decodeAudioData(n)}if(r.ok){const n=await r.arrayBuffer();this._questionArriveBuffer=await this._ctx.decodeAudioData(n)}console.log("[AudioManager] Audio assets preloaded successfully.")}catch(e){console.warn("[AudioManager] Failed to preload audio assets",e)}}playCorrectAnswerGoal(e){if(!this._isMuted){if(this._vibrate([30,40,30]),!this._correctAnswerBuffer){this.playGoalCheer();return}this._playManagedSound(this._correctAnswerBuffer,.8,e)}}playVictoryFanfare(){if(this._isMuted||(this._initContext(),!this._ctx))return;[523.25,659.25,783.99,1046.5,1318.51].forEach((t,i)=>{if(!this._ctx)return;const a=this._ctx.createOscillator(),r=this._ctx.createGain();a.type="triangle",a.frequency.setValueAtTime(t,this._ctx.currentTime+i*.1),r.gain.setValueAtTime(.25,this._ctx.currentTime+i*.1),r.gain.linearRampToValueAtTime(.01,this._ctx.currentTime+i*.1+.35),a.connect(r),r.connect(this._ctx.destination),a.start(this._ctx.currentTime+i*.1),a.stop(this._ctx.currentTime+i*.1+.35)})}playDefeatSound(){this._isMuted||(this._initContext(),this._ctx&&this.playWhistle())}toggleMute(){return this._isMuted=!this._isMuted,localStorage.setItem("ETHIO_FOOTBALL_MUTED",String(this._isMuted)),this._isMuted&&this.stopCrowdAmbience(),this._isMuted}get isMuted(){return this._isMuted}}class Ue{_uiManager;_saveManager;_audioManager;constructor(){this._uiManager=new De,this._saveManager=new Ce,this._audioManager=new $e}async initialize(){this._audioManager.preloadAssets()}get uiManager(){return this._uiManager}get saveManager(){return this._saveManager}get audioManager(){return this._audioManager}}class Ge{_games=new Map;_activeGame=null;_uiManager;constructor(e){this._uiManager=e}registerGame(e){this._games.set(e.metadata.id,e),console.log(`[GameRegistry] Registered game: ${e.metadata.name} (${e.metadata.id})`)}getRegisteredGames(){return Array.from(this._games.values())}async launchGame(e){this._activeGame&&(console.log(`[GameRegistry] Destroying active game: ${this._activeGame.metadata.name}`),this._activeGame.destroy(),this._uiManager.clear());const t=this._games.get(e);if(!t)throw new Error(`[GameRegistry] Game with ID '${e}' not found.`);console.log(`[GameRegistry] Initializing game: ${t.metadata.name}`),await t.initialize(this._uiManager),this._activeGame=t,t.start()}get activeGame(){return this._activeGame}}class We{_goals=0;_correct=0;_incorrect=0;_total=0;_currentCombo=0;_maxCombo=0;_responseTimes=[];_answerSubmissions=[];reset(){this._goals=0,this._correct=0,this._incorrect=0,this._total=0,this._currentCombo=0,this._maxCombo=0,this._responseTimes=[],this._answerSubmissions=[]}recordAnswer(e,t,i,a){if(this._total++,this._responseTimes.push(t),i&&a!==void 0&&this._answerSubmissions.push({questionId:i,selectedIndex:a,responseTimeMs:Math.round(t*1e3)}),e){this._goals++,this._correct++,this._currentCombo++,this._currentCombo>this._maxCombo&&(this._maxCombo=this._currentCombo);const r=100,n=(this._currentCombo-1)*25,s=r+n,l=20+this._currentCombo*5;return{isGoal:!0,coins:s,xp:l}}else return this._incorrect++,this._currentCombo=0,{isGoal:!1,coins:0,xp:0}}get answerSubmissions(){return this._answerSubmissions}calculateFinalStats(){const e=this._total>0?Math.round(this._correct/this._total*100):0,t=Math.min(Math.max(Math.round(e*.85+15),30),85),i=this._responseTimes.reduce((c,d)=>c+d,0),a=this._responseTimes.length>0?parseFloat((i/this._responseTimes.length).toFixed(1)):0,r=this._correct*100+this._maxCombo*50,n=this._correct*20+this._maxCombo*10;let s=5+e/20+this._maxCombo*.4;a>0&&a<5&&(s+=1);const l=parseFloat(Math.min(Math.max(s,3),10).toFixed(1));return{goals:this._goals,correctAnswers:this._correct,incorrectAnswers:this._incorrect,totalQuestions:this._total,accuracy:e,possessionPercent:t,avgResponseTime:a,maxCombo:this._maxCombo,coinsEarned:r,xpEarned:n,matchRating:l}}}const ze={"world-cup":{id:"world-cup",nameEn:"FIFA World Cup",nameAm:"የዓለም ዋንጫ",nameOm:"Waancaa Addunyaa FIFA",badge:"🏆",description:"World Cup history, records, hosts, and legend moments"},"champions-league":{id:"champions-league",nameEn:"UEFA Champions League",nameAm:"UEFA ቻምፒየንስ ሊግ",nameOm:"Liigii Chaampiyoonsii UEFA",badge:"⭐",description:"European club football, iconic finals, and top scorers"},"caf-champions":{id:"caf-champions",nameEn:"CAF Champions League",nameAm:"የCAF ሻምፒዮንስ ሊግ",nameOm:"Liigii Chaampiyoonsii CAF",badge:"🌍",description:"African club football and continental showdowns"},afcon:{id:"afcon",nameEn:"Africa Cup of Nations (AFCON)",nameAm:"የአፍሪካ ዋንጫ (AFCON)",nameOm:"Waancaa Afriikaa (AFCON)",badge:"🦁",description:"Africa's flagship national team championship"},"ethiopian-premier":{id:"ethiopian-premier",nameEn:"Ethiopian Premier League",nameAm:"የኢትዮጵያ ፕሪሚየር ሊግ",nameOm:"Liigii Piriimeraa Itoophiyaa",badge:"🇪🇹",description:"Ethiopian club teams, derbies, and domestic history"},"walia-ibex":{id:"walia-ibex",nameEn:"Walia Ibex (National Team)",nameAm:"ዋሊያ ኢቤክስ (ብሔራዊ ቡድን)",nameOm:"Waaliyaa Ibeks (Garaa Guutuu)",badge:"🐐",description:"Ethiopian national team milestones and heroes"},"premier-league":{id:"premier-league",nameEn:"English Premier League",nameAm:"የእንግሊዝ ፕሪሚየር ሊግ",nameOm:"Liigii Piriimeraa Ingilaand",badge:"🦁",description:"EPL clubs, managers, top scorers, and records"},"la-liga":{id:"la-liga",nameEn:"Spanish La Liga",nameAm:"የስፔን ላ ሊጋ",nameOm:"Laa Liigaa Ispeen",badge:"🇪🇸",description:"El Clásico, Spanish giants, and title races"},"serie-a":{id:"serie-a",nameEn:"Italian Serie A",nameAm:"የጣሊያን ሰሪ ኤ",nameOm:"Seeriyee A Xaaliyaanii",badge:"🇮🇹",description:"Calcio history, tactical legends, and Italian clubs"},bundesliga:{id:"bundesliga",nameEn:"German Bundesliga",nameAm:"የጀርመን ቡንደስሊጋ",nameOm:"Buundesliigaa Jarmaan",badge:"🇩🇪",description:"German football powerhouses and records"},"legendary-players":{id:"legendary-players",nameEn:"Legendary Players",nameAm:"አፈ ታሪክ ተጫዋቾች",nameOm:"Taphattootaa Seenaa",badge:"👟",description:"All-time greats, Ballon d'Or winners, and icons"},"football-rules":{id:"football-rules",nameEn:"Football Rules & Laws",nameAm:"የእግር ኳስ ሕግጋት",nameOm:"Seera Kubbaa Miilaa",badge:"📏",description:"Laws of the game, offside rule, VAR, and refereeing"},"transfer-market":{id:"transfer-market",nameEn:"Transfer Market & Fees",nameAm:"የዝውውር ገበያ",nameOm:"Gabaa Dabarsaa",badge:"💰",description:"Record transfer fees, contracts, and market moves"},stadiums:{id:"stadiums",nameEn:"Stadiums & Venues",nameAm:"ስታዲየሞች",nameOm:"Istaadiyeemota",badge:"🏟️",description:"Iconic football grounds, capacities, and host cities"},"football-history":{id:"football-history",nameEn:"Football History",nameAm:"የእግር ኳስ ታሪክ",nameOm:"Seenaa Kubbaa Miilaa",badge:"📜",description:"Origins, historic matches, and global football lore"}};class I{static _competitions=new Map;static _isInitialized=!1;static _initDefaults(){I._isInitialized||(Object.values(ze).forEach(e=>{I._competitions.set(e.id,{id:e.id,name:e.nameEn,nameEn:e.nameEn,nameAm:e.nameAm,nameOm:e.nameOm,badge:e.badge,description:e.description,color:"#FFD700",questionCount:10,status:"live",participants:0,prize_pool:0})}),I._isInitialized=!0)}static getAll(e="en"){return I._initDefaults(),Array.from(I._competitions.values()).map(t=>{let i=t.nameEn;return e==="am"&&t.nameAm&&(i=t.nameAm),e==="om"&&t.nameOm&&(i=t.nameOm),{...t,name:i}})}static getById(e,t="en"){I._initDefaults();const i=I._competitions.get(e);if(!i)return;let a=i.nameEn;return t==="am"&&i.nameAm&&(a=i.nameAm),t==="om"&&i.nameOm&&(a=i.nameOm),{...i,name:a}}static async syncFromCloud(e="en"){if(I._initDefaults(),_.isOnline&&m)try{const{data:t,error:i}=await m.from("competitions").select("*").eq("is_active",!0);if(!i&&t&&t.length>0){let a=0;try{const{count:r,error:n}=await m.from("game_sessions").select("*",{count:"exact",head:!0}).eq("state","playing");!n&&r&&(a=r)}catch{}t.forEach(r=>{I._competitions.set(r.id,{id:r.id,name:r.name_en,nameEn:r.name_en,nameAm:r.name_am||void 0,nameOm:r.name_om||void 0,badge:r.badge,description:r.description_en||"",color:r.color||"#FFD700",questionCount:r.question_count||10,status:"live",participants:a,prize_pool:0})})}}catch(t){console.warn("[CompetitionRegistry] Cloud sync failed, using defaults:",t)}return I.getAll(e)}static addCompetition(e){I._initDefaults(),I._competitions.set(e.id,e),console.log(`[CompetitionRegistry] Added competition: ${e.name}`)}static removeCompetition(e){return I._competitions.delete(e)}}class pe{static async invoke(e,t){if(!_.isOnline||!m)return{data:null,error:`Supabase client offline. Edge function '${e}' unavailable.`};try{const{data:i,error:a}=await m.functions.invoke(e,{body:t});return a?(console.error(`[EdgeFunctionClient] Error calling '${e}':`,a),{data:null,error:a.message}):{data:i,error:null}}catch(i){return console.error(`[EdgeFunctionClient] Exception in '${e}':`,i),{data:null,error:i.message||"Edge function invocation failed."}}}}const Qe=[{id:"fb-1",category:"walia-ibex",difficulty:2,prompt:"Which country won the first ever African Cup of Nations (AFCON) in 1957?",options:["Egypt","Ethiopia","Sudan","South Africa"],correctIndex:0,explanation:"Egypt defeated Ethiopia 4-0 in the final of the inaugural Africa Cup of Nations.",fact:"Only three nations participated in the first AFCON: Egypt, Ethiopia, and Sudan. South Africa was disqualified due to apartheid.",learningTip:"Remember '1957' as the birth year of AFCON."},{id:"fb-2",category:"walia-ibex",difficulty:1,prompt:"What is the nickname of the Ethiopian National Football Team?",options:["The Lions","Walia Ibex","The Pharoahs","Black Stars"],correctIndex:1,explanation:"The Walia Ibex is an endangered species of ibex found only in the Simien Mountains of Ethiopia."},{id:"fb-3",category:"ethiopian-premier",difficulty:3,prompt:"Which club holds the record for the most Ethiopian Premier League titles?",options:["Ethiopian Coffee SC","Dedebit FC","Fasil Kenema","Saint George SC"],correctIndex:3},{id:"fb-4",category:"ethiopian-premier",difficulty:3,prompt:"In which year was the Ethiopian Premier League established in its current format?",options:["1985","1997","2002","2010"],correctIndex:1},{id:"fb-5",category:"walia-ibex",difficulty:4,prompt:"Who is Ethiopia's all-time top goalscorer in international football?",options:["Getaneh Kebede","Saladin Said","Mengistu Worku","Adane Girma"],correctIndex:0},{id:"fb-6",category:"world-cup",difficulty:1,prompt:"Which nation has won the most FIFA Men's World Cup titles?",options:["Germany","Brazil","Argentina","Italy"],correctIndex:1},{id:"fb-7",category:"world-cup",difficulty:2,prompt:"Who won the Golden Boot in the 2022 FIFA World Cup?",options:["Lionel Messi","Kylian Mbappé","Julián Álvarez","Olivier Giroud"],correctIndex:1},{id:"fb-8",category:"champions-league",difficulty:2,prompt:"Which player has scored the most goals in UEFA Champions League history?",options:["Lionel Messi","Robert Lewandowski","Cristiano Ronaldo","Karim Benzema"],correctIndex:2},{id:"fb-9",category:"premier-league",difficulty:3,prompt:"Which team holds the record for most points in a single English Premier League season?",options:["Manchester United","Liverpool","Chelsea","Manchester City"],correctIndex:3},{id:"fb-10",category:"walia-ibex",difficulty:4,prompt:"Ethiopia won its only African Cup of Nations title in which year?",options:["1957","1962","1970","1982"],correctIndex:1,fact:"Ydnekatchew Tessema was one of the most influential figures in Ethiopian football history.",learningTip:"Ethiopia hosted and won the 1962 tournament, defeating Egypt 4-2 in the final after extra time."},{id:"fb-11",category:"premier-league",difficulty:2,prompt:"Who is the all-time top scorer of the English Premier League?",options:["Wayne Rooney","Alan Shearer","Harry Kane","Thierry Henry"],correctIndex:1},{id:"fb-12",category:"ethiopian-premier",difficulty:2,prompt:"What colors are primarily associated with Ethiopian Coffee SC?",options:["Green and Yellow","Red and White","Brown and Gold","Blue and White"],correctIndex:2},{id:"fb-13",category:"world-cup",difficulty:4,prompt:"Which African nation became the first to reach a FIFA World Cup Semi-Final?",options:["Senegal","Ghana","Morocco","Nigeria"],correctIndex:2},{id:"fb-14",category:"champions-league",difficulty:3,prompt:"Which club has won the most UEFA Champions League titles?",options:["AC Milan","Bayern Munich","Liverpool","Real Madrid"],correctIndex:3},{id:"fb-15",category:"walia-ibex",difficulty:5,prompt:"Who coached the Ethiopian National Team when they qualified for the 2013 AFCON?",options:["Bishaw Sewnet","Asrat Haile","Yohannes Sahle","Wubetu Abate"],correctIndex:0}];class H{static _instance=null;_askedQuestionIds=new Set;static getInstance(){return H._instance||(H._instance=new H),H._instance}async fetchQuestions(e,t=10,i="en",a=[],r="casual"){if(_.isOnline)try{const{data:s,error:l}=await pe.invoke("questions",{competitionId:e,count:t*2,locale:i,excludeIds:a,usageType:r});if(!l&&s&&s.questions&&s.questions.length>0)return console.log("[QuestionBank] Fetched server-authored questions via Edge Function."),this._selectQuestions(s.questions,t)}catch(s){console.warn("[QuestionBank] Edge Function failed.",s)}if(_.isOnline&&m)try{let s=m.from("questions").select("*").eq("is_active",!0);r==="casual"?s=s.eq("usage_type","casual"):r==="tournament"&&(s=s.eq("usage_type","tournament")),e&&e!=="all"&&(s=s.or(`competition_id.eq.${e},category.eq.${e}`)),a&&a.length>0&&(s=s.not("id","in",`(${a.join(",")})`));const{data:l,error:c}=await s.limit(50);if(!c&&l&&l.length>0){console.log("[QuestionBank] Fetched questions directly from Supabase DB.");const d=l.map(h=>this._mapQuestionRow(h,i));return this._selectQuestions(d,t)}}catch(s){console.warn("[QuestionBank] Supabase DB question fetch error:",s)}console.warn("[QuestionBank] Server connection unavailable. Serving fallback offline questions.");let n=Qe;if(e){const s=n.filter(l=>l.category===e);s.length>=Math.min(t,5)&&(n=s)}return a&&a.length>0&&(n=n.filter(s=>!a.includes(s.id))),this._selectQuestions(n,t)}async fetchQuestionsByIds(e,t="en"){if(_.isOnline&&m&&e.length>0)try{const{data:i,error:a}=await m.from("questions").select("*").in("id",e);if(!a&&i&&i.length>0){console.log(`[QuestionBank] Fetched ${i.length} specific questions by ID.`);const r=i.map(s=>this._mapQuestionRow(s,t,!1)),n=[];for(const s of e){const l=r.find(c=>c.id===s);l&&n.push(l)}return n}}catch(i){console.warn("[QuestionBank] Supabase DB fetchQuestionsByIds error:",i)}return this.fetchQuestions(void 0,e.length,t)}_mapQuestionRow(e,t,i=!0){let a=e.prompt_en,r=e.options_en;t==="am"&&e.prompt_am&&e.options_am?(a=e.prompt_am,r=e.options_am):t==="om"&&e.prompt_om&&e.options_om&&(a=e.prompt_om,r=e.options_om);let n=r,s=e.correct_index;if(i){const l=[0,1,2,3];for(let c=l.length-1;c>0;c--){const d=Math.floor(Math.random()*(c+1));[l[c],l[d]]=[l[d],l[c]]}n=l.map(c=>r[c]),s=l.indexOf(e.correct_index)}return{id:e.id,category:e.category,difficulty:e.difficulty,prompt:a,options:n,correctIndex:s}}_selectQuestions(e,t){let i=e.filter(s=>s.id&&!this._askedQuestionIds.has(s.id));i.length<t&&(this._askedQuestionIds.clear(),i=e);const r=[...i.length>=t?i:e];for(let s=r.length-1;s>0;s--){const l=Math.floor(Math.random()*(s+1));[r[s],r[l]]=[r[l],r[s]]}const n=r.slice(0,t);for(n.forEach(s=>{s.id&&this._askedQuestionIds.add(s.id)});n.length<t&&e.length>0;)n.push(e[Math.floor(Math.random()*e.length)]);return n}}const je={common:{title:"FOOTBALL QUIZ LEAGUE",subtitle:"ETHIO TELECOM VAS PLATFORM",close:"✖ CLOSE",backToHome:"✖ BACK TO HOME",play:"PLAY",submit:"SUBMIT",loading:"Loading...",error:"Error"},home:{soloMatch:"⚽ SOLO MATCH",liveMatch:"⚡ LIVE 1v1 MATCH",dailyChallenge:"📅 DAILY CHALLENGE",competitions:"🏆 COMPETITIONS",leaderboard:"📊 LEADERBOARD",badges:"🎖️ BADGES",admin:"⚙️ ADMIN",streak:"🔥 {count} DAY STREAK",coins:"🪙 {coins} COINS",level:"LVL {level}",invite:"Invite",inviteDesc:"+200 XP per friend.",copyLink:"Copy Link",performance:"📊 Performance",details:"DETAILS",matches:"MATCHES",points:"POINTS",score:"SCORE",lobbies:"⚽ Lobbies",championship:"🏆 ETHIOFANTASY CHAMPIONSHIP"},match:{questionCount:"QUESTION {current} OF {total}",goal:"⚽ GOAL!!!!!",saved:"🧤 SAVED!",halfTime:"HALF TIME",fullTime:"FULL TIME",matchStats:"MATCH STATISTICS",matchRating:"MATCH RATING",possession:"POSSESSION",accuracy:"ACCURACY",maxCombo:"MAX COMBO",coinsEarned:"COINS EARNED",xpEarned:"XP EARNED",continue:"CONTINUE TO HUB",leaveMatch:"Leave Match?",leaveWarning:"Your progress will be abandoned.",leaveBtn:"Leave",continueBtn:"Continue"},multiplayer:{matchmakingTitle:"LIVE MULTIPLAYER MATCHMAKING",findingOpponent:"FINDING WORTHY OPPONENT...",yourRating:"YOUR RATING",searchRange:"SEARCH RANGE",cancelMatchmaking:"✖ CANCEL MATCHMAKING",victory:"VICTORY!",draw:"MATCH DRAW!",defeated:"DEFEATED!",finalScore:"FINAL SCORE: {myScore} - {oppScore}",eloRating:"ELO RATING"},categories:{worldCup:"FIFA World Cup",championsLeague:"UEFA Champions League",cafChampions:"CAF Champions League",afcon:"Africa Cup of Nations",ethiopianPremier:"Ethiopian Premier League",waliaIbex:"Ethiopian National Team (Walia Ibex)",premierLeague:"Premier League",laLiga:"La Liga",serieA:"Serie A",bundesliga:"Bundesliga",legendaryPlayers:"Legendary Players",footballRules:"Football Rules & Laws",transferMarket:"Transfer Market",stadiums:"Stadiums & Venues",footballHistory:"Football History"}},Ye={common:{title:"የእግር ኳስ ጥያቄ ሊግ",subtitle:"ኢትዮ ቴሌኮም ቪኤኤስ መድረክ",close:"✖ ዝጋ",backToHome:"✖ ወደ ዋና ገጽ",play:"ተጫወት",submit:"ላክ",loading:"በመጫን ላይ...",error:"ስህተት"},home:{soloMatch:"⚽ ነጠላ ጨዋታ",liveMatch:"⚡ ቀጥታ 1v1 ጨዋታ",dailyChallenge:"📅 የዕለት ተግዳሮት",competitions:"🏆 ውድድሮች",leaderboard:"📊 ደረጃ ሰሌዳ",badges:"🎖️ ባጆች",admin:"⚙️ አድሚን",streak:"🔥 {count} ቀን ተከታታይ",coins:"🪙 {coins} ሳንቲም",level:"ደረጃ {level}",invite:"ጋብዝ",inviteDesc:"+200 XP በአንድ ጓደኛ",copyLink:"ሊንክ ኮፒ አድርግ",performance:"📊 አፈጻጸም",details:"ዝርዝር",matches:"ጨዋታዎች",points:"ነጥቦች",score:"ውጤት",lobbies:"⚽ ሎቢ",championship:"🏆 የኢትዮፋንታሲ ሻምፒዮና"},match:{questionCount:"ጥያቄ {current} ከ {total}",goal:"⚽ ጎል!!!!!",saved:"🧤 ተመለሰ!",halfTime:"እረፍት",fullTime:"ሙሉ ጊዜ",matchStats:"የጨዋታ ስታቲስቲክስ",matchRating:"የጨዋታ ደረጃ",possession:"ኳስ ቁጥጥር",accuracy:"ትክክለኛነት",maxCombo:"ከፍተኛ ተከታታይ",coinsEarned:"የተገኘ ሳንቲም",xpEarned:"የተገኘ XP",continue:"ወደ መነሻ ገጽ ተመለስ",leaveMatch:"ጨዋታውን ትተህ ውጣ?",leaveWarning:"ያለዎት እድገት ይጠፋል።",leaveBtn:"ውጣ",continueBtn:"ቀጥል"},multiplayer:{matchmakingTitle:"ቀጥታ ባለብዙ ተጫዋች ጨዋታ",findingOpponent:"ተፎካካሪ በመፈለግ ላይ...",yourRating:"የእርስዎ ደረጃ",searchRange:"የፍለጋ ክልል",cancelMatchmaking:"✖ ፍለጋውን ሰርዝ",victory:"ድል!",draw:"እኩል!",defeated:"ተሸንፈዋል!",finalScore:"የመጨረሻ ውጤት: {myScore} - {oppScore}",eloRating:"የኤሎ ደረጃ"},categories:{worldCup:"የዓለም ዋንጫ",championsLeague:"UEFA ቻምፒየንስ ሊግ",cafChampions:"የCAF ሻምፒዮንስ ሊግ",afcon:"የአፍሪካ ዋንጫ",ethiopianPremier:"የኢትዮጵያ ፕሪሚየር ሊግ",waliaIbex:"ዋሊያ ኢቤክስ (ብሔራዊ ቡድን)",premierLeague:"የእንግሊዝ ፕሪሚየር ሊግ",laLiga:"የስፔን ላ ሊጋ",serieA:"የጣሊያን ሰሪ ኤ",bundesliga:"የጀርመን ቡንደስሊጋ",legendaryPlayers:"አፈ ታሪክ ተጫዋቾች",footballRules:"የእግር ኳስ ሕግጋት",transferMarket:"የዝውውር ገበያ",stadiums:"ስታዲየሞች",footballHistory:"የእግር ኳስ ታሪክ"}},Ve={common:{title:"LIIGII GAAFFII KUBBAA MIILAA",subtitle:"ITIYO TELEKOOM VAS PLATFORM",close:"✖ Cufi",backToHome:"✖ Gara Fuula Duraatti",play:"Taphadhu",submit:"Ergi",loading:"Fe'amaa jira...",error:"Dogoggora"},home:{soloMatch:"⚽ TAPHA QOFAAA",liveMatch:"⚡ TAPHI KALLATTII 1v1",dailyChallenge:"📅 QORMAATA GUYYAA",competitions:"🏆 DORGOMMIIWWAN",leaderboard:"📊 SADARKAA",badges:"🎖️ BAADJIIWWAN",admin:"⚙️ ADMIIN",streak:"🔥 {count} GUYYAA WALITTI AANEE",coins:"🪙 {coins} SAAKKATOO",level:"SADARKAA {level}",invite:"Afeeri",inviteDesc:"+200 XP hiriyaa tokkoon",copyLink:"Liinkii Kopi godhi",performance:"📊 Raawwii",details:"BAL'INA",matches:"TAPHOOTA",points:"QABXII",score:"FIRI",lobbies:"⚽ Lobbies",championship:"🏆 CHAMPIONSHIP ETHIOFANTASY"},match:{questionCount:"GAAFFII {current} KEESSAA {total}",goal:"⚽ GOOLII!!!!!",saved:"🧤 QABAME!",halfTime:"BOQONNAA",fullTime:"YEROO GUUTUU",matchStats:"ISTATISTIKSII TAPHA",matchRating:"SADARKAA TAPHA",possession:"KUBBAA QABACHUU",accuracy:"SIREESSUU",maxCombo:"WAL-IRRAA OLAANAA",coinsEarned:"SANTIIMA ARGAME",xpEarned:"XP ARGATAME",continue:"GARA FUULA DURAA DEEBI'I",leaveMatch:"Tapha Dhiiftee Baataa?",leaveWarning:"Guddinni kee ni bada.",leaveBtn:"Bahi",continueBtn:"Itti Fufi"},multiplayer:{matchmakingTitle:"TAPHA KALLATTII DORGOMAA",findingOpponent:"DORGOMAA BARBAADAA JIRA...",yourRating:"SADARKAA KEE",searchRange:"DAANGAA BARBAADUU",cancelMatchmaking:"✖ BARBAADUU HAQI",victory:"INJIFANNOO!",draw:"QIXEE!",defeated:"MO'ATAMTEERTA!",finalScore:"QABXII GUUTUU: {myScore} - {oppScore}",eloRating:"SADARKAA ELO"},categories:{worldCup:"Waancaa Addunyaa FIFA",championsLeague:"Liigii Chaampiyoonsii UEFA",cafChampions:"Liigii Chaampiyoonsii CAF",afcon:"Waancaa Afriikaa",ethiopianPremier:"Liigii Piriimeraa Itoophiyaa",waliaIbex:"Waaliyaa Ibeks (Garee Biyyaaleessaa)",premierLeague:"Liigii Piriimeraa Ingilaand",laLiga:"Laa Liigaa Ispeen",serieA:"Seeriyee A Xaaliyaanii",bundesliga:"Buundesliigaa Jarmaan",legendaryPlayers:"Taphattootaa Seenaa",footballRules:"Seera Kubbaa Miilaa",transferMarket:"Gabaa Dabarsaa",stadiums:"Istaadiyeemota",footballHistory:"Seenaa Kubbaa Miilaa"}},ue={en:je,am:Ye,om:Ve};class J{static _instance=null;_currentLocale="en";constructor(){const e=localStorage.getItem("ETHIO_FOOTBALL_LOCALE");(e==="am"||e==="om"||e==="en")&&(this._currentLocale=e)}static getInstance(){return J._instance||(J._instance=new J),J._instance}setLocale(e){this._currentLocale=e,localStorage.setItem("ETHIO_FOOTBALL_LOCALE",e),console.log(`[i18n] Switched locale to: ${e}`)}get currentLocale(){return this._currentLocale}t(e,t){const i=e.split(".");let a=ue[this._currentLocale]||ue.en;for(const n of i)if(a&&a[n]!==void 0)a=a[n];else{let s=ue.en;for(const l of i)if(s&&s[l]!==void 0)s=s[l];else return e;a=s;break}if(typeof a!="string")return e;let r=a;return t&&Object.entries(t).forEach(([n,s])=>{r=r.replace(new RegExp(`\\{${n}\\}`,"g"),String(s))}),r}}const o=J.getInstance(),P=(p,e)=>o.t(p,e);class F{static _instance=null;constructor(){}static getInstance(){return F._instance||(F._instance=new F),F._instance}async createSession(e,t,i,a){if(!_.isOnline)return null;const r=m;if(!r)return null;try{const{data:{user:n}}=await r.auth.getUser();if(!n)return null;const{data:s,error:l}=await r.from("game_sessions").insert({user_id:n.id,match_type:e,competition_id:t,difficulty:typeof i=="string"?parseInt(i,10):i,question_ids:a,total_questions:a.length,time_remaining:60,state:"playing"}).select().single();return l?(console.warn("[GameSessionService] Error creating session:",l),null):s}catch(n){return console.warn("[GameSessionService] Failed to create session:",n),null}}async getActiveSession(){if(!_.isOnline)return null;const e=m;if(!e)return null;try{const{data:{user:t}}=await e.auth.getUser();if(!t)return null;const{data:i,error:a}=await e.from("game_sessions").select("*").eq("user_id",t.id).in("state",["playing","paused"]).order("created_at",{ascending:!1}).limit(1).single();return a&&a.code!=="PGRST116"?(console.warn("[GameSessionService] Error fetching active session:",a),null):i}catch(t){return console.warn("[GameSessionService] Failed to get active session:",t),null}}async updateSession(e,t){if(!_.isOnline)return;const i=m;if(i)try{const{error:a}=await i.from("game_sessions").update(t).eq("id",e);a&&console.warn("[GameSessionService] Error updating session:",a)}catch(a){console.warn("[GameSessionService] Failed to update session:",a)}}async pauseSession(e){return this.updateSession(e,{state:"paused",paused_at:new Date().toISOString()})}async resumeSession(e){return this.updateSession(e,{state:"playing",paused_at:null})}async completeSession(e,t,i,a,r){return this.updateSession(e,{state:"completed",final_score:t,accuracy:i,avg_response_time:a,max_combo:r,completed_at:new Date().toISOString()})}async abandonSession(e){return this.updateSession(e,{state:"abandoned",completed_at:new Date().toISOString()})}async recordAnswer(e,t,i,a,r,n,s){if(!_.isOnline)return;const l=m;if(l)try{const{error:c}=await l.from("game_session_answers").insert({session_id:e,question_id:t,question_index:i,selected_index:a,correct_index:r,is_correct:n,response_time_ms:s});c&&console.warn("[GameSessionService] Error recording answer:",c)}catch(c){console.warn("[GameSessionService] Failed to record answer:",c)}}async getSessionAnswers(e){if(!_.isOnline)return[];const t=m;if(!t)return[];try{const{data:i,error:a}=await t.from("game_session_answers").select("*").eq("session_id",e).order("question_index",{ascending:!0});return a?(console.warn("[GameSessionService] Error fetching session answers:",a),[]):i||[]}catch(i){return console.warn("[GameSessionService] Failed to get session answers:",i),[]}}async getHistory(e=20){if(!_.isOnline)return[];const t=m;if(!t)return[];try{const{data:{user:i}}=await t.auth.getUser();if(!i)return[];const{data:a,error:r}=await t.from("game_sessions").select("*").eq("user_id",i.id).eq("state","completed").order("completed_at",{ascending:!1}).limit(e);return r?(console.warn("[GameSessionService] Error fetching session history:",r),[]):a||[]}catch(i){return console.warn("[GameSessionService] Failed to get session history:",i),[]}}}class ${static _instance=null;STORAGE_KEY="ETHIO_ACTIVE_SESSION_V3";static getInstance(){return $._instance||($._instance=new $),$._instance}createSession(e,t,i){const a={sessionId:"SESS-"+Math.floor(1e5+Math.random()*9e5),matchType:e,startTime:Date.now(),totalQuestions:i.length,difficulty:t,currentScore:0,currentIndex:0,timeLeftSec:15,questions:i,choices:[],responseTimes:[],state:"Playing",correctCount:0,wrongCount:0,timeOutCount:0},r=i.map(n=>String(n.id));return F.getInstance().createSession(e,e,t,r).then(n=>{n&&n.id&&(a.cloudSessionId=n.id,this.saveSession(a))}),this.saveSession(a),a}getActiveSession(){const e=localStorage.getItem(this.STORAGE_KEY);if(!e)return null;try{const t=JSON.parse(e);return t.state==="Completed"||t.state==="Abandoned"||t.state==="Expired"?null:Date.now()-t.startTime>144e5?(this.clearSession(),null):t}catch{return null}}saveSession(e){localStorage.setItem(this.STORAGE_KEY,JSON.stringify(e))}clearSession(){localStorage.removeItem(this.STORAGE_KEY)}autoSaveProgress(e,t,i,a,r,n,s){if(e.currentIndex=t,e.choices.push(i),e.responseTimes.push(a),e.currentScore=n,e.timeLeftSec=s,i===-1?e.timeOutCount++:r?e.correctCount++:e.wrongCount++,e.cloudSessionId){const l=String(e.questions[t].id),c=e.questions[t].correctIndex??-1;F.getInstance().recordAnswer(e.cloudSessionId,l,t,i,c,r,a)}this.saveSession(e)}abandonSession(e){e.state="Abandoned",this.saveSession(e),this.addToHistory(e),e.cloudSessionId&&F.getInstance().abandonSession(e.cloudSessionId),this.clearSession()}completeSession(e,t){if(e.state="Completed",e.currentScore=t,this.saveSession(e),this.addToHistory(e),e.cloudSessionId){const i=e.totalQuestions>0?Math.round(e.correctCount/e.totalQuestions*100):0,a=e.responseTimes.length>0?e.responseTimes.reduce((r,n)=>r+n,0)/e.responseTimes.length:0;F.getInstance().completeSession(e.cloudSessionId,t,i,a,0)}this.clearSession()}addToHistory(e){}}class Oe{static _canvas=null;static _ctx=null;static _particles=[];static _animId=null;static burst(e,t,i=60,a=["#FFD700","#22C55E","#3B82F6","#FFFFFF","#FF4500"]){this._init();const r=e??window.innerWidth/2,n=t??window.innerHeight/3;for(let s=0;s<i;s++){const l=Math.random()*Math.PI*2,c=Math.random()*12+4;this._particles.push({x:r,y:n,vx:Math.cos(l)*c,vy:Math.sin(l)*c-3,size:Math.random()*8+4,color:a[Math.floor(Math.random()*a.length)],alpha:1,rotation:Math.random()*360,rotSpeed:(Math.random()-.5)*15,shape:Math.random()>.4?"rect":"circle"})}this._animId||this._loop()}static _init(){this._canvas||(this._canvas=document.createElement("canvas"),this._canvas.id="confetti-canvas",this._canvas.style.position="fixed",this._canvas.style.top="0",this._canvas.style.left="0",this._canvas.style.width="100vw",this._canvas.style.height="100vh",this._canvas.style.pointerEvents="none",this._canvas.style.zIndex="9999",document.body.appendChild(this._canvas)),this._canvas.width=window.innerWidth,this._canvas.height=window.innerHeight,this._ctx=this._canvas.getContext("2d")}static _loop(){if(!(!this._ctx||!this._canvas)){this._ctx.clearRect(0,0,this._canvas.width,this._canvas.height);for(let e=this._particles.length-1;e>=0;e--){const t=this._particles[e];if(t.x+=t.vx,t.y+=t.vy,t.vy+=.25,t.vx*=.98,t.rotation+=t.rotSpeed,t.alpha-=.015,t.alpha<=0||t.y>window.innerHeight){this._particles.splice(e,1);continue}this._ctx.save(),this._ctx.globalAlpha=t.alpha,this._ctx.translate(t.x,t.y),this._ctx.rotate(t.rotation*Math.PI/180),this._ctx.fillStyle=t.color,t.shape==="rect"?this._ctx.fillRect(-t.size/2,-t.size/2,t.size,t.size*1.5):(this._ctx.beginPath(),this._ctx.arc(0,0,t.size/2,0,Math.PI*2),this._ctx.fill()),this._ctx.restore()}this._particles.length>0?this._animId=requestAnimationFrame(()=>this._loop()):this._animId=null}}}class he{static animate(e,t,i,a=1200,r=n=>Math.round(n).toLocaleString()){const n=performance.now(),s=l=>{const c=l-n,d=Math.min(c/a,1),h=1-Math.pow(1-d,3),u=t+(i-t)*h;e.textContent=r(u),d<1?requestAnimationFrame(s):e.textContent=r(i)};requestAnimationFrame(s)}}class Ke{static render(e){return`
        ...
        `}}class Me{_uiManager;_audioManager;_quizEngine;_competition;_questions;_callbacks;_currentIndex=0;_timerInterval=null;_timeLeftSec=15;_startTimeMs=0;_hasKickedOff=!1;_session=null;_hasPlayedFullTimeWhistle=!1;_isPaused=!1;_isDestroyed=!1;_nextQuestionTimeoutId=null;_visibilityHandler;_networkOfflineHandler;_networkOnlineHandler;constructor(e,t,i,a,r,n){this._uiManager=e,this._audioManager=t,this._quizEngine=i,this._competition=a,this._questions=r,this._callbacks=n,this._visibilityHandler=()=>{document.visibilityState==="hidden"&&this._hasKickedOff&&!this._isPaused&&this._currentIndex<this._questions.length&&this._showPauseOverlay()},document.addEventListener("visibilitychange",this._visibilityHandler),this._networkOfflineHandler=()=>{if(this._hasKickedOff&&!this._isPaused&&this._currentIndex<this._questions.length){this._showLeaveWarning();const s=document.getElementById("match-exit-dialog")?.querySelector("div > div:nth-child(2)");s&&(s.innerHTML="⚠️ Your connection was lost. Reconnect to continue playing.")}},this._networkOnlineHandler=()=>{this._hasKickedOff&&this._isPaused&&this._currentIndex<this._questions.length&&this._hideLeaveWarning()},window.addEventListener("ethio-network-offline",this._networkOfflineHandler),window.addEventListener("ethio-network-online",this._networkOnlineHandler)}startMatch(){this._quizEngine.reset(),this._currentIndex=0,this._hasKickedOff=!1,this._session=$.getInstance().createSession(this._competition.id,"Medium",this._questions),window.ethioReviewData={questions:[],choices:[]},window.ethioOnBackPress=()=>{if(!this._hasKickedOff)return this._callbacks.onExitMatch(),!0;const e=document.getElementById("match-exit-dialog");return e&&e.style.display!=="none"?this._hideLeaveWarning():this._showLeaveWarning(),!0},this._renderKickOffScreen()}resumeSession(e){this._quizEngine.reset(),this._session=e,this._questions=e.questions,this._currentIndex=e.currentIndex,this._hasKickedOff=!0,this._isPaused=!1;for(let t=0;t<e.choices.length;t++){const i=e.choices[t],a=e.questions[t].correctIndex,r=e.responseTimes[t];this._quizEngine.recordAnswer(i===a,r)}window.ethioReviewData={questions:e.questions||[],choices:e.choices||[]},window.ethioOnBackPress=()=>{const t=document.getElementById("match-exit-dialog");return t&&t.style.display!=="none"?this._hideLeaveWarning():this._showLeaveWarning(),!0},this._renderQuestion(e.timeLeftSec)}_renderKickOffScreen(){const e=this._uiManager.container,t=this._competition.id==="all"?"QUICK MATCH.png":"DAILY CHALLENGE.png";e.innerHTML=`
            <div class="stadium-container ethio-bg-quiz" style="pointer-events: auto; display: flex; align-items: center; justify-content: center; padding: 0 28px; position: relative; height: 100vh; overflow: hidden;">
                ...
                <div class="kick-off-wrapper" style="position: relative; z-index: 10; width: 100%; max-width: 600px; margin: 0 auto; padding: 0 16px;">
                    ...
                    ${Ke.render({bannerUrl:`/assets/banners/${t}`,icon:this._competition.badge,title:this._competition.name,buttonId:"kick-off-btn",buttonText:o.currentLocale==="am"?"ጀምር":o.currentLocale==="om"?"EGGALI":"KICK OFF",showCloseButton:!0})}
        ...
        `}static Text(e,t){const i=t?.size?`font-size: ${t.size};`:"",a=t?.weight?`font-weight: ${t.weight};`:"",r=t?.color?`color: ${t.color};`:"",n=t?.margin?`margin: ${t.margin};`:"",s=t?.align?`text-align: ${t.align};`:"",l=t?.family?`font-family: ${t.family};`:"";return`<div style="${i} ${a} ${r} ${n} ${s} ${l}">${e}</div>`}static Flex(e,t){const i=t?.direction==="column"?"flex-direction: column;":"flex-direction: row;",a=t?.gap?`gap: ${t.gap};`:"",r=t?.align?`align-items: ${t.align};`:"align-items: center;",n=t?.justify?`justify-content: ${t.justify};`:"",s=t?.wrap?"flex-wrap: wrap;":"",l=t?.margin?`margin: ${t.margin};`:"";return`<div style="display: flex; ${i} ${a} ${r} ${n} ${s} ${l}">${e}</div>`}static Grid(e,t){const i=t?.minWidth||"280px",a=t?.gap?`gap: ${t.gap};`:"gap: var(--fds-space-16);",r=t?.margin?`margin: ${t.margin};`:"";return`<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(${i}, 1fr)); ${a} ${r}">${e}</div>`}static Dialog(e,t,i){return`
            <div class="glass-card" style="
                width: 100%;
                max-width: 480px;
                ...
                ">
                    ...
                    <div style="width: 100%; display: grid; grid-template-columns: 1fr 1fr; gap: 12px;">
                        <div style="grid-column: span 2;">
                            ${E.Button({id:"btn-play-again",text:o.currentLocale==="am"?"ድጋሚ ተጫወት":o.currentLocale==="om"?"Ammas Taphadhu":"Play Again",variant:"primary",fullWidth:!0,icon:"🔄"})}
                        </div>
                        
                        <div>
                            ${E.Button({id:"btn-review-game",text:o.currentLocale==="am"?"ከልስ":o.currentLocale==="om"?"Irra Deebi'i":"Review",variant:"secondary",fullWidth:!0,icon:"🔍"})}
                        </div>

                        <div>
                            ${E.Button({id:"btn-leaderboard",text:o.currentLocale==="am"?"ደረጃ":o.currentLocale==="om"?"Sadarkaa":"Rank",variant:"secondary",fullWidth:!0,icon:"📊"})}
                        </div>

                        <div style="grid-column: span 2;">
                            ${E.Button({id:"btn-home",text:o.currentLocale==="am"?"መነሻ":o.currentLocale==="om"?"Manattii":"Home",variant:"secondary",fullWidth:!0,icon:"🏠"})}
                        </div>
                    </div>
                </div>
            </div>
        ...
        `,this._bindEvents();const s=document.getElementById("final-score-rolling");s&&(this._hasAnimated||he.animate(s,0,this._finalScore,800));const l=Math.max(0,this._saveManager.profile.xp-a),c=this._saveManager.profile.xp,d=C.getLevel(l),h=C.getLevel(c),u=document.getElementById("xp-gained-rolling");u&&(this._hasAnimated||he.animate(u,0,a,800)),this._hasAnimated=!0;const f=document.getElementById("level-display-left"),x=document.getElementById("level-display-right"),v=document.getElementById("xp-progress-fill");f&&(f.innerText=`Lvl ${d.level}`),x&&(x.innerText=`Lvl ${d.level+1}`),v&&(v.style.width=`${d.progressPercent}%`,setTimeout(()=>{h.level>d.level?(v.style.width="100%",setTimeout(()=>{v.style.transition="none",v.style.width="0%",f&&(f.innerText=`Lvl ${h.level}`),x&&(x.innerText=`Lvl ${h.level+1}`),setTimeout(()=>{v.style.transition="width 1s cubic-bezier(0.34, 1.56, 0.64, 1)",v.style.width=`${h.progressPercent}%`},50),this._audioManager.playVictoryFanfare(),Oe.burst(window.innerWidth/2,window.innerHeight/2,100);const g=document.getElementById("level-up-toast");g&&(g.style.display="block")},1500)):v.style.width=`${h.progressPercent}%`},500))}_bindEvents(){const e=window;document.getElementById("btn-home")?.addEventListener("click",()=>{this._audioManager.playClick(),e.ethioForceHome?e.ethioForceHome():(e.ethioCloseGame&&e.ethioCloseGame(),e.ethioReloadHome&&e.ethioReloadHome())}),document.getElementById("btn-play-again")?.addEventListener("click",()=>{this._audioManager.playClick(),e.ethioCloseGame&&e.ethioCloseGame(),e.ethioPlayAgain?e.ethioPlayAgain(this._gameId):this._onContinue()}),document.getElementById("btn-leaderboard")?.addEventListener("click",()=>{this._audioManager.playClick(),e.ethioCloseGame&&e.ethioCloseGame(),e.ethioNavigateToTab?e.ethioNavigateToTab("rankings"):this._onContinue()});const t=document.getElementById("review-modal"),i=document.getElementById("review-questions-container");document.getElementById("btn-review-game")?.addEventListener("click",()=>{this._audioManager.playClick(),t&&i&&(this._renderReviewQuestions(i),t.style.display="flex")}),document.getElementById("btn-close-review")?.addEventListener("click",()=>{this._audioManager.playClick(),t&&(t.style.display="none")})}_renderReviewQuestions(e){const t=window.ethioReviewData||{questions:[],choices:[]},i=t.questions||[],a=t.choices||[];if(i.length===0){e.innerHTML=`
            ...
            `;return}e.innerHTML=i.map((n,s)=>{const l=a[s]!==void 0?a[s]:-1,c=l===n.correctIndex;let d="",h="";l===-1?(h="#F97316",d=`<span style="font-size: var(--fds-font-xs); font-weight: 900; color: ${h}; background: rgba(249,115,22,0.15); padding: 2px 8px; border-radius: 4px;">
                    ${o.currentLocale==="am"?"⏱ ጊዜ አልቋል":o.currentLocale==="om"?"⏱ Yeroon Dhumate":"⏱ Timeout"}
                </span>`):c?(h="#22C55E",d=`<span style="font-size: var(--fds-font-xs); font-weight: 900; color: ${h}; background: rgba(34,197,94,0.15); padding: 2px 8px; border-radius: 4px;">
                    ${o.currentLocale==="am"?"✓ ትክክል":o.currentLocale==="om"?"✓ Sirrii":"✓ Correct"}
                </span>`):(h="#EF4444",d=`<span style="font-size: var(--fds-font-xs); font-weight: 900; color: ${h}; background: rgba(239,68,68,0.15); padding: 2px 8px; border-radius: 4px;">
                    ${o.currentLocale==="am"?"✗ የተሳሳተ":o.currentLocale==="om"?"✗ Dogoggora":"✗ Wrong"}
                </span>`);const u=n.options.map((g,y)=>{const b=y===n.correctIndex,k=y===l;let A="rgba(0,0,0,0.3)",S="rgba(255,255,255,0.06)",L="",z="";b&&k?(A="rgba(34,197,94,0.15)",S="#22C55E",L='<span style="color: #22C55E; font-weight: bold; margin-right: 8px;">✓</span>',z='<div style="background: rgba(34,197,94,0.2); color: #4ADE80; font-size: 9px; padding: 2px 6px; border-radius: 4px; font-weight: bold; text-transform: uppercase;">Your Answer</div>'):b?(A="rgba(34,197,94,0.15)",S="#22C55E",L='<span style="color: #22C55E; font-weight: bold; margin-right: 8px;">✓</span>',z='<div style="background: rgba(34,197,94,0.2); color: #4ADE80; font-size: 9px; padding: 2px 6px; border-radius: 4px; font-weight: bold; text-transform: uppercase;">Correct Answer</div>'):k&&(A="rgba(239,68,68,0.15)",S="#EF4444",L='<span style="color: #EF4444; font-weight: bold; margin-right: 8px;">✗</span>',z='<div style="background: rgba(239,68,68,0.2); color: #F87171; font-size: 9px; padding: 2px 6px; border-radius: 4px; font-weight: bold; text-transform: uppercase;">Your Answer</div>');const W=String.fromCharCode(65+y)+".";return`
                    <div style="background: ${A}; border: 1px solid ${S}; padding: 10px 12px; border-radius: 8px; margin-bottom: 8px; display: flex; flex-direction: column; gap: 4px;">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            <div style="display: flex; align-items: center; font-size: var(--fds-font-sm); font-weight: 700; color: var(--fds-text-main);">
                                ${L}
                                <span style="color: var(--fds-gold-primary); margin-right: 8px;">${W}</span> 
                                ${g}
                            </div>
                            ${z}
                        </div>
                    </div>
                `}).join("");let f="";n.explanation&&(f=`
                ...
                <div class="glass-card" style="border-radius: 12px; padding: 16px; margin-bottom: 16px; border-color: ${h}; text-align: left;">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 6px;">
                        <span style="font-size: var(--fds-font-xs); font-weight: 800; color: var(--fds-text-dim); text-transform: uppercase;">
                            ${o.currentLocale==="am"?`ጥያቄ ${s+1}`:o.currentLocale==="om"?`Gaaffii ${s+1}`:`Question ${s+1}`}
                        </span>
                        ${d}
                    </div>
                    ...
                    <div class="comment-box-drawer" id="comment-drawer-${s}" style="display: none; margin-top: 12px; padding-top: 10px; border-top: 1px solid rgba(255,255,255,0.06);">
                        ...
                        <div style="display: flex; gap: 6px;">
                            <input type="text" id="comment-input-${s}" placeholder="${o.currentLocale==="am"?"አስተያየት ይፃፉ...":o.currentLocale==="om"?"Yaada barreessi...":"Write a comment..."}" style="flex: 1; background: rgba(0,0,0,0.4); border: 1px solid rgba(255,255,255,0.1); border-radius: 6px; padding: 6px 10px; color: var(--fds-text-main); font-size: var(--fds-font-xs);" />
                            <button class="btn-send-comment" data-q-idx="${s}" style="background: #009A44; border: none; color: var(--fds-text-main); padding: 6px 12px; border-radius: 6px; font-weight: 800; font-size: var(--fds-font-xs); cursor: pointer;">${o.currentLocale==="am"?"ለጥፍ":o.currentLocale==="om"?"Maxxansi":"Post"}</button>
                        </div>
                    </div>
                </div>
            `}).join(""),e.querySelectorAll(".glass-card").forEach((n,s)=>{const l=n.querySelector(".btn-review-like");l?.addEventListener("click",()=>{this._audioManager.playClick();const v=l.querySelector(".like-label"),g=l.querySelector(".heart-icon");l.classList.contains("liked")?(l.classList.remove("liked"),l.style.color="#94A3B8",v.innerText=o.currentLocale==="am"?"ውደድ":o.currentLocale==="om"?"Jaalladhu":"Like"):(l.classList.add("liked"),l.style.color="#EF4444",v.innerText=o.currentLocale==="am"?"ተወዷል":o.currentLocale==="om"?"Jaallatameera":"Liked",g&&(g.style.transform="scale(1.3)",setTimeout(()=>g.style.transform="scale(1)",200)))});const c=n.querySelector(".btn-review-comment"),d=n.querySelector(`#comment-drawer-${s}`),h=n.querySelector(`#comment-input-${s}`),u=n.querySelector(".btn-send-comment"),f=n.querySelector(`#comment-list-${s}`);c?.addEventListener("click",()=>{this._audioManager.playClick(),d&&(d.style.display=d.style.display==="none"?"block":"none",d.style.display==="block"&&h?.focus())}),u?.addEventListener("click",()=>{this._audioManager.playClick();const v=h?.value.trim();if(!v){G.show(o.currentLocale==="am"?"አስተያየት ባዶ ሊሆን አይችልም።":o.currentLocale==="om"?"Yaadni duwwaa ta'uu hin danda'u.":"Comment cannot be empty.","info");return}const g=document.createElement("div");g.style.cssText="background: rgba(0,0,0,0.2); padding: 6px 10px; border-radius: 6px;";const y=o.currentLocale==="am"?"እርስዎ:":o.currentLocale==="om"?"Isin:":"You:",b=o.currentLocale==="am"?"አሁን":o.currentLocale==="om"?"Amma":"Just now";g.innerHTML=`<strong style="color: #4ADE80;">${y}</strong> ${v} <span style="font-size: var(--fds-font-xs); color: var(--fds-text-dim); float: right;">${b}</span>`,f.appendChild(g),h.value="",f.scrollTop=f.scrollHeight,G.show(o.currentLocale==="am"?"አስተያየት ተለጥፏል!":o.currentLocale==="om"?"Yaadni maxxanfameera!":"Comment posted!","success")}),n.querySelector(".btn-review-share")?.addEventListener("click",async()=>{this._audioManager.playClick();const v=o.currentLocale==="am"?`⚽ በኢትዮ ቴሌኮም የእግር ኳስ ውድድር ላይ እየተወዳደርኩ ነው!
...
${window.location.href}`),G.show(o.currentLocale==="am"?"የእግር ኳስ መጋበዣ ሊንክ ወደ ቅሊፕቦርድ ተገልብጧል! ለመፎካከር ለጓደኞችዎ ያጋሩ።":o.currentLocale==="om"?"Geessituun affeerraa kubbaa miilaa kooppii ta'eera! Hiriyoota keetiif qooduun isaan qori.":"Football invitation link copied to clipboard! Share with friends to challenge them.","success")})})}}class Ze{metadata={id:"football-quiz",name:"Football Quiz League",description:"Televised sports match quiz with match stats, goal celebrations, and rewards!"};_uiManager;_audioManager;_saveManager;_quizEngine;_activeScoreboard=null;_targetCompetitionId="walia-ibex";_preloadedQuestions=null;matchType="casual";dailyChallengeId;async initialize(e){this._uiManager=e,this._quizEngine=new We;const t=window;this._audioManager=t.ethioAudio||new $e,this._saveManager=t.ethioSave||new Ce}async start(){const e=I.getById(this._targetCompetitionId)||I.getAll()[0];let t=this._preloadedQuestions;(!t||t.length===0)&&(t=await H.getInstance().fetchQuestions(e.id,10,o.currentLocale)),this._activeScoreboard=new Me(this._uiManager,this._audioManager,this._quizEngine,e,t,{onMatchComplete:(i,a)=>this._showMatchStats(e.id,i,a),onExitMatch:()=>this.destroy()}),this._activeScoreboard.startMatch()}async resume(e){const t=I.getById(e.matchType)||I.getAll()[0];this._activeScoreboard=new Me(this._uiManager,this._audioManager,this._quizEngine,t,e.questions,{onMatchComplete:(i,a)=>this._showMatchStats(t.id,i,a),onExitMatch:()=>this.destroy()}),this._activeScoreboard.resumeSession(e)}setCompetition(e){this._targetCompetitionId=e}setPreloadedQuestions(e){this._preloadedQuestions=e}_showMatchStats(e,t,i){const a=window;a.ethioCache&&a.ethioCache.setQuizActive(!1);const r=this.matchType==="daily"?"daily":e,n=new Je(this._uiManager,this._saveManager,this._audioManager,t,i,r,()=>{const s=window;s.ethioCloseGame?s.ethioCloseGame():s.ethioReloadHome&&s.ethioReloadHome()});this.matchType==="daily"&&this.dailyChallengeId&&(n.dailyChallengeId=this.dailyChallengeId),n.render()}update(e){}destroy(){this._activeScoreboard&&(this._activeScoreboard.destroy(),this._activeScoreboard=null),this._uiManager.clear(),console.log("[QuizGameMode] Destroyed.");const e=window;e.ethioCloseGame?e.ethioCloseGame():e.ethioReloadHome&&e.ethioReloadHome()}}class Z{static _instance=null;static getInstance(){return Z._instance||(Z._instance=new Z),Z._instance}async fetchPlatformAnalytics(){if(_.isOnline&&m)try{const{count:e}=await m.from("users").select("*",{count:"exact",head:!0}),{count:t}=await m.from("matches").select("*",{count:"exact",head:!0}),{count:i}=await m.from("competitions").select("*",{count:"exact",head:!0}),{count:a}=await m.from("subscriptions").select("*",{count:"exact",head:!0});return{activePlayers:e||124500,totalMatches:t||185e4,activeCompetitions:i||15,subscribedUsers:a||88200,smsOtpSuccessRate:"99.4%",avgLatencyMs:12}}catch(e){console.warn("[AnalyticsService] Supabase analytics query failed, returning fallback metrics:",e)}return{activePlayers:124500,totalMatches:185e4,activeCompetitions:15,subscribedUsers:88200,smsOtpSuccessRate:"99.4%",avgLatencyMs:12}}}class w{static render(e,t="",i=!0){return`
        ...
        `}static bind(e,t){const i=e.querySelector(".app-bar-back-btn");i&&i.addEventListener("click",a=>{a.preventDefault(),t()})}}class et{_uiManager;_audioManager;_onClose;_activeTab="QUESTIONS";_statusMessage="";_analyticsData=null;constructor(e,t,i){this._uiManager=e,this._audioManager=t,this._onClose=i}async render(){const e=this._uiManager.container,t=I.getAll();this._analyticsData=await Z.getInstance().fetchPlatformAnalytics(),e.innerHTML=`
        ...
        `,this._bindEvents()}_renderTabContent(e){switch(this._activeTab){case"QUESTIONS":return this._renderQuestionsTab();case"BULK_IMPORT":return this._renderBulkImportTab();case"COMPETITIONS":return this._renderCompetitionsTab(e);case"ANALYTICS":return this._renderAnalyticsTab(e)}}_renderQuestionsTab(){return`
            ...
            <div class="glass-card" style="padding: 24px; margin-bottom: 24px;">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 12px; margin-bottom: 14px;">
                    <div>
                        ...
                        <select id="q-category" class="form-input">
                            ${Object.values(ze).map(t=>`<option value="${t.id}">${t.badge} ${t.nameEn}</option>`).join("")}
                        </select>
                    </div>
                    <div>
                ...
                ${E.Button({id:"add-question-btn",text:"SAVE QUESTION TO CLOUD DATABASE",icon:"💾",variant:"primary",fullWidth:!0})}
            </div>
...
world-cup,1,Which country hosted 2022 World Cup?,Qatar,Brazil,Russia,South Africa,0" style="font-family: monospace; font-size: var(--fds-font-xs); margin-bottom: 16px;"></textarea>
                ...
                ${E.Button({id:"import-csv-btn",text:"PROCESS & IMPORT QUESTIONS",icon:"🚀",variant:"primary",fullWidth:!0})}
            </div>
        `}_renderCompetitionsTab(e){return`
            ...
            <div class="glass-card" style="padding: 24px; margin-bottom: 24px;">
                ...
                ${E.Button({id:"admin-add-comp-btn",text:"SAVE & PUBLISH COMPETITION",variant:"primary",fullWidth:!0})}
            </div>
        ...
        `}_bindEvents(){const e=this._uiManager.container;w.bind(e,()=>{this._audioManager.playClick(),this._onClose()}),e.querySelectorAll(".tab-btn").forEach(t=>{t.addEventListener("click",i=>{this._audioManager.playClick();const a=i.currentTarget.getAttribute("data-tab");a&&(this._activeTab=a,this._statusMessage="",this.render())})}),e.querySelector("#add-question-btn")?.addEventListener("click",async()=>{this._audioManager.playClick();const t=e.querySelector("#q-category")?.value,i=parseInt(e.querySelector("#q-difficulty")?.value||"2",10),a=parseInt(e.querySelector("#q-correct")?.value||"0",10),r=e.querySelector("#q-prompt-en")?.value.trim(),n=e.querySelector("#q-prompt-am")?.value.trim(),s=e.querySelector("#q-prompt-om")?.value.trim(),l=e.querySelector("#q-opt0-en")?.value.trim(),c=e.querySelector("#q-opt1-en")?.value.trim(),d=e.querySelector("#q-opt2-en")?.value.trim(),h=e.querySelector("#q-opt3-en")?.value.trim(),u=e.querySelector("#q-opt0-am")?.value.trim(),f=e.querySelector("#q-opt1-am")?.value.trim(),x=e.querySelector("#q-opt2-am")?.value.trim(),v=e.querySelector("#q-opt3-am")?.value.trim(),g=e.querySelector("#q-opt0-om")?.value.trim(),y=e.querySelector("#q-opt1-om")?.value.trim(),b=e.querySelector("#q-opt2-om")?.value.trim(),k=e.querySelector("#q-opt3-om")?.value.trim();if(!r||!l||!c||!d||!h){this._statusMessage="❌ Please fill in the English prompt and all 4 English options.",this.render();return}const A={category:t,difficulty:i,competition_id:t,prompt_en:r,prompt_am:n||null,prompt_om:s||null,options_en:[l,c,d,h],options_am:u&&f&&x&&v?[u,f,x,v]:null,options_om:g&&y&&b&&k?[g,y,b,k]:null,correct_index:a,is_active:!0};if(m){const{error:S}=await m.from("questions").insert(A);S?this._statusMessage=`❌ Cloud Insert Failed: ${S.message}`:this._statusMessage="✅ Question published to Cloud database successfully!"}else this._statusMessage="✅ Question added locally (Supabase offline).";this.render()}),e.querySelector("#import-csv-btn")?.addEventListener("click",async()=>{this._audioManager.playClick();const t=e.querySelector("#bulk-csv-area")?.value.trim();if(!t){this._statusMessage="❌ Please paste CSV content to import.",this.render();return}const i=t.split(`
`).map(n=>n.trim()).filter(n=>n.length>0);if(i.length<2){this._statusMessage="❌ CSV must contain a header row and at least 1 data row.",this.render();return}let a=0;const r=i.slice(1);for(const n of r){const s=n.split(",").map(l=>l.trim());if(s.length>=8){const[l,c,d,h,u,f,x,v]=s,g={category:l||"football-history",difficulty:parseInt(c||"1",10),competition_id:l||"football-history",prompt_en:d,options_en:[h,u,f,x],correct_index:parseInt(v||"0",10),is_active:!0};m&&await m.from("questions").insert(g),a++}}this._statusMessage=`✅ Successfully processed & imported ${a} questions!`,this.render()}),e.querySelector("#admin-add-comp-btn")?.addEventListener("click",()=>{const t=e.querySelector("#admin-comp-name"),i=e.querySelector("#admin-comp-badge"),a=e.querySelector("#admin-comp-desc");if(t&&t.value.trim()!==""){const r=t.value.toLowerCase().replace(/\s+/g,"-");I.addCompetition({id:r,name:t.value.trim(),nameEn:t.value.trim(),badge:i.value.trim()||"⚽",description:a.value.trim()||"Custom Competition",color:"#1e3a8a",questionCount:10}),this._audioManager.playClick(),this._statusMessage=`✅ Competition '${t.value.trim()}' Published Successfully!`,this.render()}})}}class D{static _instance=null;static getInstance(){return D._instance||(D._instance=new D),D._instance}async getLeaderboard(e,t="all_time",i=50){if(_.isOnline&&m)try{if(t==="daily"){const a=new Date().toISOString().split("T")[0],{data:r,error:n}=await m.rpc("get_daily_leaderboard",{p_date:a});if(!n&&r&&Array.isArray(r))return r.map((l,c)=>({rank:c+1,userId:l.user_id,username:l.username||"Anonymous Player",avatarUrl:l.avatar_url,eloRating:1200,score:l.score||0,matchesPlayed:1,wins:1}))}else{const{data:a,error:r}=await m.rpc("get_leaderboard",{p_competition_id:e||null,p_time_range:t,p_limit:i});if(!r&&a&&Array.isArray(a))return a.map(n=>({rank:n.rank,userId:n.user_id,username:n.username||"Anonymous Player",avatarUrl:n.avatar_url,eloRating:n.elo_rating||1200,score:n.score||0,matchesPlayed:n.matches_played||0,wins:n.wins||0}))}}catch(a){console.warn("[LeaderboardService] RPC query failed, returning empty list:",a)}return[]}async getUserRank(e,t){if(!e)return null;try{const a=(await this.getLeaderboard(t)).find(r=>r.userId===e);if(a)return a.rank}catch(i){console.warn("[LeaderboardService] Failed to get user rank:",i)}return null}async getMyDailyStats(){if(!m||!_.isOnline)return null;try{const{data:{user:e}}=await m.auth.getUser();if(!e)return null;const t=new Date().toISOString().split("T")[0],{data:i,error:a}=await m.rpc("get_daily_leaderboard",{p_date:t});if(a||!i||!Array.isArray(i))return null;const r=i.findIndex(n=>n.user_id===e.id);return r===-1?null:{rank:String(r+1),score:String(i[r].score||0)}}catch(e){return console.warn("[LeaderboardService] getMyDailyStats failed:",e),null}}}class Q{static _instance=null;static getInstance(){return Q._instance||(Q._instance=new Q),Q._instance}async getTodayChallenge(){if(_.isOnline&&m)try{const{data:t,error:i}=await m.rpc("get_daily_challenge");if(!i&&t){const a=t;if(a.available&&a.question_ids&&a.question_ids.length>0){const r=await H.getInstance().fetchQuestionsByIds(a.question_ids,o.currentLocale),n=a.completed||!1;return{id:a.id,themeEn:a.theme_en||"Daily Football Quiz Challenge",themeAm:a.theme_am||"የዕለቱ የእግር ኳስ ጥያቄ ተግዳሮት",themeOm:a.theme_om||"Qormaata Gaaffii Kubbaa Miilaa Guyyaa",bonusMultiplier:a.bonusMultiplier||1.5,completed:n,questions:r}}}}catch(t){console.warn("[DailyChallengeManager] Supabase fetch failed:",t)}return{themeEn:"Daily Champions Challenge",themeAm:"የዕለቱ የሻምፒዮኖች ተግዳሮት",themeOm:"Qormaata Chaampiyoonii Guyyaa",bonusMultiplier:1.5,completed:!1,questions:await H.getInstance().fetchQuestions("world-cup",10,o.currentLocale)}}}class tt{static checkAndShow(e){const t="ETHIO_FOOTBALL_LAST_LOGIN",i=new Date().toISOString().split("T")[0];if(localStorage.getItem(t)===i)return;localStorage.setItem(t,i);const n=(e.profile.streakCount||0)+1;e.updateStreak(n);const s=100+n*25;e.addXp(s)}}class U{static _instance=null;_memoryCache=new Map;_isQuizActive=!1;static getInstance(){return U._instance||(U._instance=new U),U._instance}constructor(){}setQuizActive(e){this._isQuizActive=e}get isQuizActive(){return this._isQuizActive}async getOrFetch(e,t,i={}){const a=i.ttlMs??3e5,r=this.get(e);if(r&&!i.forceRefresh&&!this.isStale(e)||this._isQuizActive&&r)return r;try{const n=await t();return this.set(e,n,a),n}catch(n){if(r)return r;throw n}}get(e){return this._memoryCache.has(e)?this._memoryCache.get(e).data:null}set(e,t,i=300*1e3){this._memoryCache.set(e,{data:t,timestamp:Date.now(),ttlMs:i})}isStale(e){const t=this._memoryCache.get(e);return t?Date.now()-t.timestamp>t.ttlMs:!0}invalidate(e){this._memoryCache.delete(e)}clear(){this._memoryCache.clear()}}class re{static attach(e,t){let i=0,a=0,r=!1;const n=document.createElement("div");n.className="pull-to-refresh-indicator",n.style.cssText=`
            position: absolute;
            top: -50px;
            left: 50%;
        ...
        `,e.style.position="relative",e.appendChild(n),e.addEventListener("touchstart",s=>{U.getInstance().isQuizActive||e.scrollTop<=0&&(i=s.touches[0].clientY,r=!0)},{passive:!0}),e.addEventListener("touchmove",s=>{if(!r||U.getInstance().isQuizActive)return;a=s.touches[0].clientY;const l=a-i;if(l>0&&e.scrollTop<=0){const c=Math.min(l*.45,75);n.style.top=`${c-42}px`,n.style.opacity=`${Math.min(c/50,1)}`;const d=n.querySelector("svg");d&&(d.style.transform=`rotate(${c*4}deg)`)}},{passive:!0}),e.addEventListener("touchend",async()=>{if(!r||U.getInstance().isQuizActive)return;if(r=!1,a-i>110&&e.scrollTop<=0){n.style.top="16px";const c=n.querySelector("svg");c&&(c.style.transition="transform 1s linear",c.style.transform="rotate(1080deg)");const d=e.scrollTop;try{await t(),e.scrollTop=d}catch(h){console.error("[PullToRefresh] Refresh failed:",h)}}n.style.pointerEvents="none",n.style.top="-50px",n.style.opacity="0";const l=n.querySelector("svg");l&&(l.style.transition="none",l.style.transform="rotate(0deg)"),i=0,a=0})}}class it{_saveManager;_audioManager;_uiManager;_callbacks;_timerInterval=null;_autoScrollInterval=null;_resetHandler=null;constructor(e,t,i,a){this._saveManager=e,this._audioManager=t,this._uiManager=i,this._callbacks=a}render(){const e=this._uiManager.container,t=this._saveManager.profile,i=t.totalMatches||0,a=i>0?Math.round((t.totalWins||0)/i*100):0,r=t.streakCount||0,n=$.getInstance().getActiveSession();let s="";n&&n.matchType==="daily"&&(s+=`
                <div class="glass-card fade-in-up" style="padding: clamp(12px, 2vh, 16px); border-color: rgba(34,197,94,0.3); border-radius: 16px; display: flex; align-items: center; justify-content: space-between;">
                    ...
                    ${E.Button({id:"btn-continue-challenge",text:"Resume",variant:"primary"})}
                </div>
            `),e.innerHTML=`
        ...
        `,this._startCountdownTimer(),this._bindEvents(),this._fetchDynamicData();const l=e.querySelector(".stadium-container");l&&re.attach(l,async()=>{this._audioManager.playClick(),await new Promise(c=>setTimeout(c,600)),this.render()}),tt.checkAndShow(this._saveManager),this._resetHandler||(this._resetHandler=()=>{this.render()},window.addEventListener("ethio:dailyReset",this._resetHandler))}async _fetchDynamicData(){try{const n=(await Q.getInstance().getTodayChallenge()).completed,s=document.getElementById("home-daily-action");s&&(n?(s.innerHTML=`
                        ...
                        </div>`,this._startCountdownTimer()):(s.innerHTML=`${E.Button({id:"btn-daily-match",text:"DAILY CHALLENGE",variant:"primary",fullWidth:!0})}`,document.getElementById("btn-daily-match")?.addEventListener("click",c=>{this._addRipple(c),this._audioManager.playClick(),this._callbacks.onDailyChallenge()})))}catch{const n=document.getElementById("home-daily-action");n&&(n.innerHTML=`${E.Button({id:"btn-daily-match",text:"DAILY CHALLENGE",variant:"primary",fullWidth:!0})}`,document.getElementById("btn-daily-match")?.addEventListener("click",()=>this._callbacks.onDailyChallenge()))}try{const r=await D.getInstance().getMyDailyStats(),n=document.getElementById("home-daily-rank"),s=document.getElementById("home-daily-score");n&&(n.textContent=r?`#${r.rank}`:"Unranked"),s&&(s.textContent=r?r.score:"0")}catch{}const e=I.getAll().filter(r=>r.status==="live"),t=e.find(r=>r.id==="daily")||e[0],i=document.getElementById("daily-players-count"),a=document.getElementById("daily-play-btn-text");t?(i&&(i.innerHTML=`🟢 LIVE MATCH • ${(t.participants||0).toLocaleString()} PLAYERS`),a&&(a.innerText=`⚡ KICK OFF NOW (+${t.prize_pool||0} XP)`)):(i&&(i.innerHTML="⚪ NO LIVE MATCHES"),a&&(a.innerText="⚡ PLAY CASUAL MATCH"));try{const r=await D.getInstance().getLeaderboard(void 0,"all_time",3),n=document.getElementById("home-leaderboard-preview");if(n&&r.length>0){const s=["🥇","🥈","🥉"],l=["rgba(255,215,0,0.08)","rgba(255,255,255,0.04)","rgba(255,255,255,0.02)"],c=["white","#E2E8F0","#CBD5E1"];n.innerHTML=r.map((d,h)=>`
        ...
        `,this._bindEvents()}_bindEvents(){this._uiManager.container.querySelectorAll(".category-btn").forEach(i=>{i.addEventListener("click",a=>{const r=a.currentTarget,n=r.getAttribute("data-category")||"random",s=r.getBoundingClientRect(),l=a,c=document.createElement("div"),d=Math.max(r.clientWidth,r.clientHeight),h=d/2;let u=l.clientX-s.left-h,f=l.clientY-s.top-h;c.style.width=c.style.height=`${d}px`,c.style.left=`${u}px`,c.style.top=`${f}px`,c.classList.add("ripple"),r.appendChild(c),setTimeout(()=>c.remove(),600),this._audioManager.playClick(),this._callbacks.onCasualPlay(n)})})}destroy(){}}class B{static _instance=null;_currentUser=null;_listeners=new Set;_saveManager;constructor(e){this._saveManager=e,this._initSession()}static normalisePhone(e){const t=e.replace(/\D/g,"");return t.startsWith("251")?"+"+t:t.startsWith("0")?"+251"+t.slice(1):e.startsWith("+")?e.replace(/\s+/g,""):"+251"+t}static getInstance(e){if(!B._instance){if(!e)throw new Error("[AuthManager] SaveManager required for initial instantiation.");B._instance=new B(e)}return B._instance}async _initSession(){if(!_.isOnline||!m){console.log("[AuthManager] Offline mode active."),this._notifyListeners();return}try{const{data:{session:e}}=await m.auth.getSession();e?.user?await this._fetchUserProfile(e.user.id):this._notifyListeners()}catch(e){console.error("[AuthManager] Failed to fetch session:",e),this._notifyListeners()}m.auth.onAuthStateChange(async(e,t)=>{console.log(`[AuthManager] Auth state changed: ${e}`),t?.user?await this._fetchUserProfile(t.user.id):(this._currentUser=null,this._notifyListeners())})}async refreshProfile(){this._currentUser&&await this._fetchUserProfile(this._currentUser.id)}async _fetchUserProfile(e,t=5,i){if(m){for(let a=0;a<t;a++){const{data:r,error:n}=await m.from("users").select("*").eq("id",e).single();if(n){if(n.code==="PGRST116"){const s=i?`Player_${i.slice(-4)}`:`Player_${e.slice(-4)}`,{data:l,error:c}=await m.from("users").insert({id:e,username:s,phone:i||null,locale:"en",elo_rating:0,coins:0,xp:0,total_matches:0,total_wins:0,subscription_tier:"free",streak_count:0,created_at:new Date().toISOString(),last_active:new Date().toISOString()}).select().single();if(!c&&l){this._currentUser=l,this._saveManager.syncWithCloudUser(l),this._notifyListeners(),console.log("[AuthManager] Created new user profile:",s);return}console.error("[AuthManager] Failed to create user profile:",c);break}if(console.warn(`[AuthManager] Error fetching user profile (attempt ${a+1}/${t}):`,n),a<t-1){await new Promise(s=>setTimeout(s,500));continue}}else if(r){this._currentUser=r,this._saveManager.syncWithCloudUser(r),this._notifyListeners();return}}console.error("[AuthManager] Failed to fetch user profile after retries."),this._notifyListeners()}}async signInWithPhone(e){if(!m)return{success:!1,error:"Supabase client offline"};const t=B.normalisePhone(e);try{const{error:i}=await m.auth.signInWithOtp({phone:t});return i?{success:!1,error:i.message}:{success:!0}}catch(i){return{success:!1,error:i.message||"Failed to send OTP"}}}async verifyOtp(e,t){if(!m)return{success:!1,error:"Supabase client offline"};const i=B.normalisePhone(e);try{const{data:a,error:r}=await m.auth.verifyOtp({phone:i,token:t,type:"sms"});return r?(console.error("[AuthManager] OTP Verification error:",r),{success:!1,error:r.message}):(a.user&&await this._fetchUserProfile(a.user.id,5,i),{success:!0})}catch(a){return{success:!1,error:a.message||"OTP verification failed"}}}async signOut(){m&&await m.auth.signOut(),this._currentUser=null,this._notifyListeners()}subscribe(e){return this._listeners.add(e),e(this._currentUser),()=>this._listeners.delete(e)}_notifyListeners(){this._listeners.forEach(e=>e(this._currentUser))}get currentUser(){return this._currentUser}get isGuest(){return!1}get isAuthenticated(){return this._currentUser!==null}}const nt=Object.freeze(Object.defineProperty({__proto__:null,AuthManager:B},Symbol.toStringTag,{value:"Module"}));class rt{_uiManager;_audioManager;_authManager;_onSuccess;_phoneStep="INPUT_PHONE";_pendingPhone="";_statusMessage="";_devOtpCode="";_showSettings=!1;_settingsTab="main";_faqExpandedIndex=-1;_bannerInterval=null;_currentBanner=1;constructor(e,t,i,a){this._uiManager=e,this._audioManager=t,this._authManager=i,this._onSuccess=a,window.ethioOnBackPress=()=>this._showSettings?(this._settingsTab!=="main"?this._settingsTab="main":this._showSettings=!1,this.render(),!0):!1}_renderSettingsContent(){return this._settingsTab==="main"?`
                <div class="settings-tile" data-tab="language" style="display: flex; align-items: center; justify-content: space-between; padding: 16px; border-bottom: 1px solid rgba(255,255,255,0.1); cursor: pointer; background: rgba(255,255,255,0.05); border-radius: 12px 12px 0 0;">
                    <div style="font-weight: 700; font-size: 16px;">${o.currentLocale==="am"?"ቋንቋ":o.currentLocale==="om"?"Afaan":"Language"}</div>
                    <div style="display: flex; align-items: center; gap: 8px;">
                        <span style="color: #94A3B8;">${o.currentLocale==="am"?"አማርኛ":o.currentLocale==="om"?"Afan Oromo":"English"}</span>
                        <span>❯</span>
                    </div>
                </div>
                <div class="settings-tile sound-toggle" style="display: flex; align-items: center; justify-content: space-between; padding: 16px; border-bottom: 1px solid rgba(255,255,255,0.1); cursor: pointer; background: rgba(255,255,255,0.05);">
                    <div style="font-weight: 700; font-size: 16px;">${o.currentLocale==="am"?"የድምፅ ውጤቶች":o.currentLocale==="om"?"Sagalee":"Sound Effects"}</div>
                ...
                <div class="settings-tile" data-tab="tc" style="display: flex; align-items: center; justify-content: space-between; padding: 16px; border-bottom: 1px solid rgba(255,255,255,0.1); cursor: pointer; background: rgba(255,255,255,0.05);">
                    <div style="font-weight: 700; font-size: 16px;">${o.currentLocale==="am"?"ውሎች እና ሁኔታዎች":o.currentLocale==="om"?"Waliigaltee & Haalawwan":"Terms & Conditions"}</div>
                    <span>❯</span>
                </div>
            ...
            ">
                ...
                <div id="auth-banner-dots" style="display: flex; gap: 6px; margin-top: 12px; margin-bottom: clamp(12px, 2.5vh, 20px);">
                    ${Array.from({length:10}).map((a,r)=>`
                        <div style="width: 6px; height: 6px; border-radius: 50%; background: ${this._currentBanner===r+1?"#00C853":"rgba(255,255,255,0.2)"}; transition: background 0.3s ease;"></div>
                    `).join("")}
                </div>
                ...
                <div style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; background: #0F172A; z-index: 1000; display: flex; flex-direction: column; overflow-y: auto; overflow-x: hidden;">
                    <div style="display: flex; align-items: center; height: 72px; padding: env(safe-area-inset-top) 0 0 0; background: #020617; border-bottom: 1px solid rgba(255,255,255,0.1); box-sizing: content-box;">
                        ...
                        <div style="flex: 1; color: white; font-weight: 700; font-size: 18px; text-transform: uppercase;">
                            ${this._settingsTab==="main"?o.currentLocale==="am"?"ቅንብሮች":o.currentLocale==="om"?"Qindaa'inoota":"Settings":this._settingsTab==="language"?o.currentLocale==="am"?"ቋንቋ ይምረጡ":o.currentLocale==="om"?"Afaan Filadhu":"Select Language":this._settingsTab==="tc"?"Terms & Conditions":"FAQ"}
                        </div>
                    </div>
                ...
                " onmouseover="this.style.background='rgba(0,200,83,0.1)'" onmouseout="this.style.background='rgba(15, 23, 42, 0.6)'">
                    ${o.currentLocale==="am"?"ሰብስክራይብ":o.currentLocale==="om"?"Galmoofadhu":"Subscribe"}
                </button>
            </div>
        `,this._bindEvents()}_bindEvents(){const e=this._uiManager.container,t=e.querySelector("#auth-banner-container");if(t){let h=0,u=0,f=!1;const x=b=>{this._currentBanner+=b,this._currentBanner>10&&(this._currentBanner=1),this._currentBanner<1&&(this._currentBanner=10),this.render()},v=b=>{h=b,f=!0},g=b=>{f&&(u=b)},y=()=>{if(!f)return;f=!1;const b=h-u;Math.abs(b)>50&&u!==0&&x(b>0?1:-1),u=0};t.addEventListener("touchstart",b=>v(b.touches[0].clientX)),t.addEventListener("touchmove",b=>g(b.touches[0].clientX)),t.addEventListener("touchend",y),t.addEventListener("mousedown",b=>v(b.clientX)),t.addEventListener("mousemove",b=>g(b.clientX)),t.addEventListener("mouseup",y),t.addEventListener("mouseleave",y)}this._bannerInterval&&(clearInterval(this._bannerInterval),this._bannerInterval=null),this._showSettings||(this._bannerInterval=setInterval(()=>{const h=e.querySelector("#auth-banner-bg"),u=e.querySelector("#auth-banner-fg");h&&u&&(u.style.opacity="1",setTimeout(()=>{if(!h||!u)return;h.src=u.src,u.style.transition="none",u.style.opacity="0",this._currentBanner=this._currentBanner>=10?1:this._currentBanner+1;const f=this._currentBanner>=10?1:this._currentBanner+1;u.src=`/assets/banners/${f}.png`,e.querySelectorAll("#auth-banner-dots > div").forEach((v,g)=>{v.style.background=this._currentBanner===g+1?"#00C853":"rgba(255,255,255,0.2)"}),u.offsetWidth,u.style.transition="opacity 0.8s ease-in-out"},800))},4e3)),e.querySelector("#phone-input")?.addEventListener("input",h=>{const u=h.target;u.value=u.value.replace(/[^0-9+]/g,""),u.value.indexOf("+")>0&&(u.value=u.value.replace(/\+/g,""))}),e.querySelector("#otp-input")?.addEventListener("input",h=>{const u=h.target,f=e.querySelector("#verify-otp-btn");f&&(u.value.trim().length===6?(f.disabled=!1,f.style.opacity="1",f.style.cursor="pointer"):(f.disabled=!0,f.style.opacity="0.5",f.style.cursor="not-allowed"))});const i=e.querySelector("#send-otp-btn");i&&i.addEventListener("click",async()=>{this._audioManager.playClick();const u=e.querySelector("#phone-input")?.value.trim()||"";if(!u){this._statusMessage=o.currentLocale==="am"?"እባክዎን ትክክለኛ የስልክ ቁጥር ያስገቡ።":o.currentLocale==="om"?"Maaloo lakkoofsa bilbilaa sirrii ta'e galchaa.":"Please enter a valid phone number.",this.render();return}const f=B.normalisePhone(u);this._pendingPhone=f,this._devOtpCode="",this._statusMessage=o.currentLocale==="am"?"የኦቲፒ መልዕክት በመላክ ላይ...":o.currentLocale==="om"?"OTP SMS ergaa jira...":"Sending OTP...",this.render();const x=await this._authManager.signInWithPhone(f);x.success?(this._phoneStep="INPUT_OTP",this._statusMessage="",this._fetchDevOtp(f)):this._statusMessage=x.error||(o.currentLocale==="am"?"ኮድ መላክ አልተቻለም።":o.currentLocale==="om"?"OTP erguun hin danda'amne.":"Failed to send OTP."),this.render()});const a=e.querySelector("#verify-otp-btn");a&&a.addEventListener("click",async()=>{this._audioManager.playClick();const u=e.querySelector("#otp-input")?.value.trim()||"";if(u.length!==6){this._statusMessage=o.currentLocale==="am"?"እባክዎን የ 6-አሃዝ ማረጋገጫ ኮድ ያስገቡ።":o.currentLocale==="om"?"Maaloo koodii mirkaneessaa dijiitii 6 galchaa.":"Please enter a 6-digit verification code.",this.render();return}this._statusMessage=o.currentLocale==="am"?"ኮድ በመፈተሽ ላይ...":o.currentLocale==="om"?"Koodii mirkaneessaa jira...":"Verifying code...",this.render();const f=await this._authManager.verifyOtp(this._pendingPhone,u);f.success?this._onSuccess():(this._statusMessage=f.error||(o.currentLocale==="am"?"የተሳሳተ የማረጋገጫ ኮድ።":o.currentLocale==="om"?"Koodii mirkaneessaa dogoggoraa.":"Invalid verification code."),this.render())});const r=e.querySelector("#change-phone-btn");r&&r.addEventListener("click",()=>{this._audioManager.playClick(),this._phoneStep="INPUT_PHONE",this._statusMessage="",this._devOtpCode="",this.render()});const n=e.querySelector("#auth-settings-btn");n&&n.addEventListener("click",()=>{this._audioManager.playClick(),this._showSettings=!0,this._settingsTab="main",this.render()});const s=e.querySelector("#auth-settings-back");s&&s.addEventListener("click",()=>{this._audioManager.playClick(),this._settingsTab!=="main"?this._settingsTab="main":this._showSettings=!1,this.render()}),e.querySelectorAll(".settings-tile[data-tab]").forEach(h=>{h.addEventListener("click",u=>{this._audioManager.playClick(),this._settingsTab=u.currentTarget.getAttribute("data-tab"),this.render()})}),e.querySelector(".sound-toggle")?.addEventListener("click",()=>{this._audioManager.toggleMute(),this._audioManager.playClick();const h=this._audioManager.isMuted;localStorage.setItem("ETHIO_FOOTBALL_MUTED",String(h));const u=localStorage.getItem("ETHIO_FOOTBALL_SETTINGS_V2");if(u)try{const f=JSON.parse(u);f.soundEffects=!h,localStorage.setItem("ETHIO_FOOTBALL_SETTINGS_V2",JSON.stringify(f))}catch{}this.render()}),e.querySelectorAll(".lang-item").forEach(h=>{h.addEventListener("click",u=>{const f=u.currentTarget.getAttribute("data-lang");o.setLocale(f),this._audioManager.playClick(),this._settingsTab="main",this.render()})}),e.querySelectorAll(".faq-item").forEach(h=>{h.addEventListener("click",u=>{const f=parseInt(u.currentTarget.getAttribute("data-idx")||"-1",10);this._faqExpandedIndex=this._faqExpandedIndex===f?-1:f,this._audioManager.playClick(),this.render()})});const l=e.querySelector("#auth-subscribe-btn"),c=e.querySelector("#btn-register-here"),d=()=>{this._audioManager.playClick(),window.location.href="sms:9401?body=OK"};l&&l.addEventListener("click",d),c&&c.addEventListener("click",d)}async _fetchDevOtp(e){if(m)for(let t=0;t<8;t++){await new Promise(i=>setTimeout(i,800));try{const{data:i}=await m.from("dev_otps").select("code").eq("phone",e).maybeSingle();if(i?.code){this._devOtpCode=String(i.code),this.render();const a=this._uiManager.container.querySelector("#otp-input");a&&(a.value=this._devOtpCode,a.dispatchEvent(new Event("input",{bubbles:!0})));return}}catch{return}}}}class ee{static instance;channels=new Map;listeners=new Map;constructor(){}static getInstance(){return ee.instance||(ee.instance=new ee),ee.instance}initUserChannels(e){if(!_.isOnline){console.warn("[RealtimeService] Offline mode: Cannot initialize channels.");return}const t=m;if(!t)return;this.cleanup();const i=t.channel(`profile-${e}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"users",filter:`id=eq.${e}`},c=>this.emit("profile_update",c)).subscribe();this.channels.set(`profile-${e}`,i);const a=t.channel(`notifications-${e}`).on("postgres_changes",{event:"INSERT",schema:"public",table:"notifications"},c=>{const d=c.new;(d.user_id===e||d.user_id===null)&&this.emit("new_notification",c)}).subscribe();this.channels.set(`notifications-${e}`,a);const r=t.channel(`messages-${e}`).on("postgres_changes",{event:"INSERT",schema:"public",table:"messages"},c=>{const d=c.new;(d.recipient_id===e||d.channel==="global")&&this.emit("new_message",c)}).subscribe();this.channels.set(`messages-${e}`,r);const n=t.channel(`rewards-${e}`).on("postgres_changes",{event:"INSERT",schema:"public",table:"rewards",filter:`user_id=eq.${e}`},c=>this.emit("new_reward",c)).subscribe();this.channels.set(`rewards-${e}`,n);const s=t.channel(`session-${e}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"game_sessions",filter:`user_id=eq.${e}`},c=>this.emit("session_update",c)).subscribe();this.channels.set(`session-${e}`,s);const l=t.channel("leaderboard").on("postgres_changes",{event:"UPDATE",schema:"public",table:"leaderboard_entries"},c=>this.emit("leaderboard_update",c)).subscribe();this.channels.set("leaderboard",l),console.log(`[RealtimeService] Channels initialized for user ${e}`)}on(e,t){this.listeners.has(e)||this.listeners.set(e,new Set),this.listeners.get(e).add(t)}off(e,t){if(t){const i=this.listeners.get(e);i&&(i.delete(t),i.size===0&&this.listeners.delete(e))}else this.listeners.delete(e)}emit(e,t){const i=this.listeners.get(e);i&&i.forEach(a=>{try{a(t)}catch(r){console.error(`[RealtimeService] Error executing listener for event ${e}:`,r)}})}cleanup(){const e=m;this.channels.forEach(t=>{e&&e.removeChannel(t)}),this.channels.clear(),this.listeners.clear(),console.log("[RealtimeService] Cleaned up all channels and listeners.")}}class ot{_uiManager;_audioManager;_saveManager;_onClose;_activeTab="daily";_previousRank=null;constructor(e,t,i,a){this._uiManager=e,this._saveManager=t,this._audioManager=i,this._onClose=a}async render(){const e=this._uiManager.container;e.innerHTML=E.LoadingState(o.currentLocale==="am"?"ደረጃዎችን በማስገባት ላይ...":o.currentLocale==="om"?"Sadarkaa fe'aa jira...":"Loading rankings...");const t=this._saveManager.profile,i=C.getDivision(t.xp);let a=[];this._activeTab==="daily"?a=await D.getInstance().getLeaderboard(void 0,"daily"):a=(await(await de(async()=>{const{TournamentService:g}=await import("./TournamentService-B2Qw_uDe.js");return{TournamentService:g}},__vite__mapDeps([0,1]))).TournamentService.getInstance().getLeaderboard(this._activeTab)).map(g=>({userId:g.userId,username:g.username,score:g.score,matchesPlayed:g.matchesPlayed}));const r=a.map(x=>{const v=x.username===t.username,y=/^\\+?[0-9]{9,}$/.test((x.username||"").replace(/[^0-9+]/g,""))?this._maskPhone(x.username):x.username||(o.currentLocale==="am"?"ያልታወቀ":o.currentLocale==="om"?"Namummaa Hin Beekamne":"Anonymous"),b=x.score||0,k=x.eloRating||0,A=C.getDivision(b);return{msisdn:y,score:b,eloRating:k,points:b,league:A.name,isMe:v}});r.sort((x,v)=>v.score-x.score);const n=r[0],s=r[1],l=r[2],c=r.slice(3),d=x=>{const v=this._activeTab===x;return`
                flex: 1;
                padding: 10px 4px;
                border-radius: 8px;
                ...
                text-transform: uppercase;
                letter-spacing: 0.5px;
            `},h=r.findIndex(x=>x.isMe),u=h!==-1?h+1:"--";let f="";if(this._previousRank!==null&&u!=="--"&&this._previousRank!=="--"){const x=this._previousRank-u;x>0?f=`<span class="rank-diff-anim rank-diff-up">▲ +${x} Positions</span>`:x<0&&(f=`<span class="rank-diff-anim rank-diff-down">▼ ${x} Positions</span>`)}this._previousRank=u,e.innerHTML=`
            <div class="stadium-container ethio-bg-main" style="pointer-events: auto; padding-bottom: 60px; overflow-y: auto;">
                ...
                <!-- TOP BAR -->
                ${w.render(o.currentLocale==="am"?"ደረጃ":o.currentLocale==="om"?"SADARKAA":"RANK","",!1)}
                ...
                <div style="max-width: 900px; margin: 0 auto; padding: 16px;">
                    ...
                    ${r.length===0?E.EmptyState("🏆",o.currentLocale==="am"?"እስካሁን የተሰለፈ ተጫዋች የለም።":o.currentLocale==="om"?"Hamma ammaatti taphataan sadarkaa qabate hin jiru.":"No players ranked yet."):`
                                ...
                                <div style="display: flex; align-items: center; gap: 8px;">
                                    ...
                                    `:`
                                        <div style="font-size: var(--fds-font-md); font-weight: 900; color: var(--fds-text-main);">
                                            ${o.currentLocale==="am"?`#${u} በ ${i.name} ሊግ`:o.currentLocale==="om"?`#${u} Liigii ${i.name} Keessatti`:`#${u} In ${i.name} League`}
                                        </div>
                                    `}
                                    ${f}
                                </div>
                    ...
                    <div style="display: flex; flex-direction: column; gap: 8px;" class="fade-in-up">
                        ${c.map((x,v)=>{const g=v+4,y=x.isMe;return`
                                <div class="glass-card" style="
                                    display: flex; 
                                    justify-content: space-between; 
                                    align-items: center; 
                                    padding: 12px 16px; 
                                    background: ${y?"rgba(34,197,94,0.15)":"rgba(15,23,42,0.7)"}; 
                                    border: 1px solid ${y?"#22C55E":"rgba(255,255,255,0.08)"}; 
                                    border-radius: 12px;
                                ">
                                    <div style="display: flex; align-items: center; gap: 12px;">
                                        <span style="font-size: var(--fds-font-sm); font-weight: 900; color: var(--fds-text-dim); min-width: 24px;">#${g}</span>
                                        <div>
                                            <div style="font-size: var(--fds-font-sm); font-weight: 900; color: ${y?"#4ADE80":"white"};">
                                                ${x.msisdn} ${y?`<span style="background: #22C55E; color: black; font-size: 9px; padding: 2px 6px; border-radius: 4px; font-weight: 900; margin-left: 6px;">${o.currentLocale==="am"?"እርስዎ":o.currentLocale==="om"?"ATI":"YOU"}</span>`:""}
                                            </div>
                                            <div style="font-size: var(--fds-font-xs); color: var(--fds-text-dim);">${o.currentLocale==="am"?`${x.league} ሊግ`:o.currentLocale==="om"?`Liigii ${x.league}`:`${x.league} League`}</div>
                                        </div>
                                    </div>
                                    <div style="text-align: right;">
                                        <div style="font-size: var(--fds-font-sm); font-weight: 900; color: var(--fds-gold-primary);">${x.score} PTS</div>
                                        <div style="font-size: var(--fds-font-xs); color: var(--fds-blue-accent);">${x.points} XP</div>
                                    </div>
                                </div>
                            `}).join("")}
                    </div>
        ...
        `}static renderNavRow(e,t,i,a,r=!0,n,s=!1){return`
        ...
        `}}class st{_uiManager;_saveManager;_audioManager;_callbacks;_unsubscribeBadge=null;constructor(e,t,i,a){this._uiManager=e,this._saveManager=t,this._audioManager=i,this._callbacks=a,this._unsubscribeBadge=q.getInstance().subscribeToBadgeUpdates(()=>{const r=document.getElementById("profile-msg-badge");if(r){const n=q.getInstance().getTotalUnreadCount();n>0?(r.innerText=n>99?"99+":n.toString(),r.style.display="inline-block"):r.style.display="none"}})}destroy(){this._unsubscribeBadge&&this._unsubscribeBadge()}render(){const e=this._uiManager.container;e.innerHTML=E.SkeletonProfile(),setTimeout(()=>{this._renderActual()},300)}_renderActual(){const e=this._uiManager.container,t=this._saveManager.profile,i=C.getDivision(t.xp);e.innerHTML=`
            <div class="stadium-container ethio-bg-main" style="pointer-events: auto; overflow-y: auto; padding-bottom: 120px;">
                ...
                ">
                    ...
                    <div>
                        <div style="font-size: var(--fds-font-xs); font-weight: 800; color: var(--tv-gold-primary); margin-bottom: 4px; text-shadow: 0 0 10px rgba(255, 215, 0, 0.4);">${o.currentLocale==="am"?"ነጥቦች":o.currentLocale==="om"?"QABXII":"POINTS"}</div>
                ...
                <div style="max-width: 600px; margin: 0 auto; padding: 0 16px;">
                    ...
                    ${M.renderCard(`
                        ${M.renderNavRow("📊",o.currentLocale==="am"?"ስታቲስቲክስ":"Statistics","stats")}
                        ${M.renderNavRow("🏆",o.currentLocale==="am"?"ስኬቶች":"Achievements","achievements")}
                        ${M.renderNavRow("🏅",o.currentLocale==="am"?"የእኔ ሽልማቶች":"My Awards","awards")}
                        ${M.renderNavRow("📈",o.currentLocale==="am"?"የመሪዎች ሰሌዳ":"Leaderboard","leaderboard","",!0,"",!0)}
                    `,"PERFORMANCE")}

                    ${M.renderCard(`
                        ${M.renderNavRow("👤",o.currentLocale==="am"?"ማንነት":"Identity","identity")}
                        ${M.renderNavRow("👥",o.currentLocale==="am"?"ጓደኞችን ይጋብዙ":"Invite Friends","invite")}
                        ${M.renderNavRow("💬",o.currentLocale==="am"?"መልዕክቶች":"Messages","messages","",!0,"profile-msg-badge",!0)}
                    `,"ACCOUNT")}

                    ${M.renderCard(`
                        ${M.renderNavRow("⭐",o.currentLocale==="am"?"ምዝገባ":"Subscription","subscription")}
                        ${M.renderNavRow("⚙️",o.currentLocale==="am"?"ቅንብሮች":"Settings","settings")}
                        ${M.renderNavRow("❓",o.currentLocale==="am"?"እገዛ እና ድጋፍ":"Help & Support","help","",!0,"",!0)}
                    `,"SERVICE")}

                    ${M.renderCard(`
                        ${M.renderNavRow("ℹ️",o.currentLocale==="am"?"ስለ እኛ":"About","about")}
                        ${M.renderNavRow("📝",o.currentLocale==="am"?"አዘውትረው የሚጠየቁ ጥያቄዎች":"FAQ","faq")}
                        ${M.renderNavRow("📜",o.currentLocale==="am"?"ደንቦች እና ሁኔታዎች":"Terms & Conditions","terms","",!0,"",!0)}
                    `,"INFORMATION")}
                    
                    ${M.renderCard(`
                        ${M.renderNavRow("🚪",o.currentLocale==="am"?"ውጣ":"Log Out","logout","",!1,"",!0)}
                    `,"SESSION")}
        ...
        `,this._bindEvents();const a=q.getInstance().getTotalUnreadCount(),r=document.getElementById("profile-msg-badge");r&&(a>0?(r.innerText=a>99?"99+":a.toString(),r.style.display="inline-block"):r.style.display="none"),D.getInstance().getMyDailyStats().then(n=>{const s=document.getElementById("profile-daily-rank");s&&(s.textContent=n?`#${n.rank}`:"Unranked")}).catch(()=>{const n=document.getElementById("profile-daily-rank");n&&(n.textContent="Unranked")})}_bindEvents(){const e=this._uiManager.container,t=document.getElementById("profile-action-modal"),i=document.getElementById("prof-modal-content"),a=document.getElementById("btn-close-prof-modal"),r=l=>{t&&i&&(i.innerHTML=l,t.style.display="flex")};a?.addEventListener("click",()=>{this._audioManager.playClick(),t&&(t.style.display="none")}),e.querySelectorAll(".profile-menu-tile").forEach(l=>{l.addEventListener("click",c=>{const h=c.currentTarget.getAttribute("data-action");if(h)switch(this._audioManager.playClick(),h){case"stats":this._callbacks.onStatistics();break;case"leaderboard":this._callbacks.onLeaderboard();break;case"subscription":this._callbacks.onSubscription();break;case"messages":this._callbacks.onMessages();break;case"settings":this._callbacks.onSettings();break;case"help":this._callbacks.onHelp();break;case"about":this._callbacks.onAbout();break;case"privacy":this._callbacks.onPrivacy();break;case"terms":this._callbacks.onTerms();break;case"invite":this._callbacks.onInvite();break;case"achievements":this._callbacks.onAchievements();break;case"awards":this._callbacks.onAwards();break;case"identity":this._callbacks.onIdentity();break;case"faq":this._callbacks.onFaq();break;case"logout":r(`
                        ...
                        `),document.getElementById("btn-cancel-logout")?.addEventListener("click",()=>{this._audioManager.playClick(),t&&(t.style.display="none")}),document.getElementById("btn-confirm-logout")?.addEventListener("click",async u=>{const f=u.currentTarget;if(f.style.opacity!=="0.5"){this._audioManager.playClick(),f.style.opacity="0.5",f.style.pointerEvents="none",f.innerHTML="Logging out...";try{await B.getInstance().signOut(),localStorage.removeItem("ETHIO_FOOTBALL_AUTH_V2"),localStorage.removeItem("ETHIO_FOOTBALL_SAVE_V1"),window.location.replace(window.location.origin+window.location.pathname)}catch(x){console.error("Logout error:",x),r(`
            ...
            <div class="stadium-container ethio-bg-main" style="pointer-events: auto; overflow-y: auto;">
                ...
                <div style="max-width: 500px; margin: 0 auto; position: relative; z-index: 10; text-align: center; padding: 0 20px;">
                    ...
                    ">
                        ...
                        ${E.Button({id:"cancel-mm-btn",text:"CANCEL MATCHMAKING",icon:"✖",variant:"secondary",fullWidth:!0,className:"cancel-btn-custom"})}
                    </div>
                </div>
            </div>
        ...
        `;const a=te.getInstance(),r=a.onMatchFound(n=>{this._audioManager.playGoalCheer(),this._onMatchFound(n)});setInterval(()=>{const n=document.getElementById("live-players-count");if(n&&document.body.contains(n)){const l=parseInt(n.innerText.split(" ")[0])+Math.floor(Math.random()*5)-2,c=Math.max(120,Math.min(180,l));n.innerText=`${c} Players in Queue`}},3e3),e.querySelector("#cancel-mm-btn")?.addEventListener("click",()=>{this._audioManager.playClick(),r(),a.leaveQueue(i.id),this._onCancel()}),await a.joinQueue(i)}}class ct{constructor(e,t,i){this._uiManager=e,this._audioManager=t,this._onBack=i}_currentTab="all";_messages=[];_isOpeningMessage=!1;_isLayoutRendered=!1;_currentRequestId=0;async render(){this._isLayoutRendered?this._updateTabUI():(this._renderLayout(),this._bindEvents(),this._isLayoutRendered=!0),await this._updateContent()}_renderLayout(){const e=this._uiManager.container,t=o.currentLocale;e.innerHTML=`
            <div class="stadium-container ethio-bg-main" style="display: flex; flex-direction: column; height: 100vh; overflow: hidden; position: relative;">
                ...
                <!-- App Bar -->
                ${w.render(t==="am"?"መልዕክቶች":t==="om"?"ERGAWWAAN":"Messages")}
        ...
        `,w.bind(e,()=>{this._audioManager.playClick(),this._onBack()}),this._updateTabUI()}_updateTabUI(){const e=o.currentLocale,t=[{id:"all",label:{en:"All",am:"ሁሉም",om:"Hunda"}},{id:"unread",label:{en:"Unread",am:"ያልተነበቡ",om:"Kan Hin Dubbifamne"}},{id:"global",label:{en:"Announcements",am:"ማስታወቂያዎች",om:"Beeksisa"}},{id:"direct",label:{en:"Inbox",am:"የገቢ መልዕክቶች",om:"Ergaa"}},{id:"system",label:{en:"Support",am:"ድጋፍ",om:"Gargaarsa"}}],i=document.getElementById("mc-tab-bar");if(!i)return;i.innerHTML=t.map(r=>{const n=r.id===this._currentTab,s=r.id==="unread"||r.id==="direct"||r.id==="global"||r.id==="all"?q.getInstance().getTotalUnreadCount():0,l=(r.id==="unread"||r.id==="direct")&&s>0;return n?`
            ...
            `);try{const i=q.getInstance();this._messages=await i.getAllMessages()}catch(i){console.error("Failed to fetch messages",i),this._currentRequestId===e&&t&&(t.innerHTML=`
                ...
                `;return}e.innerHTML=a.map(n=>{const s=new Date(n.createdAt).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),c={global:"📢",direct:"📩",system:"⚙️"}[n.category]||"✉️";return`
            ...
            `}).join(""),e.querySelectorAll(".mc-item").forEach(n=>{n.addEventListener("click",async s=>{if(this._isOpeningMessage)return;const l=s.currentTarget.getAttribute("data-id");if(l){this._isOpeningMessage=!0,this._audioManager.playClick();try{const c=this._messages.find(d=>d.id===l);c&&!c.read&&(await q.getInstance().markAsRead(l),c.read=!0),this._showFullMessage(l)}finally{this._isOpeningMessage=!1}}})})}_showFullMessage(e){const t=this._messages.find(n=>n.id===e);if(!t)return;const i=new Date(t.createdAt).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),a=new Date(t.createdAt).toLocaleDateString(),r=document.createElement("div");r.style.cssText=`
        ...
        `,document.body.appendChild(r),r.querySelector("#btn-close-msg")?.addEventListener("click",()=>{this._audioManager.playClick(),r.remove(),this._renderMessages()})}}class dt{_channel=null;_cdcChannel=null;_matchId;_listeners=new Set;constructor(e){this._matchId=e}get matchId(){return this._matchId}connect(){if(!_.isOnline||!m){console.log(`[LiveMatchClient] Offline mode — simulated channel for ${this._matchId}`);return}this._channel=m.channel(`live_match:${this._matchId}`,{config:{broadcast:{self:!0}}}),this._channel.on("broadcast",{event:"match_event"},e=>{const t=e.payload;this._notify(t)}).subscribe(),this._cdcChannel=m.channel(`public:live_match_answers:${this._matchId}`).on("postgres_changes",{event:"INSERT",schema:"public",table:"live_match_answers",filter:`live_match_id=eq.${this._matchId}`},e=>{const t=e.new;console.log("[LiveMatchClient] Postgres CDC answer insert detected:",t),this._notify({event:"ANSWER_SUBMITTED",userId:t.user_id,questionIndex:t.question_index,isCorrect:t.is_correct})}).subscribe()}async sendAnswer(e,t,i,a){const r={event:"ANSWER_SUBMITTED",userId:e,questionIndex:t,score:a,isCorrect:i};this._channel&&this._channel.send({type:"broadcast",event:"match_event",payload:r}),this._notify(r),_.isOnline&&await pe.invoke("live-match",{liveMatchId:this._matchId,userId:e,questionIndex:t,selectedIndex:i?0:1,responseTimeMs:1500})}sendFinishMatch(e,t){const i={event:"MATCH_FINISH",userId:e,score:t};this._channel&&this._channel.send({type:"broadcast",event:"match_event",payload:i}),this._notify(i)}onEvent(e){return this._listeners.add(e),()=>this._listeners.delete(e)}_notify(e){this._listeners.forEach(t=>t(e))}disconnect(){this._channel&&m&&(m.removeChannel(this._channel),this._channel=null),this._cdcChannel&&m&&(m.removeChannel(this._cdcChannel),this._cdcChannel=null),this._listeners.clear()}}class ce{static DEFAULT_K_FACTOR=32;static calculateExpectedScore(e,t){return 1/(1+Math.pow(10,(t-e)/400))}static calculateNewRatings(e,t,i,a=ce.DEFAULT_K_FACTOR){const r=ce.calculateExpectedScore(e,t),n=1-r,s=1-i,l=Math.round(a*(i-r)),c=Math.round(a*(s-n)),d=Math.max(100,e+l),h=Math.max(100,t+c);return{winnerNewElo:d,loserNewElo:h,winnerEloChange:l,loserEloChange:c}}}class pt{_uiManager;_audioManager;_saveManager;_opponent;_questions;_onComplete;_client;_currentIndex=0;_myScore=0;_opponentScore=0;_timerInterval=null;_timeLeftSec=10;_hasPlayedFullTimeWhistle=!1;_answers=[];constructor(e,t,i,a,r,n,s){this._uiManager=e,this._audioManager=t,this._saveManager=i,this._opponent=r,this._questions=n,this._onComplete=s,this._client=new dt(a)}startMatch(){this._client.connect(),this._client.onEvent(e=>{if(e.userId===this._opponent.id&&e.event==="ANSWER_SUBMITTED"&&e.score!==void 0){this._opponentScore=e.score;const t=document.getElementById("opponent-score");t&&(t.innerText=`${this._opponentScore}`)}}),this.render()}render(){const e=this._uiManager.container,t=this._saveManager.profile,i=this._questions[this._currentIndex];if(!i){this._showFinalResults();return}const a=o.currentLocale==="am"?i.promptAm||i.promptEn||i.prompt:o.currentLocale==="om"?i.promptOm||i.promptEn||i.prompt:i.promptEn||i.prompt,r=o.currentLocale==="am"?i.optionsAm&&i.optionsAm.length===i.options.length?i.optionsAm:i.options:o.currentLocale==="om"?i.optionsOm&&i.optionsOm.length===i.options.length?i.optionsOm:i.options:i.optionsEn&&i.optionsEn.length===i.options.length?i.optionsEn:i.options;e.innerHTML=`
        ...
        `,setTimeout(()=>{this._audioManager.playQuestionArrive()},80),this._startTimer(),this._bindEvents(i),setTimeout(()=>{const n=document.getElementById("live-answers-grid");n&&(n.style.pointerEvents="auto")},420)}_startTimer(){this._stopTimer(),this._timeLeftSec=10;const e=document.getElementById("live-timer-bar");this._timerInterval=setInterval(()=>{if(this._timeLeftSec--,e){const t=this._timeLeftSec/10*100;e.style.width=t+"%",this._timeLeftSec<=5&&(e.style.backgroundColor="#EF4444",this._audioManager.playCountdownWarning())}this._timeLeftSec<=0&&(this._stopTimer(),this._handleTimeOut())},1e3)}_stopTimer(){this._timerInterval&&(clearInterval(this._timerInterval),this._timerInterval=null)}_bindEvents(e){document.querySelectorAll(".live-option-btn").forEach(a=>{a.addEventListener("click",r=>{const n=r.currentTarget;this._audioManager.playAnswerSelected(),this._stopTimer(),document.querySelectorAll(".live-option-btn").forEach(c=>c.disabled=!0);const l=parseInt(n.getAttribute("data-index")||"0");this._onOptionSelected(l,n,e)})});const i=document.getElementById("live-exit-btn");i&&i.addEventListener("click",()=>{this._audioManager.playClick(),this._client.disconnect(),this._stopTimer(),this._onComplete()})}_onOptionSelected(e,t,i){const a=e===i.correctIndex,r=document.querySelectorAll(".live-option-btn"),n=(10-this._timeLeftSec)*1e3;this._answers.push({questionId:i.id,selectedIndex:e,responseTimeMs:n});const s=this._currentIndex===this._questions.length-1;if(a){t.classList.add("correct"),this._audioManager.playCorrectAnswerGoal(s?400:void 0);const h=100+Math.floor(this._timeLeftSec/10*50);this._myScore+=h;const u=document.getElementById("my-score");u&&(u.innerText=String(this._myScore)),this._showFeedbackOverlay(!0)}else{if(t.classList.add("wrong"),i.correctIndex!==void 0){const d=r[i.correctIndex];d&&d.classList.add("correct")}this._audioManager.playWrongAnswer(s?400:void 0),this._showFeedbackOverlay(!1)}const l=this._saveManager.cloudUserId||"local-user";this._client.sendAnswer(l,this._currentIndex,a,this._myScore),setTimeout(()=>{this._hideFeedbackOverlay(),this._currentIndex++,this.render()},s?400:1500)}_showFeedbackOverlay(e){const t=document.getElementById("live-feedback-overlay"),i=document.getElementById("live-feedback-icon"),a=document.getElementById("live-feedback-text");t&&i&&a&&(t.style.borderColor=e?"var(--tv-pitch-green)":"#EF4444",t.style.boxShadow=e?"0 10px 40px rgba(34,197,94,0.3)":"0 10px 40px rgba(239,68,68,0.3)",t.style.color=e?"var(--tv-pitch-green)":"#EF4444",i.innerText=e?"⚽":"🧤",a.innerText=e?o.currentLocale==="am"?"ግብ!!!!!":o.currentLocale==="om"?"GALCHII!!!!!":"GOAL!!!!!":o.currentLocale==="am"?"ግብ ተከለከለ!":o.currentLocale==="om"?"GALCHII QABAME!":"GOAL SAVED!",t.style.opacity="1",t.style.transform="translateX(-50%) scale(1)")}_hideFeedbackOverlay(){const e=document.getElementById("live-feedback-overlay");e&&(e.style.pointerEvents="none",e.style.opacity="0",e.style.transform="translateX(-50%) scale(0.9)")}_handleTimeOut(){const e=this._questions[this._currentIndex];this._answers.push({questionId:e.id,selectedIndex:-1,responseTimeMs:1e4});const t=this._saveManager.cloudUserId||"local-user";this._client.sendAnswer(t,this._currentIndex,!1,this._myScore),this._audioManager.playWhistle();const i=document.querySelectorAll(".live-option-btn");if(e.correctIndex!==void 0){const n=i[e.correctIndex];n&&n.classList.add("correct")}const r=this._currentIndex===this._questions.length-1?400:1200;setTimeout(()=>{this._currentIndex++,this.render()},r)}_showFinalResults(){this._hasPlayedFullTimeWhistle||(this._hasPlayedFullTimeWhistle=!0,this._audioManager.playFullTimeWhistle());const e=this._uiManager.container,t=this._saveManager.profile.eloRating||0,i=this._myScore>this._opponentScore,a=this._myScore===this._opponentScore,r=ce.calculateNewRatings(t,this._opponent.elo_rating,i?1:a?.5:0);this._saveManager.profile.eloRating=r.winnerNewElo,this._saveManager.addCoins(i?300:100),this._submitToBackend(),e.innerHTML=`
            <div class="stadium-container ethio-bg-main" style="pointer-events: auto; display: flex; align-items: center; justify-content: center; padding: 20px;">
                ...
                ">
                    ...
                    ${E.Button({id:"live-finish-btn",text:o.currentLocale==="am"?"ወደ ሊግ ማዕከል ተመለስ":o.currentLocale==="om"?"GARA WALTOMMII LIIGII DEEBI'I":"RETURN TO LEAGUE HUB",variant:"primary",fullWidth:!0})}
                </div>
            </div>
            <style>
                #live-finish-btn:active { transform: scale(0.96); }
            </style>
        `,e.querySelector("#live-finish-btn")?.addEventListener("click",()=>{this._audioManager.playClick(),this._onComplete()})}async _submitToBackend(){if(this._saveManager.cloudUserId)try{const{supabase:e}=await de(async()=>{const{supabase:t}=await Promise.resolve().then(()=>He);return{supabase:t}},void 0);e&&await e.rpc("submit_match_result",{p_match_type:"live",p_answers:this._answers,p_live_match_id:this._client.matchId})}catch(e){console.warn("[LiveMatchScreen] Failed to submit live match result",e)}}}class T{static _activeTab="home";static _lastCallback=null;static TABS=[{id:"home",label:"Home",icon:"🏠"},{id:"play",label:"Play",icon:"🎮"},{id:"standings",label:"Leaderboard",icon:"🏆"},{id:"profile",label:"Profile",icon:"👤"}];static LABELS={home:{en:"Home",am:"መነሻ",om:"Mula'a"},play:{en:"Play",am:"ተጫወት",om:"Tapha"},standings:{en:"Leaderboard",am:"ደረጃዎች",om:"Sadarkaa"},profile:{en:"Profile",am:"መገለጫ",om:"Profile"}};static get activeTab(){return T._activeTab}static setActiveTab(e){T._activeTab=e,T.updateTabHighlights()}static refresh(){T._lastCallback&&T.render(T._lastCallback)}static render(e){T._lastCallback=e;let t=document.getElementById("fds-bottom-nav");t||(t=document.createElement("div"),t.id="fds-bottom-nav",t.style.position="fixed",t.style.bottom="0",t.style.left="0",t.style.width="100%",t.style.paddingBottom="env(safe-area-inset-bottom, 16px)",t.style.height="calc(64px + env(safe-area-inset-bottom, 16px))",t.style.background="rgba(2, 6, 23, 0.96)",t.style.borderTop="2px solid var(--fds-gold-primary, #FFD700)",t.style.boxShadow="0 -8px 32px rgba(0, 0, 0, 0.85)",t.style.backdropFilter="blur(16px)",t.style.zIndex="9000",t.style.display="flex",t.style.justifyContent="space-around",t.style.alignItems="center",t.style.pointerEvents="auto",document.body.appendChild(t));const i=o.currentLocale;t.innerHTML=T.TABS.map(r=>{const n=r.id===T._activeTab,s=T.LABELS[r.id][i]||r.label;return`
            ...
            `}).join(""),t.querySelectorAll(".nav-tab-item").forEach(r=>{r.addEventListener("click",n=>{const l=n.currentTarget.getAttribute("data-tab-id");if(localStorage.getItem("ETHIO_FOOTBALL_MUTED")!=="true"&&typeof navigator<"u"&&navigator.vibrate)try{navigator.vibrate(10)}catch{}typeof window.ethioOnBackPress=="function"&&window.ethioOnBackPress()||l&&(l!==T._activeTab&&T.setActiveTab(l),e(l))})})}static updateTabHighlights(){const e=document.getElementById("fds-bottom-nav");if(!e)return;e.querySelectorAll(".nav-tab-item").forEach(i=>{const r=i.getAttribute("data-tab-id")===T._activeTab,n=i;n.style.color=r?"var(--fds-gold-primary, #FFD700)":"#94A3B8",n.style.transform=r?"scale(1.1)":"scale(1)",n.style.filter=r?"drop-shadow(0 2px 8px rgba(255,215,0,0.4))":"none";const s=n.querySelector(".tab-text");s&&(s.style.fontWeight=r?"800":"600")})}static setBadge(e,t){const i=document.getElementById(`nav-badge-${e}`);i&&(t>0?(i.innerText=t>99?"99+":t.toString(),i.style.display="block"):i.style.display="none")}static hide(){const e=document.getElementById("fds-bottom-nav");e&&(e.style.display="none")}static show(){const e=document.getElementById("fds-bottom-nav");e&&(e.style.display="flex")}}class j{static _instance=null;_profileCache=null;_preferencesCache=null;constructor(){}static getInstance(){return j._instance||(j._instance=new j),j._instance}async getProfile(){if(!_.isOnline)return null;const e=m;if(!e)return null;try{const{data:{user:t}}=await e.auth.getUser();if(!t)return null;const{data:i,error:a}=await e.from("users").select("*").eq("id",t.id).single();return a?(console.warn("[ProfileService] Error fetching profile:",a),null):(this._profileCache=i,i)}catch(t){return console.warn("[ProfileService] Failed to get profile:",t),null}}async updateProfile(e){if(!_.isOnline)return;const t=m;if(t)try{const{data:{user:i}}=await t.auth.getUser();if(!i)return;const{error:a}=await t.from("users").update(e).eq("id",i.id);a?console.warn("[ProfileService] Error updating profile:",a):this._profileCache&&(this._profileCache={...this._profileCache,...e})}catch(i){console.warn("[ProfileService] Failed to update profile:",i)}}async getPreferences(){if(!_.isOnline)return null;const e=m;if(!e)return null;try{const{data:{user:t}}=await e.auth.getUser();if(!t)return null;const{data:i,error:a}=await e.from("user_preferences").select("*").eq("user_id",t.id).single();return a?(console.warn("[ProfileService] Error fetching preferences:",a),null):(this._preferencesCache=i,i)}catch(t){return console.warn("[ProfileService] Failed to get preferences:",t),null}}async updatePreferences(e){if(!_.isOnline)return;const t=m;if(t)try{const{data:{user:i}}=await t.auth.getUser();if(!i)return;const{error:a}=await t.from("user_preferences").update(e).eq("user_id",i.id);a?console.warn("[ProfileService] Error updating preferences:",a):this._preferencesCache&&(this._preferencesCache={...this._preferencesCache,...e})}catch(i){console.warn("[ProfileService] Failed to update preferences:",i)}}async getEarnedAchievements(){if(!_.isOnline)return[];const e=m;if(!e)return[];try{const{data:{user:t}}=await e.auth.getUser();if(!t)return[];const{data:i,error:a}=await e.from("user_achievements").select("achievement_id, earned_at, achievements:achievements (*)").eq("user_id",t.id);return a?(console.warn("[ProfileService] Error fetching user achievements:",a),[]):i||[]}catch(t){return console.warn("[ProfileService] Failed to get user achievements:",t),[]}}async getRewards(){if(!_.isOnline)return[];const e=m;if(!e)return[];try{const{data:{user:t}}=await e.auth.getUser();if(!t)return[];const{data:i,error:a}=await e.from("rewards").select("*").eq("user_id",t.id);return a?(console.warn("[ProfileService] Error fetching user rewards:",a),[]):i||[]}catch(t){return console.warn("[ProfileService] Failed to get rewards:",t),[]}}subscribeToProfileChanges(e){if(!_.isOnline)return()=>{};const t=m;if(!t)return()=>{};let i=null;return t.auth.getUser().then(({data:{user:a}})=>{if(!a)return;const r=m;r&&(i=r.channel(`public:users:id=eq.${a.id}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"users",filter:`id=eq.${a.id}`},n=>{this._profileCache=n.new,e(this._profileCache)}).subscribe())}),()=>{const a=m;i&&a&&a.removeChannel(i)}}}class Y{static _instance=null;constructor(){}static getInstance(){return Y._instance||(Y._instance=new Y),Y._instance}async getCategories(){if(!_.isOnline)return[];const e=m;if(!e)return[];try{const{data:t,error:i}=await e.from("faq_items").select("category");return i?(console.warn("[FAQService] Error fetching FAQ categories:",i),[]):t?Array.from(new Set(t.map(r=>r.category))):[]}catch(t){return console.warn("[FAQService] Failed to get FAQ categories:",t),[]}}async getFAQsByCategory(e){if(!_.isOnline)return[];const t=m;if(!t)return[];try{const{data:i,error:a}=await t.from("faq_items").select("*").eq("category",e).order("sort_order",{ascending:!0});return a?(console.warn("[FAQService] Error fetching FAQs by category:",a),[]):i||[]}catch(i){return console.warn("[FAQService] Failed to get FAQs by category:",i),[]}}async searchFAQs(e){if(!_.isOnline)return[];const t=m;if(!t)return[];if(!e||e.trim()==="")return[];try{const{data:i,error:a}=await t.from("faq_items").select("*").or(`question_en.ilike.%${e}%,answer_en.ilike.%${e}%`).order("sort_order",{ascending:!0});return a?(console.warn("[FAQService] Error searching FAQs:",a),[]):i||[]}catch(i){return console.warn("[FAQService] Failed to search FAQs:",i),[]}}}class ie{static instance;constructor(){}static getInstance(){return ie.instance||(ie.instance=new ie),ie.instance}async createTicket(e,t,i){if(!_.isOnline)return console.warn("[SupportService] Offline mode: cannot create ticket."),{ticketId:"",success:!1};const a=m;if(!a)return{ticketId:"",success:!1};try{const{data:{user:r},error:n}=await a.auth.getUser();if(n||!r)return console.error("[SupportService] Auth error or user not found:",n),{ticketId:"",success:!1};const{data:s,error:l}=await a.from("support_tickets").insert({user_id:r.id,category:e,message:t,subject:i||null,status:"open"}).select("id").single();return l?(console.error("[SupportService] Failed to create ticket:",l),{ticketId:"",success:!1}):{ticketId:s.id,success:!0}}catch(r){return console.error("[SupportService] Error creating ticket:",r),{ticketId:"",success:!1}}}async getMyTickets(){if(!_.isOnline)return console.warn("[SupportService] Offline mode: returning empty tickets list."),[];const e=m;if(!e)return[];try{const{data:{user:t},error:i}=await e.auth.getUser();if(i||!t)return console.error("[SupportService] Auth error or user not found:",i),[];const{data:a,error:r}=await e.from("support_tickets").select("*").eq("user_id",t.id).order("created_at",{ascending:!1});return r?(console.error("[SupportService] Failed to fetch tickets:",r),[]):a}catch(t){return console.error("[SupportService] Error fetching tickets:",t),[]}}async getTicketById(e){if(!_.isOnline)return console.warn("[SupportService] Offline mode: cannot fetch ticket."),null;const t=m;if(!t)return null;try{const{data:i,error:a}=await t.from("support_tickets").select("*").eq("id",e).single();return a?(console.error(`[SupportService] Failed to fetch ticket with ID ${e}:`,a),null):i}catch(i){return console.error(`[SupportService] Error fetching ticket with ID ${e}:`,i),null}}}class ut{static show(){return new Promise(e=>{const t=document.createElement("div");t.style.cssText=`
                position: fixed;
                top: 0;
                left: 0;
                width: 100%;
            ...
            `;const i=o.currentLocale==="am"?"ከመለያ መውጣት":o.currentLocale==="om"?"Herrega Keessaa Ba'uu":"Log Out",a=o.currentLocale==="am"?"በእርግጥ ከኢትዮ ፋንታሲ መለያዎ መውጣት ይፈልጋሉ?":o.currentLocale==="om"?"Dhuguma herrega Ethio Fantasy keessaa ba'uu barbaadduu?":"Are you sure you want to log out of your Ethio Fantasy account?",r=o.currentLocale==="am"?"ሰርዝ":o.currentLocale==="om"?"HAQI":"Cancel",n=o.currentLocale==="am"?"ውጣ":o.currentLocale==="om"?"BA'I":"Log Out";t.innerHTML=`
                <div style="
                    background: #ffffff;
                    border-radius: 16px;
                    padding: 32px 24px;
            ...
            ">
                <div style="display: flex; align-items: center; gap: 16px;">
                    ...
                    <div>
                        <div style="font-size: 15px; font-weight: 800; color: white; letter-spacing: 0.3px;">${c}</div>
                        ${d?`<div style="font-size: 13px; color: var(--fds-text-dim); margin-top: 2px; font-weight: 600;">${d}</div>`:""}
                    </div>
                </div>
        ...
        `,r=o.currentLocale==="am"?"አማርኛ":o.currentLocale==="om"?"Afan Oromo":"English",n=Object.values(this._settings.notifications).some(l=>l);e.innerHTML=`
            <div class="stadium-container ethio-bg-main" style="pointer-events: auto;">
                ...
                ${w.render(o.currentLocale==="am"?"ቅንብሮች":o.currentLocale==="om"?"QINDAA'INOOTA":"Settings")}

                <div style="max-width: 600px; margin: 0 auto; padding: 24px 16px 120px 16px;">
                    
                    <!-- Account Group -->
                    <div style="font-size: 12px; font-weight: 900; color: var(--tv-gold-primary); margin-bottom: 8px; margin-left: 20px; text-transform: uppercase; letter-spacing: 1px;">${o.currentLocale==="am"?"መለያ እና መገለጫ":o.currentLocale==="om"?"HERREGA & PROFILE":"ACCOUNT & PROFILE"}</div>
                    <div class="glass-card" style="margin-bottom: 24px; border-radius: 16px; padding: 0; overflow: hidden; border: 1px solid rgba(255,255,255,0.08); background: rgba(15, 23, 42, 0.6); backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px);">
                        ${t("🌍",o.currentLocale==="am"?"ቋንቋ":o.currentLocale==="om"?"Afaan":"Language",r,i,"tile-language")}
                        ${t("🔔",o.currentLocale==="am"?"ማሳወቂያዎች":o.currentLocale==="om"?"Beeksisa":"Notifications","",a(n),"tile-notifications")}
                        <div style="border-bottom: none;">
                            ${t("🔊",o.currentLocale==="am"?"የድምፅ ውጤቶች":o.currentLocale==="om"?"Sagalee":"Sound Effects",this._settings.soundEffects?o.currentLocale==="am"?"የበራ":o.currentLocale==="om"?"Kan Baname":"Enabled":o.currentLocale==="am"?"የጠፋ":o.currentLocale==="om"?"Kan Cufame":"Muted",a(this._settings.soundEffects),"tile-sound")}
                        </div>
                    </div>

                    <!-- Legal Group -->
                    <div style="font-size: 12px; font-weight: 900; color: var(--tv-gold-primary); margin-bottom: 8px; margin-left: 20px; text-transform: uppercase; letter-spacing: 1px;">${o.currentLocale==="am"?"እገዛ እና ህጋዊ":o.currentLocale==="om"?"GARGAARSA & SEERA":"SUPPORT & LEGAL"}</div>
                    <div class="glass-card" style="margin-bottom: 32px; border-radius: 16px; padding: 0; overflow: hidden; border: 1px solid rgba(255,255,255,0.08); background: rgba(15, 23, 42, 0.6); backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px);">
                        ${t("❓",o.currentLocale==="am"?"እገዛ እና ድጋፍ":o.currentLocale==="om"?"Gargaarsa & Deeggarsa":"Help & Support","",i,"tile-help")}
                        ${t("📜",o.currentLocale==="am"?"ውሎች እና ሁኔታዎች":o.currentLocale==="om"?"Waliigaltee & Haalawwan":"Terms & Conditions","",i,"tile-terms")}
                        <div style="border-bottom: none;">
                            ${t("🔒",o.currentLocale==="am"?"የግላዊነት ፖሊሲ":o.currentLocale==="om"?"Imaammata Dhuunfaa":"Privacy Policy","",i,"tile-privacy")}
                        </div>
                    </div>
            ...
            <div class="stadium-container ethio-bg-main" style="pointer-events: auto;">
                ...
                <div style="max-width: 600px; margin: 0 auto; padding: 24px 16px;">
                    <div class="glass-card" style="border-radius: 12px; padding: 0; overflow: hidden; border-color: rgba(255,255,255,0.08);">
                        ...
                        ${s(o.currentLocale==="am"?"የምዝገባ ሁኔታ":o.currentLocale==="om"?"Haala Kaffaltii":"Subscription Status",n)}
                        <div style="border-bottom: none;">
                            ${s(o.currentLocale==="am"?"የተመዘገቡበት ቀን":o.currentLocale==="om"?"Guyyaa Galmee":"Registration Date",r)}
                        </div>
                    </div>
                </div>
            </div>
        `,this._bindSubScreenBack(e)}_renderLanguageScreen(e,t){const i=(r,n)=>{const s=o.currentLocale===r;return`
        ...
        `,this._bindSubScreenBack(e),e.querySelectorAll(".lang-item").forEach(r=>{r.addEventListener("click",n=>{const l=n.currentTarget.getAttribute("data-lang");l&&(this._audioManager.playClick(),o.setLocale(l),T.refresh(),this.render())})})}_renderNotificationsScreen(e,t){const i=(r,n)=>{const s=this._settings.notifications[r];return`
                <div style="display: flex; align-items: center; justify-content: space-between; padding: 16px; border-bottom: 1px solid rgba(255,255,255,0.05);">
                    ...
                    <label class="switch-container">
                        <input type="checkbox" class="switch-input notif-toggle" data-key="${r}" ${s?"checked":""}>
                        <span class="switch-slider"></span>
                    </label>
                </div>
            `};e.innerHTML=`
        ...
        `,this._bindSubScreenBack(e),e.querySelectorAll(".notif-toggle").forEach(r=>{r.addEventListener("change",n=>{this._audioManager.playClick();const s=n.currentTarget,l=s.getAttribute("data-key");l&&(this._settings.notifications[l]=s.checked,this._saveSettings())})})}_renderSoundScreen(e,t){const i=(s,l)=>{const c=this._settings.soundEffects===s;return`
            ...
            `},a=o.currentLocale==="am"?"ድምፅ አብራ":o.currentLocale==="om"?"Bani":"Enable",r=o.currentLocale==="am"?"ድምፅ አጥፋ":o.currentLocale==="om"?"Cufi":"Disable";e.innerHTML=`
            <div class="stadium-container ethio-bg-main" style="pointer-events: auto;">
        ...
        `,this._bindSubScreenBack(e),e.querySelectorAll(".sound-item").forEach(s=>{s.addEventListener("click",l=>{const d=l.currentTarget.getAttribute("data-val")==="true";this._settings.soundEffects=d,this._saveSettings(),this._audioManager.playClick(),this.render()})})}_renderHelpScreen(e,t){const i='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,0.2)" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18l6-6-6-6"/></svg>',a=[{id:"account",name:o.currentLocale==="am"?"መለያ":o.currentLocale==="om"?"Herrega":"Account",desc:"Account creation, recovery and security",icon:"👤"},{id:"subscription",name:o.currentLocale==="am"?"ምዝገባ":o.currentLocale==="om"?"Kaffaltii":"Subscription",desc:"Premium access and daily billing",icon:"💳"},{id:"unsubscription",name:o.currentLocale==="am"?"ምዝገባ መሰረዝ":o.currentLocale==="om"?"Haquu":"Unsubscription",desc:"How to opt out or cancel service",icon:"🛑"},{id:"dailyChallenge",name:o.currentLocale==="am"?"የዕለት ተግዳሮት":o.currentLocale==="om"?"Qormaata Guyyaa":"Daily Challenge",desc:"Rules and bonuses for daily plays",icon:"📅"},{id:"tournament",name:o.currentLocale==="am"?"ውድድር":o.currentLocale==="om"?"Dorgommii":"Tournament",desc:"Joining and competing in live events",icon:"🏆"},{id:"rewards",name:o.currentLocale==="am"?"ሽልማቶች":o.currentLocale==="om"?"Badhaasa":"Rewards",desc:"Claiming cash prizes and coins",icon:"🎁"},{id:"gameplay",name:o.currentLocale==="am"?"የጨዋታ ሁኔታ":o.currentLocale==="om"?"Tapha":"Gameplay",desc:"How to answer questions and score",icon:"⚽"},{id:"leaderboard",name:o.currentLocale==="am"?"ደረጃ ሰሌዳ":o.currentLocale==="om"?"Sadarkaa":"Leaderboard",desc:"ELO rating and division climbing",icon:"📊"},{id:"profile",name:o.currentLocale==="am"?"መገለጫ":(o.currentLocale==="om","Profile"),desc:"Managing your player identity",icon:"👤"},{id:"notifications",name:o.currentLocale==="am"?"ማሳወቂያዎች":o.currentLocale==="om"?"Beeksisa":"Notifications",desc:"SMS alerts and system updates",icon:"🔔"},{id:"technicalIssues",name:o.currentLocale==="am"?"ቴክኒካዊ ጉዳዮች":o.currentLocale==="om"?"Rakkina Sirnaa":"Technical Issues",desc:"Report bugs or connection problems",icon:"🔧"}],r={account:[{q:"How is my account created?",a:"Your account is automatically created when you authenticate with your Ethio Telecom mobile phone number. There is no password required."},{q:"Can I delete my account?",a:"To delete your account data, please contact Ethio Telecom customer service or submit a support ticket via the app."}],subscription:[{q:"What is Premium Subscription?",a:"Premium subscription gives you unlimited daily plays, full access to all leagues, and entry into the weekly cash prize draws for 2 Birr/day."},{q:"How do I pay for subscription?",a:"Subscription fees are automatically deducted from your Ethio Telecom airtime balance daily."}],unsubscription:[{q:"How do I unsubscribe?",a:'You can cancel your active subscription anytime by going to Settings > Account > Profile and choosing Unsubscribe, or by sending "STOP" to the Ethio Telecom shortcode 8282.'}],dailyChallenge:[{q:"What is the Daily Challenge?",a:"The Daily Challenge is a special daily set of 10 trivia questions on hot football topics. Completing it awards double reward coins and a 1.5x XP bonus!"},{q:"How many times can I play the Daily Challenge?",a:"You can play the Daily Challenge once per calendar day. It resets every night at midnight EAT."}],tournament:[{q:"How do tournaments work?",a:"Tournaments are knockout brackets held every weekend. Players register during the week and compete live in 1v1 match phases to progress."},{q:"What are the tournament entry requirements?",a:"Premium subscribers can enter tournaments for free. Basic and free players must pay a 100 coin registration fee."}],rewards:[{q:"What rewards can I win?",a:"You can win in-game coins, profile XP, custom football badges, and real cash prizes credited directly to your Ethio Telecom mobile account balance."},{q:"When are weekly prizes distributed?",a:"Weekly prizes are processed and sent every Monday at 10:00 AM EAT based on the final Sunday night division standings."}],gameplay:[{q:"How do I play a match?",a:"Read the question carefully and tap the correct option before the timer runs out. Fast answers score Goals, while incorrect ones are Saved by the goalkeeper!"},{q:"How does the match timer work?",a:"You have 30 seconds per question in Solo Matches, and 20 seconds in Live 1v1 Matches. Answering quicker increases your possession stat!"}],leaderboard:[{q:"How are leaderboard points calculated?",a:"Leaderboard standings are based on ELO ratings. You win ELO points by defeating opponents in Live 1v1 Matches and scoring high accuracy in Solo Matches."},{q:"How often does the leaderboard reset?",a:"Division leaderboards reset weekly on Sunday at midnight EAT, after which the top players are promoted and rewards are dispatched."}],profile:[{q:"Why can't I edit my username?",a:"To comply with Ethio Telecom VAS portal guidelines, player profiles are verified and tied securely to your MSISDN. Manually changing names is restricted."}],notifications:[{q:"What notifications will I receive?",a:"You will receive SMS alerts for tournament kick-offs, daily challenge reminders, and subscription renewals. You can toggle these settings anytime."}],technicalIssues:[{q:"The app is freezing. What should I do?",a:"Ensure you have a stable network connection (3G/4G/LTE/5G). Try refreshing the app page by swiping down, or clearing your mobile browser cache."}],privacy:[{q:"How is my data used?",a:"We collect your phone number and game statistics solely to manage your game state and calculate rankings. We never share your data with third parties."}],terms:[{q:"Are there age restrictions?",a:"Yes, you must be 18 years or older, or have parental consent, and be an active Ethio Telecom subscriber to compete for cash rewards."}]};if(this._showContactSupportForm){e.innerHTML=`
                ...
                <div class="ethio-layer ethio-layer-lights"></div>
                    ...
                    ${t(o.currentLocale==="am"?"ቴክኒካዊ ጉዳዮች":o.currentLocale==="om"?"RAKKINA SIRNAA":"TECHNICAL ISSUES")}
                    ...
                    <div style="max-width: 600px; margin: 0 auto; padding: 24px 16px;">
                        ...
                        <div class="glass-card" style="border-radius: 16px; padding: 20px; border: 1px solid rgba(255,255,255,0.08); background: rgba(15, 23, 42, 0.6); backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); text-align: left;" id="support-form-container">
                            <div style="font-size: 18px; font-weight: 900; color: white; margin-bottom: 8px; letter-spacing: 0.5px;">${o.currentLocale==="am"?"✉️ ሪፖርት ያድርጉ":o.currentLocale==="om"?"✉️ Gabaasi":"✉️ Report an Issue"}</div>
                            ...
                            <div style="margin-bottom: 16px;">
                                <label style="display: block; font-size: 12px; color: var(--tv-gold-primary); margin-bottom: 8px; font-weight: 800; text-transform: uppercase;">${o.currentLocale==="am"?"የጉዳዩ ዓይነት":o.currentLocale==="om"?"GOSA RAKKINA":"PROBLEM CATEGORY"}</label>
                            ...
                            <div style="margin-bottom: 16px;">
                                <label style="display: block; font-size: 12px; color: var(--tv-gold-primary); margin-bottom: 8px; font-weight: 800; text-transform: uppercase;">${o.currentLocale==="am"?"መልእክት":o.currentLocale==="om"?"ERGAA":"DESCRIPTION"}</label>
                                <textarea id="support-message" placeholder="${o.currentLocale==="am"?"ችግርዎን እዚህ ይግለጹ...":o.currentLocale==="om"?"Rakkina keessan asitti ibsaa...":"Provide details about the issue..."}" style="width: 100%; height: 100px; padding: 14px; background: rgba(0,0,0,0.5); border: 1px solid rgba(255,255,255,0.15); border-radius: 12px; color: white; outline: none; resize: none; font-family: inherit; font-size: 15px; box-sizing: border-box;"></textarea>
                            </div>
            ...
            `,this._bindSubScreenBack(e),document.getElementById("btn-back-help")?.addEventListener("click",()=>{this._audioManager.playClick(),this._showContactSupportForm=!1,this.render()}),document.getElementById("btn-submit-support")?.addEventListener("click",async()=>{this._audioManager.playClick();const l=document.getElementById("support-message")?.value.trim(),c=document.getElementById("support-category"),d=c?c.value:"General Feedback";if(!l){G.show(o.currentLocale==="am"?"እባክዎን ከማስገባትዎ በፊት መልእክት ያስገቡ።":o.currentLocale==="om"?"Maree ergamuu dura ergaa galchaa.":"Please enter a message before submitting.","warning");return}const h=document.getElementById("support-form-container");if(h){h.innerHTML=`
                    ...
                    `;const u=await ie.getInstance().createTicket(d,l),f=u.success?`EF-${u.ticketId.substring(0,8).toUpperCase()}`:"EF-"+Math.floor(1e5+Math.random()*9e5);h.innerHTML=`
                    ...
                    `}});return}if(this._helpCategory){const l=this._faqsCache.length>0?this._faqsCache:r[this._helpCategory]||[],c=l.map((v,g)=>`
                <div class="glass-card" style="border-radius: 12px; margin-bottom: 12px; border-color: rgba(255,255,255,0.08); overflow: hidden;">
                    <div class="faq-header" data-idx="${g}" style="display: flex; justify-content: space-between; align-items: center; padding: 16px; cursor: pointer; background: rgba(255,255,255,0.02);">
                    ...
                    <div class="faq-body" id="faq-body-${g}" style="max-height: 0; overflow: hidden; transition: max-height 0.2s ease-out; background: rgba(0,0,0,0.2);">
                        <div style="padding: 16px; font-size: var(--fds-font-sm); color: var(--fds-text-muted); line-height: 1.5;">${v.a}</div>
                    </div>
                </div>
            `).join(""),d=a.find(v=>v.id===this._helpCategory),h=d?d.name:this._helpCategory,u=`
                <div style="text-align: center; padding: 40px 16px;">
            ...
            `,this._bindSubScreenBack(e),document.getElementById("btn-back-help")?.addEventListener("click",()=>{this._audioManager.playClick(),this._helpCategory=null,this._faqsCache=[],this.render()}),document.getElementById("faq-search-input")?.addEventListener("input",v=>{const g=v.target.value.toLowerCase();e.querySelectorAll("#faq-list-wrapper > .glass-card").forEach(b=>{const k=(b.querySelector(".faq-header > div")?.textContent||"").toLowerCase(),A=(b.querySelector(".faq-body > div")?.textContent||"").toLowerCase();k.includes(g)||A.includes(g)?b.style.display="block":b.style.display="none"})}),e.querySelectorAll(".faq-header").forEach(v=>{v.addEventListener("click",g=>{this._audioManager.playClick();const y=g.currentTarget,b=y.getAttribute("data-idx"),k=e.querySelector(`#faq-body-${b}`),A=y.querySelector(".faq-icon");k&&A&&(k.style.maxHeight==="0px"||!k.style.maxHeight?(k.style.maxHeight=k.scrollHeight+"px",A.innerText="➖"):(k.style.maxHeight="0px",A.innerText="➕"))})});return}const n=a.map(l=>`
        ...
        `,this._bindSubScreenBack(e),document.getElementById("btn-contact-support")?.addEventListener("click",()=>{this._audioManager.playClick(),this._showContactSupportForm=!0,this.render()}),e.querySelectorAll(".help-category-tile").forEach(l=>{l.addEventListener("click",async c=>{const h=c.currentTarget.getAttribute("data-cat-id");if(h){if(this._audioManager.playClick(),h==="technicalIssues"){this._showContactSupportForm=!0,this.render();return}this._helpCategory=h;const u=document.getElementById("faq-list-wrapper");u&&(u.innerHTML=`<div style="padding: 20px; color: var(--fds-text-dim);">${o.currentLocale==="am"?"ጥያቄዎች በመጫን ላይ...":o.currentLocale==="om"?"Gaaffiiwwan fe'amaa jiru...":"Loading FAQs..."}</div>`);const x=await Y.getInstance().getFAQsByCategory(h);this._faqsCache=x.map(v=>{let g=v.question_en,y=v.answer_en;return o.currentLocale==="am"&&v.question_am&&v.answer_am?(g=v.question_am,y=v.answer_am):o.currentLocale==="om"&&v.question_om&&v.answer_om&&(g=v.question_om,y=v.answer_om),{q:g,a:y}}),this.render()}})})}_renderTermsScreen(e,t){const i=o.currentLocale==="am"?`
        ...
        `,this._bindSubScreenBack(e)}_goBack(){if(this._subScreen!==this._defaultSubScreen)this._subScreen=this._defaultSubScreen;else if(!(this._helpCategory!==null||this._showContactSupportForm)){this._onBack();return}this._helpCategory=null,this._showContactSupportForm=!1,this.render()}_bindSubScreenBack(e){w.bind(e,()=>{this._audioManager.playClick(),this._goBack()})}_maskPhone(e){let t=e.replace(/[^0-9+]/g,"");return t.startsWith("+")&&(t=t.substring(1)),t.startsWith("251")&&(t="251"+t.replace(/^0+/,"")),t.substring(0,4)+"****"+t.substring(t.length-2)}}class R{static _instance=null;constructor(){}static getInstance(){return R._instance||(R._instance=new R),R._instance}async getNotifications(e){if(!_.isOnline)return[];const t=m;if(!t)return[];try{const{data:{user:i}}=await t.auth.getUser();if(!i)return[];let a=t.from("notifications").select("*").or(`user_id.eq.${i.id},user_id.is.null`).order("created_at",{ascending:!1});e&&(a=a.eq("category",e));const{data:r,error:n}=await a;return n?(console.warn("[NotificationService] Error fetching notifications:",n),[]):r||[]}catch(i){return console.warn("[NotificationService] Failed to get notifications:",i),[]}}async getUnreadCount(){if(!_.isOnline)return 0;const e=m;if(!e)return 0;try{const{data:{user:t}}=await e.auth.getUser();if(!t)return 0;const{count:i,error:a}=await e.from("notifications").select("*",{count:"exact",head:!0}).or(`user_id.eq.${t.id},user_id.is.null`).eq("read",!1);return a?(console.warn("[NotificationService] Error fetching unread count:",a),0):i||0}catch(t){return console.warn("[NotificationService] Failed to get unread count:",t),0}}async markAsRead(e){if(!_.isOnline)return;const t=m;if(t)try{const{error:i}=await t.from("notifications").update({read:!0}).eq("id",e);i&&console.warn("[NotificationService] Error marking as read:",i)}catch(i){console.warn("[NotificationService] Failed to mark as read:",i)}}async markAllAsRead(){if(!_.isOnline)return;const e=m;if(e)try{const{data:{user:t}}=await e.auth.getUser();if(!t)return;const{error:i}=await e.from("notifications").update({read:!0}).or(`user_id.eq.${t.id},user_id.is.null`).eq("read",!1);i&&console.warn("[NotificationService] Error marking all as read:",i)}catch(t){console.warn("[NotificationService] Failed to mark all as read:",t)}}subscribeToNewNotifications(e){if(!_.isOnline)return()=>{};const t=m;if(!t)return()=>{};let i=null;return t.auth.getUser().then(({data:{user:a}})=>{if(!a)return;const r=m;r&&(i=r.channel(`public:notifications:user_id=eq.${a.id}`).on("postgres_changes",{event:"INSERT",schema:"public",table:"notifications"},n=>{const s=n.new;(s.user_id===a.id||s.user_id===null)&&e(s)}).subscribe())}),()=>{const a=m;i&&a&&a.removeChannel(i)}}}class gt{_uiManager;_audioManager;_onBack;_activeTab="all";_notifications=[];_unsubscribeRealtime=null;constructor(e,t,i){this._uiManager=e,this._audioManager=t,this._onBack=i,this._unsubscribeRealtime=R.getInstance().subscribeToNewNotifications(a=>{this._notifications.unshift(a),this.render()}),this._loadNotifications()}async _loadNotifications(){const e=R.getInstance();this._notifications=await e.getNotifications(),this.render()}render(){const e=this._uiManager.container,t=o.currentLocale,i=this._notifications.filter(l=>this._activeTab==="all"?!0:this._activeTab==="unread"?!l.read:l.category===this._activeTab),r=[{id:"all",label:{en:"All",am:"ሁሉም",om:"Hunda"}},{id:"unread",label:{en:"Unread",am:"ያልተነበቡ",om:"Kan Hin Dubbifamne"}},{id:"daily",label:{en:"Daily",am:"የዕለት",om:"Guyyaa"}},{id:"tournament",label:{en:"League",am:"ሊግ",om:"Liigii"}},{id:"rewards",label:{en:"Rewards",am:"ሽልማቶች",om:"Badhaasa"}},{id:"announcements",label:{en:"System",am:"ስርዓት",om:"Sirna"}},{id:"subscription",label:{en:"Billing",am:"ክፍያ",om:"Kaffaltii"}}].map(l=>{const c=l.id===this._activeTab,d=l.id==="unread"?this._notifications.filter(h=>!h.read).length:l.id==="all"?this._notifications.length:this._notifications.filter(h=>h.category===l.id).length;return`
            ...
            `}).join(""),n=i.length>0?i.map(l=>{const d={daily:"📅",tournament:"🏆",rewards:"🎁",announcements:"📢",system:"⚙️",subscription:"💳"}[l.category]||"🔔",h=t==="am"&&l.title_am?l.title_am:t==="om"&&l.title_om?l.title_om:l.title_en,u=t==="am"&&l.body_am?l.body_am:t==="om"&&l.body_om?l.body_om:l.body_en,f=new Date(l.created_at).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"});return`
            ...
            `}).join(""):E.EmptyState("📭","No Notifications"),s=this._notifications.some(l=>!l.read);e.innerHTML=`
            <div class="stadium-container ethio-bg-main" style="pointer-events: auto;">
                ...
                <!-- App Bar -->
                ${w.render(t==="am"?"ማሳወቂያዎች":t==="om"?"BEEKSIISAA":"NOTIFICATIONS",s?`
        ...
        `,this._bindEvents()}_filterNotifications(e){const t=o.currentLocale;let i=this._notifications.filter(r=>this._activeTab==="all"?!0:this._activeTab==="unread"?!r.read:r.category===this._activeTab);if(e.trim()){const r=e.toLowerCase();i=i.filter(n=>n.title_en&&n.title_en.toLowerCase().includes(r)||n.title_am&&n.title_am.toLowerCase().includes(r)||n.title_om&&n.title_om.toLowerCase().includes(r)||n.body_en&&n.body_en.toLowerCase().includes(r)||n.body_am&&n.body_am.toLowerCase().includes(r)||n.body_om&&n.body_om.toLowerCase().includes(r))}const a=document.getElementById("notifications-list");a&&(a.innerHTML=i.length>0?i.map(n=>{const l={daily:"📅",tournament:"🏆",rewards:"🎁",announcements:"📢",system:"⚙️",subscription:"💳"}[n.category]||"🔔",c=t==="am"&&n.title_am?n.title_am:t==="om"&&n.title_om?n.title_om:n.title_en,d=t==="am"&&n.body_am?n.body_am:t==="om"&&n.body_om?n.body_om:n.body_en,h=new Date(n.created_at).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"});return`
                ...
                `}).join(""):E.EmptyState("📭","No Notifications"),a.querySelectorAll(".notif-item").forEach(n=>{n.addEventListener("click",async s=>{const c=s.currentTarget.getAttribute("data-notif-id");c&&(this._audioManager.playClick(),await R.getInstance().markAsRead(c),await this._loadNotifications())})}),document.getElementById("btn-empty-clear-notif")?.addEventListener("click",()=>{this._audioManager.playClick();const n=document.getElementById("notif-search-input");n&&(n.value="",this._filterNotifications(""))}))}_bindEvents(){w.bind(this._uiManager.container,()=>{this._audioManager.playClick(),this._unsubscribeRealtime&&this._unsubscribeRealtime(),this._onBack()}),document.getElementById("notif-search-input")?.addEventListener("input",r=>{const n=r.target.value;this._filterNotifications(n)}),document.getElementById("btn-mark-read")?.addEventListener("click",async()=>{this._audioManager.playClick(),await R.getInstance().markAllAsRead(),await this._loadNotifications()}),this._uiManager.container.querySelectorAll(".notif-tab").forEach(r=>{r.addEventListener("click",n=>{const l=n.currentTarget.getAttribute("data-tab-id");l&&(this._audioManager.playClick(),this._activeTab=l,this.render())})}),this._uiManager.container.querySelectorAll(".notif-item").forEach(r=>{r.addEventListener("click",async n=>{const l=n.currentTarget.getAttribute("data-notif-id");l&&(this._audioManager.playClick(),await R.getInstance().markAsRead(l),await this._loadNotifications())})}),document.getElementById("btn-empty-home")?.addEventListener("click",()=>{this._audioManager.playClick(),this._unsubscribeRealtime&&this._unsubscribeRealtime(),this._onBack()});const a=this._uiManager.container.querySelector(".stadium-container");a&&re.attach(a,async()=>{this._audioManager.playClick(),await this._loadNotifications()})}}class ht{_uiManager;_saveManager;_audioManager;_onBack;constructor(e,t,i,a){this._uiManager=e,this._saveManager=t,this._audioManager=i,this._onBack=a}async render(){const e=this._uiManager.container;e.innerHTML=E.LoadingState("Loading stats...");const t=this._saveManager.profile,i=await F.getInstance().getHistory(50);let a=t.totalMatches||0,r=t.totalWins||0,n=a>0?Math.round(r/a*100):0,s=0,l=n,c=0,d=0,h=0;if(i.length>0){let S=0,L=0,z=0,W=0,V=0;i.forEach(N=>{S+=Number(N.accuracy)||0,L+=Number(N.avg_response_time)||0,z+=Number(N.correct_count)||0,V+=Number(N.total_questions)||10,W+=(Number(N.total_questions)||10)-(Number(N.correct_count)||0)}),l=Math.round(S/i.length),s=L/i.length*1e3;const oe=z/V,se=W/V;c=Math.round(a*10*oe),d=Math.round(a*10*se)}const u=s>0?(s/1e3).toFixed(1)+"s":"--",f=t.xp,x=t.highScores["football-quiz"]||0,v=(S,L,z)=>`
            <div style="margin-bottom: 12px;">
                <div style="display: flex; justify-content: space-between; margin-bottom: 6px;">
                    <div style="font-size: var(--fds-font-xs); font-weight: 700; color: var(--fds-text-dim); text-transform: uppercase;">${S}</div>
                    <div style="font-size: var(--fds-font-xs); font-weight: 800; color: var(--fds-text-main);">${L}%</div>
                </div>
                <div style="width: 100%; height: 8px; background: rgba(0,0,0,0.4); border-radius: 4px; overflow: hidden; border: 1px solid rgba(255,255,255,0.05);">
                    <div style="width: ${L}%; height: 100%; background: ${z}; border-radius: 4px; box-shadow: 0 0 8px ${z}; transition: width 1s ease-out;"></div>
                </div>
            </div>
        `,g=(S,L)=>`
            <div style="display: flex; justify-content: space-between; align-items: center; padding: 12px 16px; border-bottom: 1px solid rgba(255,255,255,0.05);">
                ...
                <div style="font-size: 15px; font-weight: 800; color: var(--fds-text-main);">${L}</div>
            </div>
        `,y=(S,L)=>M.renderCard(`<div style="display: flex; flex-direction: column;">${L}</div>`,S),b=(S,L)=>M.renderCard(`<div style="padding: 20px 16px 8px 16px;">${L}</div>`,S);let k="";a>0?k=b("VISUAL ANALYTICS",`
            ...
            <div class="stadium-container ethio-bg-main" style="pointer-events: auto; overflow-y: auto; padding-bottom: 120px;">
                ...
                <div style="max-width: 600px; margin: 0 auto; padding: 24px 16px;">
                    ...
                    ${y("OVERVIEW",`
                        ${g("Games Played",String(a))}
                        ${g("Matches Won",String(r))}
                        ${g("Accuracy",`${l}%`)}
                        <div style="border-bottom: none;">${g("Points / Rank Point",`${f} XP`)}</div>
                    `)}

                    ${y("PERFORMANCE",`
                        ${g("Highest Score",x.toLocaleString())}
                        ${g("Average Response Time",u)}
                        ${g("Correct Answers",String(c))}
                        ${g("Wrong Answers",String(d))}
                        <div style="border-bottom: none;">${g("Skipped Questions",String(h))}</div>
                    `)}
                ...
                <div style="flex: 1; overflow-y: auto; padding-bottom: 80px;" class="hide-scrollbar">
                    <div id="achievements-content" style="max-width: 600px; margin: 0 auto; display: flex; flex-direction: column; min-height: 100%;">
                        ...
                        <div style="margin: auto; padding: 40px;">
                            ${E.LoadingState(o.currentLocale==="am"?"ስኬቶችን በመጫን ላይ...":"Loading achievements...")}
                        </div>
                    </div>
                </div>
        ...
        `;const l=this._activeTab==="all"?this._achievements:this._achievements.filter(c=>c.categoryId===this._activeTab);n+=`
            <div style="padding: 0 16px;">
                ${l.length>0?l.map(c=>this._buildAchievementCard(c)).join(""):E.EmptyState("🎁","No Achievements","Keep playing to unlock your first achievement.")}
            </div>
        `,e.innerHTML=n,this._bindTabs()}_buildAchievementCard(e){const t=o.currentLocale==="am"?e.titleAm:o.currentLocale==="om"?e.titleOm:e.titleEn,i=o.currentLocale==="am"?e.descriptionAm:o.currentLocale==="om"?e.descriptionOm:e.descriptionEn,a=Math.min(100,Math.round(e.progress/e.maxProgress*100)),r=e.isUnlocked?"unlocked":"locked";let n="";return e.categoryId==="rewards"&&e.rewardEligibility&&(n=`<div class="ethio-reward-tag">${e.rewardEligibility.rewardType}</div>`),`
        ...
        `}_bindTabs(){document.querySelectorAll(".ach-tab").forEach(n=>{n.addEventListener("click",s=>{const c=s.currentTarget.getAttribute("data-tab");c&&c!==this._activeTab&&(this._audioManager.playClick(),this._activeTab=c,this._renderContent())})});const t=document.querySelectorAll(".ach-card"),i=document.getElementById("ach-detail-modal"),a=document.getElementById("ach-modal-content"),r=document.getElementById("btn-close-ach-modal");t.forEach(n=>{n.addEventListener("click",s=>{const c=s.currentTarget.getAttribute("data-id"),d=this._achievements.find(h=>h.id===c);if(d&&i&&a){this._audioManager.playClick();const h=o.currentLocale==="am"?d.titleAm:o.currentLocale==="om"?d.titleOm:d.titleEn,u=o.currentLocale==="am"?d.descriptionAm:o.currentLocale==="om"?d.descriptionOm:d.descriptionEn,f=Math.min(100,Math.round(d.progress/d.maxProgress*100)),x=d.isUnlocked?"linear-gradient(90deg, #4ADE80, #22C55E)":"linear-gradient(90deg, #FBBF24, #F59E0B)";a.innerHTML=`
                        ...
                        <div style="font-size: 14px; color: var(--fds-text-muted); margin-bottom: 24px; max-width: 80%; line-height: 1.5;">${u}</div>
                    ...
                    `,i.style.display="flex",document.getElementById("btn-close-ach-modal-inner")?.addEventListener("click",()=>{this._audioManager.playClick(),i.style.display="none"})}})}),r?.addEventListener("click",()=>{this._audioManager.playClick(),i&&(i.style.display="none")})}}class ne{static instance;constructor(){}static getInstance(){return ne.instance||(ne.instance=new ne),ne.instance}async getAwards(e){if(!_.isOnline||!m)return[];try{const{data:t,error:i}=await m.rpc("get_past_tournament_winners",{p_period_type:e});if(!i&&t&&Array.isArray(t))return t.map(a=>({awardId:`awd_${a.user_id}_${e}`,tournamentId:`trn_${e}`,tournamentType:e,rank:a.rank,userMsisdn:a.msisdn||"",maskedMsisdn:this.maskMsisdn(a.msisdn||""),prizeAmount:this.calculatePrize(a.rank,e),currency:"ETB",tournamentStartDate:"",tournamentEndDate:"",awardDate:new Date().toISOString(),createdAt:new Date().toISOString()}))}catch(t){console.error("[AwardsService] Failed to fetch awards",t)}return[]}calculatePrize(e,t){if(t==="monthly"){if(e===1)return 5e4;if(e===2)return 25e3;if(e===3)return 1e4}else if(t==="weekly"){if(e===1)return 1e4;if(e===2)return 5e3;if(e===3)return 2500}else{if(e===1)return 1e3;if(e===2)return 500;if(e===3)return 250}return 0}maskMsisdn(e){const t=e.replace("+","");if(t.length<9)return e;const i=t.substring(0,5),a=t.substring(t.length-2);return`${i}*****${a}`}}class vt{_uiManager;_audioManager;_onBack;_activeTab="daily";_awards=[];_loading=!0;_error=null;constructor(e,t,i){this._uiManager=e,this._audioManager=t,this._onBack=i,this._loadAwards()}async _loadAwards(){this._loading=!0,this._error=null,this.render();try{this._awards=await ne.getInstance().getAwards(this._activeTab)}catch{this._error="Failed to load awards. Please try again."}finally{this._loading=!1,this.render()}}render(){const e=this._uiManager.container,t=i=>this._activeTab===i?`
                    flex: 1;
                    background: linear-gradient(135deg, var(--fds-green-pitch) 0%, var(--fds-green-dark) 100%);
                    border: 1px solid rgba(74, 222, 128, 0.4);
                    color: white;
        ...
        `,this._bindEvents()}_renderContent(){if(this._loading)return E.LoadingState("Loading awards...");if(this._error)return`
                <div style="text-align: center; padding: 40px 16px;">
                    ${E.ErrorState("btn-retry-awards")}
        ...
        `}_capitalize(e){return e.charAt(0).toUpperCase()+e.slice(1)}_bindEvents(){const e=this._uiManager.container;w.bind(e,()=>{this._audioManager.playClick(),this._onBack()}),e.querySelectorAll(".award-tab").forEach(t=>{t.addEventListener("click",i=>{const a=i.currentTarget.getAttribute("data-tab");a&&a!==this._activeTab&&(this._audioManager.playClick(),this._activeTab=a,this._loadAwards())})}),e.querySelector("#btn-view-tournaments")?.addEventListener("click",()=>{this._audioManager.playClick(),this._onBack()}),e.querySelector("#btn-retry-awards")?.addEventListener("click",()=>{this._audioManager.playClick(),this._loadAwards()})}}class yt{_uiManager;_saveManager;_audioManager;_onBack;_referralCode;_referralLink;constructor(e,t,i,a){this._uiManager=e,this._saveManager=t,this._audioManager=i,this._onBack=a,this._referralCode=this._saveManager.profile.phone||"GUEST",this._referralLink=`https://ethiofantasy.com/join?ref=${this._referralCode}`,window.ethioOnBackPress=()=>(this._audioManager.playClick(),this._onBack(),!0)}destroy(){window.ethioOnBackPress=null}render(){const e=this._uiManager.container,t='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path></svg>';e.innerHTML=`
            <div class="stadium-container ethio-bg-main" style="pointer-events: auto;">
                ...
                ${w.render(o.currentLocale==="am"?"ጓደኞችን ይጋብዙ":o.currentLocale==="om"?"HIRIYOOTA AFFEERI":"INVITE FRIENDS")}
                ...
                <div style="max-width: 600px; margin: 0 auto; padding: 24px 16px 120px 16px;">
                    ...
                    <div style="text-align: center; margin-bottom: 24px;">
                        ...
                        <h1 style="font-size: 24px; font-weight: 900; color: white; margin-bottom: 8px; text-transform: uppercase; letter-spacing: 0.5px;">${o.currentLocale==="am"?"ጓደኞችን ይጋብዙ":o.currentLocale==="om"?"Hiriyoota Affeeri":"Invite Friends"}</h1>
                        <p style="font-size: 15px; color: var(--fds-text-dim); line-height: 1.5; font-weight: 600;">${o.currentLocale==="am"?"ጓደኞችዎን ወደ ውድድሩ ያምጡ።":o.currentLocale==="om"?"Hiriyoota keessan dorgommiitti fidaa.":"Bring your friends into the competition."}</p>
                    </div>
                    ...
                    <div class="glass-card" style="margin-bottom: 24px; border-radius: 16px; padding: 20px; border: 1px solid rgba(255,255,255,0.08); background: rgba(15, 23, 42, 0.6); backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px);">
                        ...
                        <div style="margin-bottom: 20px;">
                            <label style="display: block; font-size: 12px; color: var(--tv-gold-primary); margin-bottom: 8px; font-weight: 800; text-transform: uppercase;">${o.currentLocale==="am"?"የግብዣ ኮድ":o.currentLocale==="om"?"Koodii Affeerichaa":"REFERRAL CODE"}</label>
                            <div style="display: flex; gap: 12px;">
                        ...
                        <div>
                            <label style="display: block; font-size: 12px; color: var(--tv-gold-primary); margin-bottom: 8px; font-weight: 800; text-transform: uppercase;">${o.currentLocale==="am"?"የግብዣ ሊንክ":o.currentLocale==="om"?"Liinkii Affeerichaa":"REFERRAL LINK"}</label>
                            <div style="display: flex; gap: 12px;">
                    ...
                    <div id="btn-share" style="background: linear-gradient(135deg, var(--fds-green-pitch) 0%, var(--fds-green-dark) 100%); padding: 16px; text-align: center; border-radius: 12px; font-weight: 900; font-size: 16px; color: white; letter-spacing: 0.5px; cursor: pointer; box-shadow: 0 4px 12px rgba(34, 197, 94, 0.3); margin-bottom: 24px;">
                        ${o.currentLocale==="am"?"ጓደኞችን ይጋብዙ":o.currentLocale==="om"?"HIRIYOOTA AFFEERI":"INVITE FRIENDS"}
                    </div>

                    <!-- STATUS / EMPTY STATE -->
                    <div style="text-align: center; padding: 24px 16px;">
                        <div style="font-size: 40px; margin-bottom: 12px; opacity: 0.5;">📉</div>
                        <div style="font-size: 15px; font-weight: 800; color: white; margin-bottom: 4px;">${o.currentLocale==="am"?"ምንም ጓደኞች ገና አልተጋበዙም":o.currentLocale==="om"?"Hiriyoonni hin affeeramne":"No Referrals Yet"}</div>
                        <div style="font-size: 13px; color: var(--fds-text-dim);">${o.currentLocale==="am"?"ጓደኞችን ይጋብዙ እና እዚህ የእርስዎን ሁኔታ ይከታተሉ።":o.currentLocale==="om"?"Hiriyoota affeeri asitti hordofi.":"Invite friends to track your referral status here."}</div>
                    </div>
        ...
        `,w.bind(e,()=>{this._audioManager.playClick(),this._onBack()}),e.querySelectorAll(".btn-copy").forEach(a=>{a.addEventListener("click",r=>{this._audioManager.playClick();const s=r.currentTarget.getAttribute("data-type")==="code"?this._referralCode:this._referralLink;navigator.clipboard.writeText(s),G.show(o.currentLocale==="am"?"ተቀድቷል ✅":o.currentLocale==="om"?"WARAABAMEERA ✅":"COPIED ✅","success")})}),document.getElementById("btn-share")?.addEventListener("click",async()=>{if(this._audioManager.playClick(),navigator.share)try{await navigator.share({title:o.currentLocale==="am"?"ኢትዮ ፋንታሲን ይጫወቱ":o.currentLocale==="om"?"Ethio Fantasy Taphadhu":"Play EthioFantasy",text:o.currentLocale==="am"?`በኢትዮ ፋንታሲ ላይ ተቀላቀሉኝ! የኔን ኮድ ይጠቀሙ፡ ${this._referralCode}`:o.currentLocale==="om"?`Ethio Fantasy irratti na waliin taphadhu! Koodii koo: ${this._referralCode}`:`Join me on EthioFantasy! Use my code: ${this._referralCode}`,url:this._referralLink})}catch(a){console.log("Share error:",a)}else navigator.clipboard.writeText(this._referralLink),G.show(o.currentLocale==="am"?"ሊንክ ተቀድቷል ✅":o.currentLocale==="om"?"LIINKIIN WARAABAMEERA ✅":"LINK COPIED ✅","success")})}}class bt{_uiManager;_saveManager;_audioManager;_onBack;constructor(e,t,i,a){this._uiManager=e,this._saveManager=t,this._audioManager=i,this._onBack=a,window.ethioOnBackPress=()=>(this._audioManager.playClick(),this._onBack(),!0)}destroy(){window.ethioOnBackPress=null}_maskPhone(e){let t=e.replace(/[^0-9]/g,"");return e.startsWith("+")?t=e.substring(1):t=e,t.startsWith("251")||(t="251"+t.replace(/^0+/,"")),t.length<9?t:t.substring(0,4)+"*****"+t.substring(t.length-2)}async render(){const e=this._uiManager.container,t=this._saveManager.profile,i=C.getDivision(t.xp);let a="Unranked";try{const s=await D.getInstance().getMyDailyStats();s&&(a=`#${s.rank}`)}catch(s){console.error("Failed to get rank:",s)}const r=t.username||`Player_${Math.floor(Math.random()*4294967295).toString(16)}`,n=t.phone?this._maskPhone(t.phone):"Guest";e.innerHTML=`
            <div class="stadium-container ethio-bg-main" style="pointer-events: auto;">
                ...
                ${w.render(o.currentLocale==="am"?"መለያ":o.currentLocale==="om"?"EENYUMMAA":"IDENTITY")}
                ...
                <div style="max-width: 600px; margin: 0 auto; padding: 24px 16px 120px 16px;">
                    ...
                    <div style="font-size: 14px; font-weight: 800; color: var(--tv-gold-primary); margin-bottom: 12px; text-transform: uppercase; padding-left: 8px;">
                        ${o.currentLocale==="am"?"የተጫዋች ሁኔታ":o.currentLocale==="om"?"SADARKAA TAPHATAA":"PLAYER STATUS"}
                    </div>
                    ...
                    <div class="glass-card" style="margin-bottom: 24px; border-radius: 16px; padding: 20px; border: 1px solid rgba(255,255,255,0.08); background: rgba(15, 23, 42, 0.6); backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px);">
                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 16px; padding-bottom: 16px; border-bottom: 1px solid rgba(255,255,255,0.05);">
                            <div style="font-size: 14px; color: var(--fds-text-dim);">${o.currentLocale==="am"?"ሊግ":o.currentLocale==="om"?"Liigii":"League"}</div>
                            <div style="font-size: 16px; font-weight: 800; color: white;">${i.name}</div>
                        </div>

                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 16px; padding-bottom: 16px; border-bottom: 1px solid rgba(255,255,255,0.05);">
                            <div style="font-size: 14px; color: var(--fds-text-dim);">${o.currentLocale==="am"?"ደረጃ":o.currentLocale==="om"?"Sadarkaa":"Rank"}</div>
                            <div style="font-size: 16px; font-weight: 800; color: var(--tv-gold-primary);">${a}</div>
                        </div>

                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            <div style="font-size: 14px; color: var(--fds-text-dim);">${o.currentLocale==="am"?"ነጥብ":o.currentLocale==="om"?"Qabxii":"Rank Point"}</div>
        ...
        `,w.bind(e,()=>{this._audioManager.playClick(),this._onBack()})}}class xt{_uiManager;_audioManager;_onBack;_activeCategory=null;_faqsCache=[];constructor(e,t,i,a){this._uiManager=e,this._audioManager=i,this._onBack=a,window.ethioOnBackPress=()=>(this._audioManager.playClick(),this._activeCategory?(this._activeCategory=null,this._faqsCache=[],this.render()):this._onBack(),!0)}destroy(){window.ethioOnBackPress=null}render(){const e=this._uiManager.container,t='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,0.2)" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18l6-6-6-6"/></svg>',i=[{id:"account",name:"Account",icon:"👤"},{id:"subscription",name:"Subscription",icon:"💳"},{id:"gameplay",name:"Gameplay",icon:"⚽"},{id:"dailyChallenge",name:"Daily Challenge",icon:"📅"},{id:"tournament",name:"Tournament",icon:"🏆"},{id:"rewards",name:"Rewards",icon:"🎁"},{id:"technicalIssues",name:"Technical Issues",icon:"🔧"}],a={account:[{q:"How is my account created?",a:"Your account is automatically created when you authenticate with your Ethio Telecom mobile phone number. There is no password required."},{q:"Can I delete my account?",a:"To delete your account data, please contact Ethio Telecom customer service or submit a support ticket via the app."}],subscription:[{q:"What is Premium Subscription?",a:"Premium subscription gives you unlimited daily plays, full access to all leagues, and entry into the weekly cash prize draws for 2 Birr/day."},{q:"How do I pay for subscription?",a:"Subscription fees are automatically deducted from your Ethio Telecom airtime balance daily."}],gameplay:[{q:"How do I play a match?",a:"Read the question carefully and tap the correct option before the timer runs out. Fast answers score Goals, while incorrect ones are Saved by the goalkeeper!"},{q:"How does the match timer work?",a:"You have 30 seconds per question in Solo Matches, and 20 seconds in Live 1v1 Matches. Answering quicker increases your possession stat!"}],dailyChallenge:[{q:"What is the Daily Challenge?",a:"The Daily Challenge is a special daily set of 10 trivia questions on hot football topics. Completing it awards double reward coins and a 1.5x XP bonus!"},{q:"How many times can I play the Daily Challenge?",a:"You can play the Daily Challenge once per calendar day. It resets every night at midnight EAT."}],tournament:[{q:"How do tournaments work?",a:"Tournaments are knockout brackets held every weekend. Players register during the week and compete live in 1v1 match phases to progress."},{q:"What are the tournament entry requirements?",a:"Premium subscribers can enter tournaments for free. Basic and free players must pay a 100 coin registration fee."}],rewards:[{q:"What rewards can I win?",a:"You can win in-game coins, profile XP, custom football badges, and real cash prizes credited directly to your Ethio Telecom mobile account balance."},{q:"When are weekly prizes distributed?",a:"Weekly prizes are processed and sent every Monday at 10:00 AM EAT based on the final Sunday night division standings."}],technicalIssues:[{q:"The app is freezing. What should I do?",a:"Ensure you have a stable network connection (3G/4G/LTE/5G). Try refreshing the app page by swiping down, or clearing your mobile browser cache."}]};if(this._activeCategory){const s=this._faqsCache.length>0?this._faqsCache:a[this._activeCategory]||[],l=s.map((x,v)=>`
            ...
            `).join(""),c=i.find(x=>x.id===this._activeCategory),d=c?c.name:this._activeCategory,h=`
                <div style="text-align: center; padding: 40px 16px;">
                    <div style="font-size: 48px; margin-bottom: 16px; opacity: 0.5;">📋</div>
                    <div style="font-size: 16px; font-weight: 800; color: white; margin-bottom: 8px;">No FAQs Available</div>
            ...
            `;e.innerHTML=`
                <div class="stadium-container ethio-bg-main" style="pointer-events: auto;">
                    ...
                    <div style="max-width: 600px; margin: 0 auto; padding: 24px 16px 120px 16px;">
                        ...
                        <div style="margin-bottom: 24px; padding-left: 12px; border-left: 4px solid var(--tv-gold-primary);">
                            <div style="font-size: 18px; font-weight: 900; color: white; margin-bottom: 4px; letter-spacing: 0.5px;">${d.toUpperCase()}</div>
        ...
        `,w.bind(e,()=>{this._audioManager.playClick(),this._onBack()}),e.querySelectorAll(".faq-category-tile").forEach(s=>{s.addEventListener("click",async l=>{const d=l.currentTarget.getAttribute("data-cat-id");if(d){this._audioManager.playClick(),this._activeCategory=d,this.render();try{const u=await Y.getInstance().getFAQsByCategory(d);u&&u.length>0&&(this._faqsCache=u.map(f=>{let x=f.question_en,v=f.answer_en;return o.currentLocale==="am"&&f.question_am&&f.answer_am?(x=f.question_am,v=f.answer_am):o.currentLocale==="om"&&f.question_om&&f.answer_om&&(x=f.question_om,v=f.answer_om),{q:x,a:v}}))}catch(h){console.error("Failed to fetch FAQs:",h)}this.render()}})})}}const _t="1.0.0",wt={version:_t};class kt{_uiManager;_audioManager;_onBack;constructor(e,t,i,a){this._uiManager=e,this._audioManager=i,this._onBack=a,window.ethioOnBackPress=()=>(this._audioManager.playClick(),this._onBack(),!0)}destroy(){window.ethioOnBackPress=null}render(){const e=this._uiManager.container,i=[{title:o.currentLocale==="am"?"ስለ ኢትዮ ፋንታሲ":o.currentLocale==="om"?"Waa'ee EthioFantasy":"About EthioFantasy",content:o.currentLocale==="am"?"ኢትዮፋንታሲ በኢትዮጵያ ውስጥ ላሉ የእግር ኳስ አፍቃሪዎች የተዘጋጀ ልዩ የእግር ኳስ ጥያቄዎች ሊግ ነው።":o.currentLocale==="om"?"EthioFantasy dorgommii gaaffii kubbaa miilaa fayyadamtoota Itoophiyaatif qophaa'ee dha.":"EthioFantasy is a premium Football Quiz League platform crafted specifically for football fans in Ethiopia."},{title:o.currentLocale==="am"?"እንዴት እንደሚሰራ":o.currentLocale==="om"?"Akkamitti Hojjeta":"How It Works",content:o.currentLocale==="am"?"ዕለታዊ የትሪቪያ ጨዋታዎችን ይጫወቱ፣ ሌሎች ተጫዋቾችን በቀጥታ 1v1 ይፈትኑ እና በሊግ ደረጃዎች ይውጡ።":o.currentLocale==="om"?"Tapha guyyaa taphadhaa, dorgomtoota kan biroo 1v1 irratti falmaa, sadarkaa liigii kooraa.":"Play daily trivia matches, challenge other players in live 1v1 showdowns, and climb the league divisions."},{title:o.currentLocale==="am"?"ጨዋታዎች እና ፈተናዎች":o.currentLocale==="om"?"Taphawwanii fi Qormaata":"Games & Challenges",content:o.currentLocale==="am"?"የዕለት ተግዳሮቶች ከነጥብ ማባዣዎች ጋር እና የክህሎት ማረጋገጫ የሆኑ ጥያቄዎች።":o.currentLocale==="om"?"Qormaata guyyaa qabxii baay'isu waliin.":"Daily themed challenges with score multipliers and skill-based quizzes."},{title:o.currentLocale==="am"?"ውድድሮች":o.currentLocale==="om"?"Dorgommii":"Tournaments",content:o.currentLocale==="am"?"የሳምንቱ መጨረሻ ውድድሮች እና የE-ስፖርት አይነት የማለፊያ ውድድሮች።":o.currentLocale==="om"?"Dorgommii dhuma torbaniti.":"Interactive Weekend knockout tournaments with E-Sports style brackets."},{title:o.currentLocale==="am"?"ሽልማቶች":o.currentLocale==="om"?"Badhaasa":"Rewards",content:o.currentLocale==="am"?"የገንዘብ ሽልማቶችን እና ልዩ ባጆችን በውድድሮች አሸንፈው ይውሰዱ።":o.currentLocale==="om"?"Badhaasa qarshii mo'achuuf sadarkaa liigii kooraa.":"Win real cash prizes, badges, and recognition on the Ethio Telecom VAS platform."},{title:o.currentLocale==="am"?"ድጋፍ":o.currentLocale==="om"?"Deeggarsa":"Support",content:"support@ethiofantasy.com<br>Powered by InnoGames VAS Team"}].map(a=>`
        ...
        `).join("");e.innerHTML=`
            <div class="stadium-container ethio-bg-main" style="pointer-events: auto; overflow-y: auto;">
                ...
                ${w.render(o.currentLocale==="am"?"ስለ ኢትዮ ፋንታሲ":o.currentLocale==="om"?"WAA'EE ETHIO FANTASY":"ABOUT ETHIOFANTASY")}
                ...
                <div style="max-width: 600px; margin: 0 auto; padding: 24px 16px 120px 16px;">
                    ...
                    <div style="text-align: center; margin-top: 32px; padding-top: 24px; border-top: 1px dashed rgba(255,255,255,0.15);">
                        ...
                        <div style="font-size: 14px; font-weight: 700; color: var(--tv-gold-primary); margin-bottom: 12px;">Version ${wt.version}</div>
                        <div style="font-size: 12px; color: rgba(255,255,255,0.4);">© ${new Date().getFullYear()} Ethio Telecom VAS. All Rights Reserved.</div>
                    </div>

                </div>
            </div>
        `,w.bind(e,()=>{this._audioManager.playClick(),this._onBack()})}}class St{_uiManager;_audioManager;_onBack;constructor(e,t,i,a){this._uiManager=e,this._audioManager=i,this._onBack=a,window.ethioOnBackPress=()=>(this._audioManager.playClick(),this._onBack(),!0)}destroy(){window.ethioOnBackPress=null}render(){const e=this._uiManager.container,t=o.currentLocale==="am"?`
            <div style="font-family: sans-serif; line-height: 1.6;">
        ...
        `;e.innerHTML=`
            <div class="stadium-container ethio-bg-main" style="pointer-events: auto; overflow-y: auto;">
                ...
                ${w.render(o.currentLocale==="am"?"ውሎች እና ሁኔታዎች":o.currentLocale==="om"?"WALIIGALTEE":"TERMS & CONDITIONS")}
        ...
        `,w.bind(e,()=>{this._audioManager.playClick(),this._onBack()})}}const At=EventTarget.prototype.addEventListener;EventTarget.prototype.addEventListener=function(p,e,t){if(p==="click"){const i=e;e=async function(a){const r=a.currentTarget;if(r&&r.nodeType===Node.ELEMENT_NODE){if(r.hasAttribute("disabled")||r.hasAttribute("data-ethio-processing")){a.preventDefault(),a.stopImmediatePropagation();return}r.setAttribute("data-ethio-processing","true");const n=r.style.pointerEvents;r.style.pointerEvents="none";try{const s=i.call(this,a);s instanceof Promise&&await s}finally{setTimeout(()=>{r.removeAttribute("data-ethio-processing"),r.style.pointerEvents=n},300)}}else i.call(this,a)}}return At.call(this,p,e,t)};async function Et(){const p=new Ue;await p.initialize();const e=B.getInstance(p.saveManager),t=U.getInstance(),i=ae.getInstance(),a=new Ge(p.uiManager);a.registerGame(new Ze),q.getInstance().subscribeToBadgeUpdates(g=>{T.setBadge("profile",g)});const r=window;r.ethioAudio=p.audioManager,r.ethioSave=p.saveManager,r.ethioAuth=e,r.ethioCache=t,r.ethioEvents=i;let n={home:["home"],play:["play"],standings:["standings"],profile:["profile"]},s="home",l=null;try{window.history.replaceState({root:!0},""),window.history.pushState({trap:!0},"")}catch{}const c=async(g,y=!0)=>{if(l&&typeof l.destroy=="function"&&l.destroy(),p.audioManager.stopAllGameplaySounds(),l=null,y){const b=n[s]||[];b.length>0&&b[b.length-1]!==g&&b.push(g)}switch(g){case"home":T.setActiveTab("home"),s="home",t.setQuizActive(!1);const b=new it(p.saveManager,p.audioManager,p.uiManager,{onKickOff:async()=>{t.setQuizActive(!0),a.getRegisteredGames().find(K=>K.metadata.id==="football-quiz").setCompetition("walia-ibex"),n[s].push("quiz_game"),await a.launchGame("football-quiz")},onLiveMatch:()=>c("matchmaking"),onDailyChallenge:()=>{c("play_single_path",!1)},onCompetitions:()=>d("standings"),onLeaderboard:()=>d("standings"),onAchievements:()=>d("profile"),onAdminPanel:()=>c("admin"),onSettings:()=>c("settings"),onNotifications:()=>c("notifications"),onViewStats:()=>c("stats"),onMessages:()=>c("messages"),onCasualPlay:async()=>{const O=a.getRegisteredGames().find(K=>K.metadata.id==="football-quiz");O.setCompetition("all"),O.matchType="casual",n[s].push("quiz_game"),await a.launchGame("football-quiz")}});l=b,b.render();break;case"play":T.setActiveTab("play"),s="play",t.setQuizActive(!1);const k=new at(p.uiManager,p.audioManager,{onCasualPlay:async O=>{const K=a.getRegisteredGames().find(qe=>qe.metadata.id==="football-quiz");K.setCompetition(O&&O!=="random"?O:"all"),K.matchType="casual",n[s].push("quiz_game"),await a.launchGame("football-quiz")}});l=k,k.render();break;case"standings":T.setActiveTab("standings"),s="standings",t.setQuizActive(!1);const A=new ot(p.uiManager,p.saveManager,p.audioManager,u);l=A,await A.render();break;case"play_single_path":t.setQuizActive(!0);const S=await Q.getInstance().getTodayChallenge(),L=a.getRegisteredGames().find(O=>O.metadata.id==="football-quiz");!S.completed&&S.questions.length>0?(L.setCompetition(S.questions[0]?.category||"world-cup"),L.setPreloadedQuestions(S.questions),L.matchType="daily",L.dailyChallengeId=S.id,n[s].push("quiz_game"),await a.launchGame("football-quiz")):(de(()=>Promise.resolve().then(()=>Xe),void 0).then(O=>O.Toast.show(o.currentLocale==="am"?"የዕለቱ ውድድር አልቋል! 내일 ይሞክሩ":"Daily challenge already completed! Come back tomorrow.","error")),t.setQuizActive(!1),d("home"));break;case"profile":T.setActiveTab("profile"),s="profile",t.setQuizActive(!1);const z=new st(p.uiManager,p.saveManager,p.audioManager,{onAchievements:()=>c("achievements"),onStatistics:()=>c("stats"),onLeaderboard:()=>d("standings"),onSubscription:()=>c("subscription"),onMessages:()=>c("messages"),onSettings:()=>c("settings"),onHelp:()=>c("help"),onAbout:()=>c("about"),onPrivacy:()=>c("privacy"),onTerms:()=>c("terms"),onAwards:()=>c("awards"),onInvite:()=>c("invite"),onIdentity:()=>c("identity"),onFaq:()=>c("faq")});l=z,z.render();break;case"messages":t.setQuizActive(!1);const W=new ct(p.uiManager,p.audioManager,u);l=W,W.render();break;case"settings":t.setQuizActive(!1);const V=new ge(p.uiManager,p.saveManager,p.audioManager,u,"main");l=V,V.render();break;case"help":t.setQuizActive(!1);const oe=new ge(p.uiManager,p.saveManager,p.audioManager,u,"help");l=oe,oe.render();break;case"achievements":t.setQuizActive(!1);const se=new ft(p.uiManager,p.saveManager,p.audioManager,u);l=se,se.render();break;case"awards":t.setQuizActive(!1);const N=new vt(p.uiManager,p.audioManager,u);l=N,N.render();break;case"invite":t.setQuizActive(!1);const fe=new yt(p.uiManager,p.saveManager,p.audioManager,u);l=fe,fe.render();break;case"identity":t.setQuizActive(!1);const ve=new bt(p.uiManager,p.saveManager,p.audioManager,u);l=ve,ve.render();break;case"faq":t.setQuizActive(!1);const ye=new xt(p.uiManager,p.saveManager,p.audioManager,u);l=ye,ye.render();break;case"about":t.setQuizActive(!1);const be=new kt(p.uiManager,p.saveManager,p.audioManager,u);l=be,be.render();break;case"privacy":t.setQuizActive(!1);const xe=new ge(p.uiManager,p.saveManager,p.audioManager,u,"privacy");l=xe,xe.render();break;case"terms":t.setQuizActive(!1);const _e=new St(p.uiManager,p.saveManager,p.audioManager,u);l=_e,_e.render();break;case"notifications":t.setQuizActive(!1);const we=new gt(p.uiManager,p.audioManager,u);l=we,we.render();break;case"admin":t.setQuizActive(!1);const ke=new et(p.uiManager,p.audioManager,u);l=ke,ke.render();break;case"matchmaking":t.setQuizActive(!1);const Se=new lt(p.uiManager,p.audioManager,p.saveManager,async O=>{r.ethioLiveMatchInfo=O,c("live_match")},u);l=Se,await Se.render();break;case"live_match":t.setQuizActive(!0);const le=r.ethioLiveMatchInfo;if(!le){u();return}const Be=await H.getInstance().fetchQuestionsByIds(le.questionIds,o.currentLocale),Ae=new pt(p.uiManager,p.audioManager,p.saveManager,le.liveMatchId,le.opponent,Be,u);l=Ae,Ae.startMatch();break;case"stats":t.setQuizActive(!1);const Ee=new ht(p.uiManager,p.saveManager,p.audioManager,u);l=Ee,Ee.render();break;case"subscription":t.setQuizActive(!1);const Le=new mt(p.uiManager,p.audioManager,u);l=Le,Le.render();break}},d=g=>{const y=n[g],b=y[y.length-1];if(s===g){if(b===g)return;n[g]=[g],c(g,!0);return}s=g,c(b,!0)};r.ethioReloadHome=()=>d("home"),r.ethioHandleBack=()=>{u()},r.ethioCloseGame=()=>{t.setQuizActive(!1);const g=n[s]||[];g.length>0&&(g[g.length-1]==="quiz_game"||g[g.length-1]==="match_stats")&&g.pop();const y=g.length>0?g[g.length-1]:s;c(y,!1)},r.ethioForceHome=()=>{t.setQuizActive(!1);const g=n[s]||[];g.length>0&&(g[g.length-1]==="quiz_game"||g[g.length-1]==="match_stats")&&g.pop(),n.home=["home"],s="home",c("home",!0)},i.on("RELOAD_CURRENT_VIEW",()=>{t.isQuizActive||(console.log("[Bootstrap] Reloading current view upon event trigger."),c(s,!1))}),document.addEventListener("visibilitychange",()=>{document.visibilityState==="visible"&&!t.isQuizActive&&(console.log("[Bootstrap] App resumed. Triggering background refresh for stale data."),i.emit("DATA_REFRESHED"))});const h=()=>{const g=navigator.onLine;let y=document.getElementById("ethio-offline-banner");g?(y&&(y.style.background="var(--fds-green-pitch)",y.innerHTML="<span>✅</span><span>Connection restored! Refreshing data...</span>",setTimeout(()=>{y?.remove()},2e3)),t.isQuizActive||(console.log("[Bootstrap] Network restored. Triggering reconnection data sync."),i.emit("NETWORK_RESTORED"),i.emit("RELOAD_CURRENT_VIEW"))):y||(y=document.createElement("div"),y.id="ethio-offline-banner",y.style.cssText=`
                ...
                `,y.innerHTML="<span>⚠️</span><span>No internet connection. Paused. Reconnecting...</span>",document.body.appendChild(y))};window.addEventListener("online",h),window.addEventListener("offline",h);const u=()=>{const g=n[s]||[];if(typeof window.ethioOnBackPress=="function"&&window.ethioOnBackPress())return;p.audioManager.playClick();const y=document.querySelector('#session-recovery-overlay, #ethio-exit-modal, #ethio-leave-modal, .glass-card-modal, [id*="modal"]');if(y){y.remove();return}if(t.isQuizActive){f();return}if(g.length>1){g.pop();const b=g[g.length-1];(b==="quiz_game"||b==="match_stats")&&g.pop();const k=g.length>0?g[g.length-1]:s;c(k,!1)}else s==="home"?x():d("home")},f=()=>{if(document.getElementById("ethio-leave-modal"))return;const y=document.createElement("div");y.id="ethio-leave-modal",y.style.cssText=`
        ...
        `,document.body.appendChild(y),document.getElementById("leave-btn-continue")?.addEventListener("click",()=>{p.audioManager.playClick(),y.remove()}),document.getElementById("leave-btn-leave")?.addEventListener("click",()=>{p.audioManager.playClick(),y.remove(),t.setQuizActive(!1);const b=n[s]||[];b.length>0&&b[b.length-1]==="quiz_game"&&b.pop();const k=b.length>0?b[b.length-1]:s;c(k,!1)})},x=()=>{if(document.getElementById("ethio-exit-modal"))return;const y=document.createElement("div");y.id="ethio-exit-modal",y.style.cssText=`
            position: fixed; top: 0; left: 0; width: 100vw; height: 100vh;
            background: rgba(2, 6, 23, 0.88); backdrop-filter: blur(16px);
            z-index: 99999; display: flex; align-items: center; justify-content: center;
            padding: 20px; box-sizing: border-box; pointer-events: auto;
        ...
        `,document.body.appendChild(y),document.getElementById("exit-btn-stay")?.addEventListener("click",()=>{p.audioManager.playClick(),y.remove()}),document.getElementById("exit-btn-confirm")?.addEventListener("click",()=>{p.audioManager.playClick(),y.remove(),window.navigator?.app?.exitApp?window.navigator.app.exitApp():window.Android?.exitApp?window.Android.exitApp():window.close()})};window.addEventListener("popstate",g=>{g.preventDefault();try{window.history.pushState({trap:!0},"")}catch{}u()}),window.addEventListener("keydown",g=>{(g.key==="Escape"||g.key==="Back")&&u()}),r.ethioReloadHome=()=>d("home"),r.ethioNavigateToTab=g=>d(g),r.ethioPlayAgain=async g=>{t.setQuizActive(!0),a.getRegisteredGames().find(b=>b.metadata.id==="football-quiz").setCompetition(g),n[s]||(n[s]=[s]),n[s].push("quiz_game"),await a.launchGame("football-quiz")},T.render(g=>{d(g)});let v=null;return e.subscribe(g=>{const y=g?.id!==v;if(v=g?.id||null,!g)console.log("[Bootstrap] User signed out. Invalidating cache."),t.clear(),T.hide(),new rt(p.uiManager,p.audioManager,e,()=>{}).render();else if(console.log("[Bootstrap] User authenticated. Refreshing profile & channels:",g.username),T.show(),ee.getInstance().initUserChannels(g.id),i.emit("PROFILE_UPDATED",g),y){$.getInstance().getActiveSession()&&$.getInstance().clearSession(),n={home:["home"],play:["play"],standings:["standings"],profile:["profile"]},s="home",c("home",!1);try{window.history.replaceState({root:!0},""),window.history.pushState({trap:!0},"")}catch{}}}),console.log("[Bootstrap] ⚽ Smart Caching & Refresh Strategy initialized."),p}async function Lt(){try{await Et()}catch(p){console.error(p);const e=document.createElement("div");e.style.color="red",e.style.position="absolute",e.style.top="10px",e.style.left="10px",e.style.backgroundColor="white",e.style.padding="10px",e.style.fontFamily="monospace",e.innerText=`Runtime Error: ${p.message||p}
