...
${window.location.href}`),ae.show(s.currentLocale==="am"?"የእግር ኳስ መጋበዣ ሊንክ ወደ ቅሊፕቦርድ ተገልብጧል! ለመፎካከር ለጓደኞችዎ ያጋሩ።":s.currentLocale==="om"?"Geessituun affeerraa kubbaa miilaa kooppii ta'eera! Hiriyoota keetiif qooduun isaan qori.":"Football invitation link copied to clipboard! Share with friends to challenge them.","success")})})}}class Ve{metadata={id:"football-quiz",name:"Football Quiz League",description:"Televised sports match quiz with match stats, goal celebrations, and rewards!"};_uiManager;_audioManager;_saveManager;_quizEngine;_activeScoreboard=null;_targetCompetitionId="walia-ibex";_preloadedQuestions=null;matchType="casual";dailyChallengeId;async initialize(e){this._uiManager=e,this._quizEngine=new He;const t=window;this._audioManager=t.ethioAudio||new Ie,this._saveManager=t.ethioSave||new Te}async start(){const e=E.getById(this._targetCompetitionId)||E.getAll()[0];let t=this._preloadedQuestions;(!t||t.length===0)&&(t=await D.getInstance().fetchQuestions(e.id,10,s.currentLocale)),this._activeScoreboard=new Le(this._uiManager,this._audioManager,this._quizEngine,e,t,{onMatchComplete:(i,a)=>this._showMatchStats(e.id,i,a),onExitMatch:()=>this.destroy()}),this._activeScoreboard.startMatch()}async resume(e){const t=E.getById(e.matchType)||E.getAll()[0];this._activeScoreboard=new Le(this._uiManager,this._audioManager,this._quizEngine,t,e.questions,{onMatchComplete:(i,a)=>this._showMatchStats(t.id,i,a),onExitMatch:()=>this.destroy()}),this._activeScoreboard.resumeSession(e)}setCompetition(e){this._targetCompetitionId=e}setPreloadedQuestions(e){this._preloadedQuestions=e}_showMatchStats(e,t,i){const a=window;a.ethioCache&&a.ethioCache.setQuizActive(!1);const n=this.matchType==="daily"?"daily":e,r=new Ke(this._uiManager,this._saveManager,this._audioManager,t,i,n,()=>{const o=window;o.ethioCloseGame?o.ethioCloseGame():o.ethioReloadHome&&o.ethioReloadHome()});this.matchType==="daily"&&this.dailyChallengeId&&(r.dailyChallengeId=this.dailyChallengeId),r.render()}update(e){}destroy(){this._activeScoreboard&&(this._activeScoreboard.destroy(),this._activeScoreboard=null),this._uiManager.clear(),console.log("[QuizGameMode] Destroyed.");const e=window;e.ethioCloseGame?e.ethioCloseGame():e.ethioReloadHome&&e.ethioReloadHome()}}class K{static _instance=null;static getInstance(){return K._instance||(K._instance=new K),K._instance}async fetchPlatformAnalytics(){if(_.isOnline&&h)try{const{count:e}=await h.from("users").select("*",{count:"exact",head:!0}),{count:t}=await h.from("matches").select("*",{count:"exact",head:!0}),{count:i}=await h.from("competitions").select("*",{count:"exact",head:!0}),{count:a}=await h.from("subscriptions").select("*",{count:"exact",head:!0});return{activePlayers:e||124500,totalMatches:t||185e4,activeCompetitions:i||15,subscribedUsers:a||88200,smsOtpSuccessRate:"99.4%",avgLatencyMs:12}}catch(e){console.warn("[AnalyticsService] Supabase analytics query failed, returning fallback metrics:",e)}return{activePlayers:124500,totalMatches:185e4,activeCompetitions:15,subscribedUsers:88200,smsOtpSuccessRate:"99.4%",avgLatencyMs:12}}}class S{static render(e,t="",i=!0){return`
        ...
        `}static bind(e,t){const i=e.querySelector(".app-bar-back-btn");i&&i.addEventListener("click",a=>{a.preventDefault(),t()})}}class Xe{_uiManager;_audioManager;_onClose;_activeTab="QUESTIONS";_statusMessage="";_analyticsData=null;constructor(e,t,i){this._uiManager=e,this._audioManager=t,this._onClose=i}async render(){const e=this._uiManager.container,t=E.getAll();this._analyticsData=await K.getInstance().fetchPlatformAnalytics(),e.innerHTML=`
