...
import{c as Fe}from"./supabase-kic3bLQH.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))i(a);new MutationObserver(a=>{for(const n of a)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function t(a){const n={};return a.integrity&&(n.integrity=a.integrity),a.referrerPolicy&&(n.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?n.credentials="include":a.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(a){if(a.ep)return;a.ep=!0;const n=t(a);fetch(a.href,n)}})();const Re="modulepreload",De=function(p){return"/"+p},Te={},de=function(e,t,i){let a=Promise.resolve();if(t&&t.length>0){let r=function(c){return Promise.all(c.map(d=>Promise.resolve(d).then(g=>({status:"fulfilled",value:g}),g=>({status:"rejected",reason:g}))))};document.getElementsByTagName("link");const s=document.querySelector("meta[property=csp-nonce]"),l=s?.nonce||s?.getAttribute("nonce");a=r(t.map(c=>{if(c=De(c),c in Te)return;Te[c]=!0;const d=c.endsWith(".css"),g=d?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${g}`))return;const m=document.createElement("link");if(m.rel=d?"stylesheet":Re,d||(m.as="script"),m.crossOrigin="",m.href=c,l&&m.setAttribute("nonce",l),document.head.appendChild(m),d)return new Promise((b,y)=>{m.addEventListener("load",b),m.addEventListener("error",()=>y(new Error(`Unable to preload CSS for ${c}`)))})}))}function n(r){const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=r,window.dispatchEvent(s),!s.defaultPrevented)throw r}return a.then(r=>{for(const s of r||[])s.status==="rejected"&&n(s.reason);return e().catch(n)})};class Ne{_container;constructor(){let e=document.getElementById("ui-root");e||(e=document.createElement("div"),e.id="ui-root",e.style.position="absolute",e.style.top="0",e.style.left="0",e.style.width="100%",e.style.height="100%",e.style.pointerEvents="none",e.style.fontFamily="system-ui, -apple-system, sans-serif",document.body.appendChild(e)),this._container=e}get container(){return this._container}clear(){this._container.innerHTML="",this._container.classList.remove("page-transition-enter"),this._container.offsetWidth,this._container.classList.add("page-transition-enter")}}const Ie="https://eywvrsqiqvmiktovaxmq.supabase.co",He="sb_publishable_vSzKiN0dx8mgRRb3jsDonQ_BesE-gSx";class X{static _instance=null;_client=null;constructor(){try{this._client=Fe(Ie,He,{auth:{autoRefreshToken:!0,persistSession:!0,detectSessionInUrl:!0,storage:window.sessionStorage},realtime:{params:{eventsPerSecond:10}}}),console.log("[SupabaseClient] Initialized successfully with URL:",Ie)}catch(e){console.error("[SupabaseClient] Failed to initialize Supabase client:",e),this._client=null}}static getInstance(){return X._instance||(X._instance=new X),X._instance}get client(){return this._client}get isOnline(){return this._client!==null}}const _=X.getInstance(),h=_.client,Ge=Object.freeze(Object.defineProperty({__proto__:null,supabase:h,supabaseService:_},Symbol.toStringTag,{value:"Module"}));class Ce{_profile;_cloudUserId=null;constructor(){this._profile=this._defaultProfile()}get cloudUserId(){return this._cloudUserId}_defaultProfile(){return{username:"Player",coins:0,xp:0,highScores:{"football-quiz":0},unlockedItems:["default-ball","default-jersey"],eloRating:0,streakCount:0,totalMatches:0,totalWins:0}}syncWithCloudUser(e){this._cloudUserId=e.id,this._profile.username=e.username,this._profile.coins=e.coins,this._profile.xp=e.xp,this._profile.eloRating=e.elo_rating,this._profile.streakCount=e.streak_count,this._profile.totalMatches=e.total_matches,this._profile.totalWins=e.total_wins,e.phone&&(this._profile.phone=e.phone),this.save()}save(){const e=_.client;if(this._cloudUserId&&e){let t=0;if(this._profile.highScores)for(const i in this._profile.highScores)t+=this._profile.highScores[i];e.from("users").update({username:this._profile.username,coins:this._profile.coins,xp:this._profile.xp,score:t,elo_rating:this._profile.eloRating||0,streak_count:this._profile.streakCount||0,total_matches:this._profile.totalMatches||0,total_wins:this._profile.totalWins||0,last_active:new Date().toISOString()}).eq("id",this._cloudUserId).then(({error:i})=>{i&&console.error("[SaveManager] Error syncing profile to cloud:",i)})}}get profile(){return this._profile}updateUsername(e){this._profile.username=e,this.save()}updateHighScore(e,t){const i=this._profile.highScores[e]||0;return t>i?(this._profile.highScores[e]=t,this._profile.xp+=Math.floor(t*.5),this.save(),!0):!1}addCoins(e){this._profile.coins+=e,this.save()}addXp(e){this._profile.xp+=e,this.save()}incrementMatchStats(e){this._profile.totalMatches=(this._profile.totalMatches||0)+1,e&&(this._profile.totalWins=(this._profile.totalWins||0)+1),this.save()}updateStreak(e){this._profile.streakCount=e,this.save()}isAdmin(){return this._profile.role==="admin"}}class $e{_ctx=null;_isMuted=!1;_crowdGain=null;_crowdSource=null;_correctAnswerBuffer=null;_wrongAnswerBuffer=null;_answerSelectedBuffer=null;_finalWhistleBuffer=null;_questionArriveBuffer=null;_activeGameplaySound=null;constructor(){const e=localStorage.getItem("ETHIO_FOOTBALL_MUTED");e!==null&&(this._isMuted=e==="true"),typeof document<"u"&&document.addEventListener("visibilitychange",()=>{document.hidden&&this.stopAllGameplaySounds(.05)})}stopAllGameplaySounds(e=.08){if(this.stopCrowdAmbience(),!this._ctx||!this._activeGameplaySound)return;const t=this._activeGameplaySound;this._activeGameplaySound=null,t.timeoutId&&clearTimeout(t.timeoutId);const i=this._ctx.currentTime;try{t.gain.gain.cancelScheduledValues(i),t.gain.gain.setValueAtTime(t.gain.gain.value,i),t.gain.gain.linearRampToValueAtTime(.01,i+e),t.source.stop(i+e+.02)}catch{}}_playManagedSound(e,t,i,a=0){if(this.stopAllGameplaySounds(.02),!e||(this._initContext(),!this._ctx))return;const n=this._ctx.createBufferSource();n.buffer=e;const r=this._ctx.createGain();r.gain.value=t,n.connect(r),r.connect(this._ctx.destination),n.start(this._ctx.currentTime+a);const s={source:n,gain:r,timeoutId:void 0};this._activeGameplaySound=s,i&&(s.timeoutId=setTimeout(()=>{this._activeGameplaySound===s&&this.stopAllGameplaySounds(.08)},i))}_initContext(){if(!this._ctx){const e=window.AudioContext||window.webkitAudioContext;this._ctx=new e,console.log("[AudioManager] Football stadium Web AudioContext initialized.")}this._ctx.state==="suspended"&&this._ctx.resume()}_vibrate(e){if(!this._isMuted&&typeof navigator<"u"&&navigator.vibrate)try{navigator.vibrate(e)}catch{}}playClick(){if(this._isMuted||(this._vibrate(10),this._initContext(),!this._ctx))return;const e=this._ctx.createOscillator(),t=this._ctx.createGain();e.type="sine",e.frequency.setValueAtTime(800,this._ctx.currentTime),e.frequency.exponentialRampToValueAtTime(400,this._ctx.currentTime+.05),t.gain.setValueAtTime(.15,this._ctx.currentTime),t.gain.linearRampToValueAtTime(.01,this._ctx.currentTime+.05),e.connect(t),t.connect(this._ctx.destination),e.start(),e.stop(this._ctx.currentTime+.05)}playWhistle(){if(this._isMuted||(this._initContext(),!this._ctx))return;const e=this._ctx.createOscillator(),t=this._ctx.createOscillator(),i=this._ctx.createGain();e.type="sine",t.type="sine",e.frequency.setValueAtTime(2400,this._ctx.currentTime),t.frequency.setValueAtTime(2450,this._ctx.currentTime),i.gain.setValueAtTime(.18,this._ctx.currentTime),i.gain.linearRampToValueAtTime(.01,this._ctx.currentTime+.35),e.connect(i),t.connect(i),i.connect(this._ctx.destination),e.start(),t.start(),e.stop(this._ctx.currentTime+.35),t.stop(this._ctx.currentTime+.35)}playFullTimeWhistle(){if(!this._isMuted&&(this._vibrate([30,40,30]),this._initContext(),!!this._ctx)){if(!this._finalWhistleBuffer){const e=(i,a)=>{if(!this._ctx)return;const n=this._ctx.createOscillator(),r=this._ctx.createOscillator(),s=this._ctx.createGain();n.type="sine",r.type="sine",n.frequency.setValueAtTime(2400,i),r.frequency.setValueAtTime(2450,i),s.gain.setValueAtTime(0,i),s.gain.linearRampToValueAtTime(.18,i+.05),s.gain.setValueAtTime(.18,i+a-.1),s.gain.linearRampToValueAtTime(0,i+a),n.connect(s),r.connect(s),s.connect(this._ctx.destination),n.start(i),r.start(i),n.stop(i+a),r.stop(i+a)},t=this._ctx.currentTime;e(t,.25),e(t+.35,.25),e(t+.7,.6);return}this._playManagedSound(this._finalWhistleBuffer,.75,void 0,.15)}}playCrowdAmbience(){if(this._isMuted||(this._initContext(),!this._ctx||this._crowdSource))return;const e=this._ctx.sampleRate*2,t=this._ctx.createBuffer(1,e,this._ctx.sampleRate),i=t.getChannelData(0);let a=0,n=0,r=0;for(let s=0;s<e;s++){const l=Math.random()*2-1;a=.99886*a+l*.0555179,n=.99332*n+l*.0750759,r=.969*r+l*.153852,i[s]=(a+n+r)*.04}this._crowdSource=this._ctx.createBufferSource(),this._crowdSource.buffer=t,this._crowdSource.loop=!0,this._crowdGain=this._ctx.createGain(),this._crowdGain.gain.setValueAtTime(.04,this._ctx.currentTime),this._crowdSource.connect(this._crowdGain),this._crowdGain.connect(this._ctx.destination),this._crowdSource.start()}stopCrowdAmbience(){if(this._crowdSource){try{this._crowdSource.stop()}catch{}this._crowdSource=null}}playGoalCheer(){if(this._isMuted||(this._initContext(),!this._ctx))return;this.playWhistle();const e=this._ctx.createOscillator(),t=this._ctx.createGain();e.type="sine",e.frequency.setValueAtTime(140,this._ctx.currentTime),e.frequency.exponentialRampToValueAtTime(40,this._ctx.currentTime+.12),t.gain.setValueAtTime(.3,this._ctx.currentTime),t.gain.linearRampToValueAtTime(.01,this._ctx.currentTime+.12),e.connect(t),t.connect(this._ctx.destination),e.start(),e.stop(this._ctx.currentTime+.12),[523.25,659.25,783.99,1046.5].forEach((a,n)=>{if(!this._ctx)return;const r=this._ctx.createOscillator(),s=this._ctx.createGain();r.type="triangle",r.frequency.setValueAtTime(a,this._ctx.currentTime+n*.08),s.gain.setValueAtTime(.2,this._ctx.currentTime+n*.08),s.gain.linearRampToValueAtTime(.01,this._ctx.currentTime+n*.08+.3),r.connect(s),s.connect(this._ctx.destination),r.start(this._ctx.currentTime+n*.08),r.stop(this._ctx.currentTime+n*.08+.3)})}playWrongAnswer(e){this._isMuted||(this._vibrate([40,20,40]),this._wrongAnswerBuffer&&this._playManagedSound(this._wrongAnswerBuffer,.7,e))}playAnswerSelected(e){if(!this._isMuted){if(!this._answerSelectedBuffer){this.playClick();return}this._playManagedSound(this._answerSelectedBuffer,.4,e)}}playQuestionArrive(){this._isMuted||(this._vibrate([10]),this._questionArriveBuffer&&this._playManagedSound(this._questionArriveBuffer,.45))}playCountdownWarning(){if(this._isMuted||(this._initContext(),!this._ctx))return;const e=this._ctx.createOscillator(),t=this._ctx.createGain();e.type="sine",e.frequency.setValueAtTime(70,this._ctx.currentTime),e.frequency.exponentialRampToValueAtTime(30,this._ctx.currentTime+.08),t.gain.setValueAtTime(.3,this._ctx.currentTime),t.gain.linearRampToValueAtTime(.01,this._ctx.currentTime+.08),e.connect(t),t.connect(this._ctx.destination),e.start(),e.stop(this._ctx.currentTime+.08);const i=this._ctx.createOscillator(),a=this._ctx.createGain();i.type="triangle",i.frequency.setValueAtTime(1200,this._ctx.currentTime),a.gain.setValueAtTime(.12,this._ctx.currentTime),a.gain.linearRampToValueAtTime(.01,this._ctx.currentTime+.04),i.connect(a),a.connect(this._ctx.destination),i.start(),i.stop(this._ctx.currentTime+.04)}async preloadAssets(){if(!this._isMuted)try{const[e,t,i,a,n]=await Promise.all([fetch("/assets/audios/Righ%20Answer%20score%20goal.m4a"),fetch("/assets/audios/wrong%20answer.m4a"),fetch("/assets/audios/Answer%20selected.m4a"),fetch("/assets/audios/whistle%20when%20game%20ends%20or%20timout.m4a"),fetch("/assets/audios/question-arrive.mp3")]);if(!this._ctx){const r=window.AudioContext||window.webkitAudioContext;this._ctx=new r}if(e.ok){const r=await e.arrayBuffer();this._correctAnswerBuffer=await this._ctx.decodeAudioData(r)}if(t.ok){const r=await t.arrayBuffer();this._wrongAnswerBuffer=await this._ctx.decodeAudioData(r)}if(i.ok){const r=await i.arrayBuffer();this._answerSelectedBuffer=await this._ctx.decodeAudioData(r)}if(a.ok){const r=await a.arrayBuffer();this._finalWhistleBuffer=await this._ctx.decodeAudioData(r)}if(n.ok){const r=await n.arrayBuffer();this._questionArriveBuffer=await this._ctx.decodeAudioData(r)}console.log("[AudioManager] Audio assets preloaded successfully.")}catch(e){console.warn("[AudioManager] Failed to preload audio assets",e)}}playCorrectAnswerGoal(e){if(!this._isMuted){if(this._vibrate([30,40,30]),!this._correctAnswerBuffer){this.playGoalCheer();return}this._playManagedSound(this._correctAnswerBuffer,.8,e)}}playVictoryFanfare(){if(this._isMuted||(this._initContext(),!this._ctx))return;[523.25,659.25,783.99,1046.5,1318.51].forEach((t,i)=>{if(!this._ctx)return;const a=this._ctx.createOscillator(),n=this._ctx.createGain();a.type="triangle",a.frequency.setValueAtTime(t,this._ctx.currentTime+i*.1),n.gain.setValueAtTime(.25,this._ctx.currentTime+i*.1),n.gain.linearRampToValueAtTime(.01,this._ctx.currentTime+i*.1+.35),a.connect(n),n.connect(this._ctx.destination),a.start(this._ctx.currentTime+i*.1),a.stop(this._ctx.currentTime+i*.1+.35)})}playDefeatSound(){this._isMuted||(this._initContext(),this._ctx&&this.playWhistle())}toggleMute(){return this._isMuted=!this._isMuted,localStorage.setItem("ETHIO_FOOTBALL_MUTED",String(this._isMuted)),this._isMuted&&this.stopCrowdAmbience(),this._isMuted}get isMuted(){return this._isMuted}}class Ue{_uiManager;_saveManager;_audioManager;constructor(){this._uiManager=new Ne,this._saveManager=new Ce,this._audioManager=new $e}async initialize(){this._audioManager.preloadAssets()}get uiManager(){return this._uiManager}get saveManager(){return this._saveManager}get audioManager(){return this._audioManager}}class We{_games=new Map;_activeGame=null;_uiManager;constructor(e){this._uiManager=e}registerGame(e){this._games.set(e.metadata.id,e),console.log(`[GameRegistry] Registered game: ${e.metadata.name} (${e.metadata.id})`)}getRegisteredGames(){return Array.from(this._games.values())}async launchGame(e){this._activeGame&&(console.log(`[GameRegistry] Destroying active game: ${this._activeGame.metadata.name}`),this._activeGame.destroy(),this._uiManager.clear());const t=this._games.get(e);if(!t)throw new Error(`[GameRegistry] Game with ID '${e}' not found.`);console.log(`[GameRegistry] Initializing game: ${t.metadata.name}`),await t.initialize(this._uiManager),this._activeGame=t,t.start()}get activeGame(){return this._activeGame}}class Qe{_goals=0;_correct=0;_incorrect=0;_total=0;_currentCombo=0;_maxCombo=0;_responseTimes=[];_answerSubmissions=[];reset(){this._goals=0,this._correct=0,this._incorrect=0,this._total=0,this._currentCombo=0,this._maxCombo=0,this._responseTimes=[],this._answerSubmissions=[]}recordAnswer(e,t,i,a){if(this._total++,this._responseTimes.push(t),i&&a!==void 0&&this._answerSubmissions.push({questionId:i,selectedIndex:a,responseTimeMs:Math.round(t*1e3)}),e){this._goals++,this._correct++,this._currentCombo++,this._currentCombo>this._maxCombo&&(this._maxCombo=this._currentCombo);const n=100,r=(this._currentCombo-1)*25,s=n+r,l=20+this._currentCombo*5;return{isGoal:!0,coins:s,xp:l}}else return this._incorrect++,this._currentCombo=0,{isGoal:!1,coins:0,xp:0}}get answerSubmissions(){return this._answerSubmissions}calculateFinalStats(){const e=this._total>0?Math.round(this._correct/this._total*100):0,t=Math.min(Math.max(Math.round(e*.85+15),30),85),i=this._responseTimes.reduce((c,d)=>c+d,0),a=this._responseTimes.length>0?parseFloat((i/this._responseTimes.length).toFixed(1)):0,n=this._correct*100+this._maxCombo*50,r=this._correct*20+this._maxCombo*10;let s=5+e/20+this._maxCombo*.4;a>0&&a<5&&(s+=1);const l=parseFloat(Math.min(Math.max(s,3),10).toFixed(1));return{goals:this._goals,correctAnswers:this._correct,incorrectAnswers:this._incorrect,totalQuestions:this._total,accuracy:e,possessionPercent:t,avgResponseTime:a,maxCombo:this._maxCombo,coinsEarned:n,xpEarned:r,matchRating:l}}}const ze={"world-cup":{id:"world-cup",nameEn:"FIFA World Cup",nameAm:"የዓለም ዋንጫ",nameOm:"Waancaa Addunyaa FIFA",badge:"🏆",description:"World Cup history, records, hosts, and legend moments"},"champions-league":{id:"champions-league",nameEn:"UEFA Champions League",nameAm:"UEFA ቻምፒየንስ ሊግ",nameOm:"Liigii Chaampiyoonsii UEFA",badge:"⭐",description:"European club football, iconic finals, and top scorers"},"caf-champions":{id:"caf-champions",nameEn:"CAF Champions League",nameAm:"የCAF ሻምፒዮንስ ሊግ",nameOm:"Liigii Chaampiyoonsii CAF",badge:"🌍",description:"African club football and continental showdowns"},afcon:{id:"afcon",nameEn:"Africa Cup of Nations (AFCON)",nameAm:"የአፍሪካ ዋንጫ (AFCON)",nameOm:"Waancaa Afriikaa (AFCON)",badge:"🦁",description:"Africa's flagship national team championship"},"ethiopian-premier":{id:"ethiopian-premier",nameEn:"Ethiopian Premier League",nameAm:"የኢትዮጵያ ፕሪሚየር ሊግ",nameOm:"Liigii Piriimeraa Itoophiyaa",badge:"🇪🇹",description:"Ethiopian club teams, derbies, and domestic history"},"walia-ibex":{id:"walia-ibex",nameEn:"Walia Ibex (National Team)",nameAm:"ዋሊያ ኢቤክስ (ብሔራዊ ቡድን)",nameOm:"Waaliyaa Ibeks (Garaa Guutuu)",badge:"🐐",description:"Ethiopian national team milestones and heroes"},"premier-league":{id:"premier-league",nameEn:"English Premier League",nameAm:"የእንግሊዝ ፕሪሚየር ሊግ",nameOm:"Liigii Piriimeraa Ingilaand",badge:"🦁",description:"EPL clubs, managers, top scorers, and records"},"la-liga":{id:"la-liga",nameEn:"Spanish La Liga",nameAm:"የስፔን ላ ሊጋ",nameOm:"Laa Liigaa Ispeen",badge:"🇪🇸",description:"El Clásico, Spanish giants, and title races"},"serie-a":{id:"serie-a",nameEn:"Italian Serie A",nameAm:"የጣሊያን ሰሪ ኤ",nameOm:"Seeriyee A Xaaliyaanii",badge:"🇮🇹",description:"Calcio history, tactical legends, and Italian clubs"},bundesliga:{id:"bundesliga",nameEn:"German Bundesliga",nameAm:"የጀርመን ቡንደስሊጋ",nameOm:"Buundesliigaa Jarmaan",badge:"🇩🇪",description:"German football powerhouses and records"},"legendary-players":{id:"legendary-players",nameEn:"Legendary Players",nameAm:"አፈ ታሪክ ተጫዋቾች",nameOm:"Taphattootaa Seenaa",badge:"👟",description:"All-time greats, Ballon d'Or winners, and icons"},"football-rules":{id:"football-rules",nameEn:"Football Rules & Laws",nameAm:"የእግር ኳስ ሕግጋት",nameOm:"Seera Kubbaa Miilaa",badge:"📏",description:"Laws of the game, offside rule, VAR, and refereeing"},"transfer-market":{id:"transfer-market",nameEn:"Transfer Market & Fees",nameAm:"የዝውውር ገበያ",nameOm:"Gabaa Dabarsaa",badge:"💰",description:"Record transfer fees, contracts, and market moves"},stadiums:{id:"stadiums",nameEn:"Stadiums & Venues",nameAm:"ስታዲየሞች",nameOm:"Istaadiyeemota",badge:"🏟️",description:"Iconic football grounds, capacities, and host cities"},"football-history":{id:"football-history",nameEn:"Football History",nameAm:"የእግር ኳስ ታሪክ",nameOm:"Seenaa Kubbaa Miilaa",badge:"📜",description:"Origins, historic matches, and global football lore"}};class I{static _competitions=new Map;static _isInitialized=!1;static _initDefaults(){I._isInitialized||(Object.values(ze).forEach(e=>{I._competitions.set(e.id,{id:e.id,name:e.nameEn,nameEn:e.nameEn,nameAm:e.nameAm,nameOm:e.nameOm,badge:e.badge,description:e.description,color:"#FFD700",questionCount:10,status:"live",participants:0,prize_pool:0})}),I._isInitialized=!0)}static getAll(e="en"){return I._initDefaults(),Array.from(I._competitions.values()).map(t=>{let i=t.nameEn;return e==="am"&&t.nameAm&&(i=t.nameAm),e==="om"&&t.nameOm&&(i=t.nameOm),{...t,name:i}})}static getById(e,t="en"){I._initDefaults();const i=I._competitions.get(e);if(!i)return;let a=i.nameEn;return t==="am"&&i.nameAm&&(a=i.nameAm),t==="om"&&i.nameOm&&(a=i.nameOm),{...i,name:a}}static async syncFromCloud(e="en"){if(I._initDefaults(),_.isOnline&&h)try{const{data:t,error:i}=await h.from("competitions").select("*").eq("is_active",!0);if(!i&&t&&t.length>0){let a=0;try{const{count:n,error:r}=await h.from("game_sessions").select("*",{count:"exact",head:!0}).eq("state","playing");!r&&n&&(a=n)}catch{}t.forEach(n=>{I._competitions.set(n.id,{id:n.id,name:n.name_en,nameEn:n.name_en,nameAm:n.name_am||void 0,nameOm:n.name_om||void 0,badge:n.badge,description:n.description_en||"",color:n.color||"#FFD700",questionCount:n.question_count||10,status:"live",participants:a,prize_pool:0})})}}catch(t){console.warn("[CompetitionRegistry] Cloud sync failed, using defaults:",t)}return I.getAll(e)}static addCompetition(e){I._initDefaults(),I._competitions.set(e.id,e),console.log(`[CompetitionRegistry] Added competition: ${e.name}`)}static removeCompetition(e){return I._competitions.delete(e)}}class pe{static async invoke(e,t){if(!_.isOnline||!h)return{data:null,error:`Supabase client offline. Edge function '${e}' unavailable.`};try{const{data:i,error:a}=await h.functions.invoke(e,{body:t});return a?(console.error(`[EdgeFunctionClient] Error calling '${e}':`,a),{data:null,error:a.message}):{data:i,error:null}}catch(i){return console.error(`[EdgeFunctionClient] Exception in '${e}':`,i),{data:null,error:i.message||"Edge function invocation failed."}}}}const je=[{id:"fb-1",category:"walia-ibex",difficulty:2,prompt:"Which country won the first ever African Cup of Nations (AFCON) in 1957?",options:["Egypt","Ethiopia","Sudan","South Africa"],correctIndex:0,explanation:"Egypt defeated Ethiopia 4-0 in the final of the inaugural Africa Cup of Nations.",fact:"Only three nations participated in the first AFCON: Egypt, Ethiopia, and Sudan. South Africa was disqualified due to apartheid.",learningTip:"Remember '1957' as the birth year of AFCON."},{id:"fb-2",category:"walia-ibex",difficulty:1,prompt:"What is the nickname of the Ethiopian National Football Team?",options:["The Lions","Walia Ibex","The Pharoahs","Black Stars"],correctIndex:1,explanation:"The Walia Ibex is an endangered species of ibex found only in the Simien Mountains of Ethiopia."},{id:"fb-3",category:"ethiopian-premier",difficulty:3,prompt:"Which club holds the record for the most Ethiopian Premier League titles?",options:["Ethiopian Coffee SC","Dedebit FC","Fasil Kenema","Saint George SC"],correctIndex:3},{id:"fb-4",category:"ethiopian-premier",difficulty:3,prompt:"In which year was the Ethiopian Premier League established in its current format?",options:["1985","1997","2002","2010"],correctIndex:1},{id:"fb-5",category:"walia-ibex",difficulty:4,prompt:"Who is Ethiopia's all-time top goalscorer in international football?",options:["Getaneh Kebede","Saladin Said","Mengistu Worku","Adane Girma"],correctIndex:0},{id:"fb-6",category:"world-cup",difficulty:1,prompt:"Which nation has won the most FIFA Men's World Cup titles?",options:["Germany","Brazil","Argentina","Italy"],correctIndex:1},{id:"fb-7",category:"world-cup",difficulty:2,prompt:"Who won the Golden Boot in the 2022 FIFA World Cup?",options:["Lionel Messi","Kylian Mbappé","Julián Álvarez","Olivier Giroud"],correctIndex:1},{id:"fb-8",category:"champions-league",difficulty:2,prompt:"Which player has scored the most goals in UEFA Champions League history?",options:["Lionel Messi","Robert Lewandowski","Cristiano Ronaldo","Karim Benzema"],correctIndex:2},{id:"fb-9",category:"premier-league",difficulty:3,prompt:"Which team holds the record for most points in a single English Premier League season?",options:["Manchester United","Liverpool","Chelsea","Manchester City"],correctIndex:3},{id:"fb-10",category:"walia-ibex",difficulty:4,prompt:"Ethiopia won its only African Cup of Nations title in which year?",options:["1957","1962","1970","1982"],correctIndex:1,fact:"Ydnekatchew Tessema was one of the most influential figures in Ethiopian football history.",learningTip:"Ethiopia hosted and won the 1962 tournament, defeating Egypt 4-2 in the final after extra time."},{id:"fb-11",category:"premier-league",difficulty:2,prompt:"Who is the all-time top scorer of the English Premier League?",options:["Wayne Rooney","Alan Shearer","Harry Kane","Thierry Henry"],correctIndex:1},{id:"fb-12",category:"ethiopian-premier",difficulty:2,prompt:"What colors are primarily associated with Ethiopian Coffee SC?",options:["Green and Yellow","Red and White","Brown and Gold","Blue and White"],correctIndex:2},{id:"fb-13",category:"world-cup",difficulty:4,prompt:"Which African nation became the first to reach a FIFA World Cup Semi-Final?",options:["Senegal","Ghana","Morocco","Nigeria"],correctIndex:2},{id:"fb-14",category:"champions-league",difficulty:3,prompt:"Which club has won the most UEFA Champions League titles?",options:["AC Milan","Bayern Munich","Liverpool","Real Madrid"],correctIndex:3},{id:"fb-15",category:"walia-ibex",difficulty:5,prompt:"Who coached the Ethiopian National Team when they qualified for the 2013 AFCON?",options:["Bishaw Sewnet","Asrat Haile","Yohannes Sahle","Wubetu Abate"],correctIndex:0}];class H{static _instance=null;_askedQuestionIds=new Set;static getInstance(){return H._instance||(H._instance=new H),H._instance}async fetchQuestions(e,t=10,i="en",a=[],n="casual"){if(_.isOnline)try{const{data:s,error:l}=await pe.invoke("questions",{competitionId:e,count:t*2,locale:i,excludeIds:a,usageType:n});if(!l&&s&&s.questions&&s.questions.length>0)return console.log("[QuestionBank] Fetched server-authored questions via Edge Function."),this._selectQuestions(s.questions,t)}catch(s){console.warn("[QuestionBank] Edge Function failed.",s)}if(_.isOnline&&h)try{let s=h.from("questions").select("*").eq("is_active",!0);n==="casual"?s=s.eq("usage_type","casual"):n==="tournament"&&(s=s.eq("usage_type","tournament")),e&&e!=="all"&&(s=s.or(`competition_id.eq.${e},category.eq.${e}`)),a&&a.length>0&&(s=s.not("id","in",`(${a.join(",")})`));const{data:l,error:c}=await s.limit(50);if(!c&&l&&l.length>0){console.log("[QuestionBank] Fetched questions directly from Supabase DB.");const d=l.map(g=>this._mapQuestionRow(g,i));return this._selectQuestions(d,t)}}catch(s){console.warn("[QuestionBank] Supabase DB question fetch error:",s)}console.warn("[QuestionBank] Server connection unavailable. Serving fallback offline questions.");let r=je;if(e){const s=r.filter(l=>l.category===e);s.length>=Math.min(t,5)&&(r=s)}return a&&a.length>0&&(r=r.filter(s=>!a.includes(s.id))),this._selectQuestions(r,t)}async fetchQuestionsByIds(e,t="en"){if(_.isOnline&&h&&e.length>0)try{const{data:i,error:a}=await h.from("questions").select("*").in("id",e);if(!a&&i&&i.length>0){console.log(`[QuestionBank] Fetched ${i.length} specific questions by ID.`);const n=i.map(s=>this._mapQuestionRow(s,t,!1)),r=[];for(const s of e){const l=n.find(c=>c.id===s);l&&r.push(l)}return r}}catch(i){console.warn("[QuestionBank] Supabase DB fetchQuestionsByIds error:",i)}return this.fetchQuestions(void 0,e.length,t)}_mapQuestionRow(e,t,i=!0){let a=e.prompt_en,n=e.options_en;t==="am"&&e.prompt_am&&e.options_am?(a=e.prompt_am,n=e.options_am):t==="om"&&e.prompt_om&&e.options_om&&(a=e.prompt_om,n=e.options_om);let r=n,s=e.correct_index;if(i){const l=[0,1,2,3];for(let c=l.length-1;c>0;c--){const d=Math.floor(Math.random()*(c+1));[l[c],l[d]]=[l[d],l[c]]}r=l.map(c=>n[c]),s=l.indexOf(e.correct_index)}return{id:e.id,category:e.category,difficulty:e.difficulty,prompt:a,options:r,correctIndex:s}}_selectQuestions(e,t){let i=e.filter(s=>s.id&&!this._askedQuestionIds.has(s.id));i.length<t&&(this._askedQuestionIds.clear(),i=e);const n=[...i.length>=t?i:e];for(let s=n.length-1;s>0;s--){const l=Math.floor(Math.random()*(s+1));[n[s],n[l]]=[n[l],n[s]]}const r=n.slice(0,t);for(r.forEach(s=>{s.id&&this._askedQuestionIds.add(s.id)});r.length<t&&e.length>0;)r.push(e[Math.floor(Math.random()*e.length)]);return r}}const Ye={common:{title:"FOOTBALL QUIZ LEAGUE",subtitle:"ETHIO TELECOM VAS PLATFORM",close:"✖ CLOSE",backToHome:"✖ BACK TO HOME",play:"PLAY",submit:"SUBMIT",loading:"Loading...",error:"Error"},home:{soloMatch:"⚽ SOLO MATCH",liveMatch:"⚡ LIVE 1v1 MATCH",dailyChallenge:"📅 DAILY CHALLENGE",competitions:"🏆 COMPETITIONS",leaderboard:"📊 LEADERBOARD",badges:"🎖️ BADGES",admin:"⚙️ ADMIN",streak:"🔥 {count} DAY STREAK",coins:"🪙 {coins} COINS",level:"LVL {level}",invite:"Invite",inviteDesc:"+200 XP per friend.",copyLink:"Copy Link",performance:"📊 Performance",details:"DETAILS",matches:"MATCHES",points:"POINTS",score:"SCORE",lobbies:"⚽ Lobbies",championship:"🏆 ETHIOFANTASY CHAMPIONSHIP"},match:{questionCount:"QUESTION {current} OF {total}",goal:"⚽ GOAL!!!!!",saved:"🧤 SAVED!",halfTime:"HALF TIME",fullTime:"FULL TIME",matchStats:"MATCH STATISTICS",matchRating:"MATCH RATING",possession:"POSSESSION",accuracy:"ACCURACY",maxCombo:"MAX COMBO",coinsEarned:"COINS EARNED",xpEarned:"XP EARNED",continue:"CONTINUE TO HUB",leaveMatch:"Leave Match?",leaveWarning:"Your progress will be abandoned.",leaveBtn:"Leave",continueBtn:"Continue"},multiplayer:{matchmakingTitle:"LIVE MULTIPLAYER MATCHMAKING",findingOpponent:"FINDING WORTHY OPPONENT...",yourRating:"YOUR RATING",searchRange:"SEARCH RANGE",cancelMatchmaking:"✖ CANCEL MATCHMAKING",victory:"VICTORY!",draw:"MATCH DRAW!",defeated:"DEFEATED!",finalScore:"FINAL SCORE: {myScore} - {oppScore}",eloRating:"ELO RATING"},categories:{worldCup:"FIFA World Cup",championsLeague:"UEFA Champions League",cafChampions:"CAF Champions League",afcon:"Africa Cup of Nations",ethiopianPremier:"Ethiopian Premier League",waliaIbex:"Ethiopian National Team (Walia Ibex)",premierLeague:"Premier League",laLiga:"La Liga",serieA:"Serie A",bundesliga:"Bundesliga",legendaryPlayers:"Legendary Players",footballRules:"Football Rules & Laws",transferMarket:"Transfer Market",stadiums:"Stadiums & Venues",footballHistory:"Football History"}},Ke={common:{title:"የእግር ኳስ ጥያቄ ሊግ",subtitle:"ኢትዮ ቴሌኮም ቪኤኤስ መድረክ",close:"✖ ዝጋ",backToHome:"✖ ወደ ዋና ገጽ",play:"ተጫወት",submit:"ላክ",loading:"በመጫን ላይ...",error:"ስህተት"},home:{soloMatch:"⚽ ነጠላ ጨዋታ",liveMatch:"⚡ ቀጥታ 1v1 ጨዋታ",dailyChallenge:"📅 የዕለት ተግዳሮት",competitions:"🏆 ውድድሮች",leaderboard:"📊 ደረጃ ሰሌዳ",badges:"🎖️ ባጆች",admin:"⚙️ አድሚን",streak:"🔥 {count} ቀን ተከታታይ",coins:"🪙 {coins} ሳንቲም",level:"ደረጃ {level}",invite:"ጋብዝ",inviteDesc:"+200 XP በአንድ ጓደኛ",copyLink:"ሊንክ ኮፒ አድርግ",performance:"📊 አፈጻጸም",details:"ዝርዝር",matches:"ጨዋታዎች",points:"ነጥቦች",score:"ውጤት",lobbies:"⚽ ሎቢ",championship:"🏆 የኢትዮፋንታሲ ሻምፒዮና"},match:{questionCount:"ጥያቄ {current} ከ {total}",goal:"⚽ ጎል!!!!!",saved:"🧤 ተመለሰ!",halfTime:"እረፍት",fullTime:"ሙሉ ጊዜ",matchStats:"የጨዋታ ስታቲስቲክስ",matchRating:"የጨዋታ ደረጃ",possession:"ኳስ ቁጥጥር",accuracy:"ትክክለኛነት",maxCombo:"ከፍተኛ ተከታታይ",coinsEarned:"የተገኘ ሳንቲም",xpEarned:"የተገኘ XP",continue:"ወደ መነሻ ገጽ ተመለስ",leaveMatch:"ጨዋታውን ትተህ ውጣ?",leaveWarning:"ያለዎት እድገት ይጠፋል።",leaveBtn:"ውጣ",continueBtn:"ቀጥል"},multiplayer:{matchmakingTitle:"ቀጥታ ባለብዙ ተጫዋች ጨዋታ",findingOpponent:"ተፎካካሪ በመፈለግ ላይ...",yourRating:"የእርስዎ ደረጃ",searchRange:"የፍለጋ ክልል",cancelMatchmaking:"✖ ፍለጋውን ሰርዝ",victory:"ድል!",draw:"እኩል!",defeated:"ተሸንፈዋል!",finalScore:"የመጨረሻ ውጤት: {myScore} - {oppScore}",eloRating:"የኤሎ ደረጃ"},categories:{worldCup:"የዓለም ዋንጫ",championsLeague:"UEFA ቻምፒየንስ ሊግ",cafChampions:"የCAF ሻምፒዮንስ ሊግ",afcon:"የአፍሪካ ዋንጫ",ethiopianPremier:"የኢትዮጵያ ፕሪሚየር ሊግ",waliaIbex:"ዋሊያ ኢቤክስ (ብሔራዊ ቡድን)",premierLeague:"የእንግሊዝ ፕሪሚየር ሊግ",laLiga:"የስፔን ላ ሊጋ",serieA:"የጣሊያን ሰሪ ኤ",bundesliga:"የጀርመን ቡንደስሊጋ",legendaryPlayers:"አፈ ታሪክ ተጫዋቾች",footballRules:"የእግር ኳስ ሕግጋት",transferMarket:"የዝውውር ገበያ",stadiums:"ስታዲየሞች",footballHistory:"የእግር ኳስ ታሪክ"}},Ve={common:{title:"LIIGII GAAFFII KUBBAA MIILAA",subtitle:"ITIYO TELEKOOM VAS PLATFORM",close:"✖ Cufi",backToHome:"✖ Gara Fuula Duraatti",play:"Taphadhu",submit:"Ergi",loading:"Fe'amaa jira...",error:"Dogoggora"},home:{soloMatch:"⚽ TAPHA QOFAAA",liveMatch:"⚡ TAPHI KALLATTII 1v1",dailyChallenge:"📅 QORMAATA GUYYAA",competitions:"🏆 DORGOMMIIWWAN",leaderboard:"📊 SADARKAA",badges:"🎖️ BAADJIIWWAN",admin:"⚙️ ADMIIN",streak:"🔥 {count} GUYYAA WALITTI AANEE",coins:"🪙 {coins} SAAKKATOO",level:"SADARKAA {level}",invite:"Afeeri",inviteDesc:"+200 XP hiriyaa tokkoon",copyLink:"Liinkii Kopi godhi",performance:"📊 Raawwii",details:"BAL'INA",matches:"TAPHOOTA",points:"QABXII",score:"FIRI",lobbies:"⚽ Lobbies",championship:"🏆 CHAMPIONSHIP ETHIOFANTASY"},match:{questionCount:"GAAFFII {current} KEESSAA {total}",goal:"⚽ GOOLII!!!!!",saved:"🧤 QABAME!",halfTime:"BOQONNAA",fullTime:"YEROO GUUTUU",matchStats:"ISTATISTIKSII TAPHA",matchRating:"SADARKAA TAPHA",possession:"KUBBAA QABACHUU",accuracy:"SIREESSUU",maxCombo:"WAL-IRRAA OLAANAA",coinsEarned:"SANTIIMA ARGAME",xpEarned:"XP ARGATAME",continue:"GARA FUULA DURAA DEEBI'I",leaveMatch:"Tapha Dhiiftee Baataa?",leaveWarning:"Guddinni kee ni bada.",leaveBtn:"Bahi",continueBtn:"Itti Fufi"},multiplayer:{matchmakingTitle:"TAPHA KALLATTII DORGOMAA",findingOpponent:"DORGOMAA BARBAADAA JIRA...",yourRating:"SADARKAA KEE",searchRange:"DAANGAA BARBAADUU",cancelMatchmaking:"✖ BARBAADUU HAQI",victory:"INJIFANNOO!",draw:"QIXEE!",defeated:"MO'ATAMTEERTA!",finalScore:"QABXII GUUTUU: {myScore} - {oppScore}",eloRating:"SADARKAA ELO"},categories:{worldCup:"Waancaa Addunyaa FIFA",championsLeague:"Liigii Chaampiyoonsii UEFA",cafChampions:"Liigii Chaampiyoonsii CAF",afcon:"Waancaa Afriikaa",ethiopianPremier:"Liigii Piriimeraa Itoophiyaa",waliaIbex:"Waaliyaa Ibeks (Garee Biyyaaleessaa)",premierLeague:"Liigii Piriimeraa Ingilaand",laLiga:"Laa Liigaa Ispeen",serieA:"Seeriyee A Xaaliyaanii",bundesliga:"Buundesliigaa Jarmaan",legendaryPlayers:"Taphattootaa Seenaa",footballRules:"Seera Kubbaa Miilaa",transferMarket:"Gabaa Dabarsaa",stadiums:"Istaadiyeemota",footballHistory:"Seenaa Kubbaa Miilaa"}},ue={en:Ye,am:Ke,om:Ve};class J{static _instance=null;_currentLocale="en";constructor(){const e=localStorage.getItem("ETHIO_FOOTBALL_LOCALE");(e==="am"||e==="om"||e==="en")&&(this._currentLocale=e)}static getInstance(){return J._instance||(J._instance=new J),J._instance}setLocale(e){this._currentLocale=e,localStorage.setItem("ETHIO_FOOTBALL_LOCALE",e),console.log(`[i18n] Switched locale to: ${e}`)}get currentLocale(){return this._currentLocale}t(e,t){const i=e.split(".");let a=ue[this._currentLocale]||ue.en;for(const r of i)if(a&&a[r]!==void 0)a=a[r];else{let s=ue.en;for(const l of i)if(s&&s[l]!==void 0)s=s[l];else return e;a=s;break}if(typeof a!="string")return e;let n=a;return t&&Object.entries(t).forEach(([r,s])=>{n=n.replace(new RegExp(`\\{${r}\\}`,"g"),String(s))}),n}}const o=J.getInstance(),P=(p,e)=>o.t(p,e);class R{static _instance=null;constructor(){}static getInstance(){return R._instance||(R._instance=new R),R._instance}async createSession(e,t,i,a){if(!_.isOnline)return null;const n=h;if(!n)return null;try{const{data:{user:r}}=await n.auth.getUser();if(!r)return null;const{data:s,error:l}=await n.from("game_sessions").insert({user_id:r.id,match_type:e,competition_id:t,difficulty:typeof i=="string"?parseInt(i,10):i,question_ids:a,total_questions:a.length,time_remaining:60,state:"playing"}).select().single();return l?(console.warn("[GameSessionService] Error creating session:",l),null):s}catch(r){return console.warn("[GameSessionService] Failed to create session:",r),null}}async getActiveSession(){if(!_.isOnline)return null;const e=h;if(!e)return null;try{const{data:{user:t}}=await e.auth.getUser();if(!t)return null;const{data:i,error:a}=await e.from("game_sessions").select("*").eq("user_id",t.id).in("state",["playing","paused"]).order("created_at",{ascending:!1}).limit(1).single();return a&&a.code!=="PGRST116"?(console.warn("[GameSessionService] Error fetching active session:",a),null):i}catch(t){return console.warn("[GameSessionService] Failed to get active session:",t),null}}async updateSession(e,t){if(!_.isOnline)return;const i=h;if(i)try{const{error:a}=await i.from("game_sessions").update(t).eq("id",e);a&&console.warn("[GameSessionService] Error updating session:",a)}catch(a){console.warn("[GameSessionService] Failed to update session:",a)}}async pauseSession(e){return this.updateSession(e,{state:"paused",paused_at:new Date().toISOString()})}async resumeSession(e){return this.updateSession(e,{state:"playing",paused_at:null})}async completeSession(e,t,i,a,n){return this.updateSession(e,{state:"completed",final_score:t,accuracy:i,avg_response_time:a,max_combo:n,completed_at:new Date().toISOString()})}async abandonSession(e){return this.updateSession(e,{state:"abandoned",completed_at:new Date().toISOString()})}async recordAnswer(e,t,i,a,n,r,s){if(!_.isOnline)return;const l=h;if(l)try{const{error:c}=await l.from("game_session_answers").insert({session_id:e,question_id:t,question_index:i,selected_index:a,correct_index:n,is_correct:r,response_time_ms:s});c&&console.warn("[GameSessionService] Error recording answer:",c)}catch(c){console.warn("[GameSessionService] Failed to record answer:",c)}}async getSessionAnswers(e){if(!_.isOnline)return[];const t=h;if(!t)return[];try{const{data:i,error:a}=await t.from("game_session_answers").select("*").eq("session_id",e).order("question_index",{ascending:!0});return a?(console.warn("[GameSessionService] Error fetching session answers:",a),[]):i||[]}catch(i){return console.warn("[GameSessionService] Failed to get session answers:",i),[]}}async getHistory(e=20){if(!_.isOnline)return[];const t=h;if(!t)return[];try{const{data:{user:i}}=await t.auth.getUser();if(!i)return[];const{data:a,error:n}=await t.from("game_sessions").select("*").eq("user_id",i.id).eq("state","completed").order("completed_at",{ascending:!1}).limit(e);return n?(console.warn("[GameSessionService] Error fetching session history:",n),[]):a||[]}catch(i){return console.warn("[GameSessionService] Failed to get session history:",i),[]}}}class ${static _instance=null;STORAGE_KEY="ETHIO_ACTIVE_SESSION_V3";static getInstance(){return $._instance||($._instance=new $),$._instance}createSession(e,t,i){const a={sessionId:"SESS-"+Math.floor(1e5+Math.random()*9e5),matchType:e,startTime:Date.now(),totalQuestions:i.length,difficulty:t,currentScore:0,currentIndex:0,timeLeftSec:15,questions:i,choices:[],responseTimes:[],state:"Playing",correctCount:0,wrongCount:0,timeOutCount:0},n=i.map(r=>String(r.id));return R.getInstance().createSession(e,e,t,n).then(r=>{r&&r.id&&(a.cloudSessionId=r.id,this.saveSession(a))}),this.saveSession(a),a}getActiveSession(){const e=localStorage.getItem(this.STORAGE_KEY);if(!e)return null;try{const t=JSON.parse(e);return t.state==="Completed"||t.state==="Abandoned"||t.state==="Expired"?null:Date.now()-t.startTime>144e5?(this.clearSession(),null):t}catch{return null}}saveSession(e){localStorage.setItem(this.STORAGE_KEY,JSON.stringify(e))}clearSession(){localStorage.removeItem(this.STORAGE_KEY)}autoSaveProgress(e,t,i,a,n,r,s){if(e.currentIndex=t,e.choices.push(i),e.responseTimes.push(a),e.currentScore=r,e.timeLeftSec=s,i===-1?e.timeOutCount++:n?e.correctCount++:e.wrongCount++,e.cloudSessionId){const l=String(e.questions[t].id),c=e.questions[t].correctIndex??-1;R.getInstance().recordAnswer(e.cloudSessionId,l,t,i,c,n,a)}this.saveSession(e)}abandonSession(e){e.state="Abandoned",this.saveSession(e),this.addToHistory(e),e.cloudSessionId&&R.getInstance().abandonSession(e.cloudSessionId),this.clearSession()}completeSession(e,t){if(e.state="Completed",e.currentScore=t,this.saveSession(e),this.addToHistory(e),e.cloudSessionId){const i=e.totalQuestions>0?Math.round(e.correctCount/e.totalQuestions*100):0,a=e.responseTimes.length>0?e.responseTimes.reduce((n,r)=>n+r,0)/e.responseTimes.length:0;R.getInstance().completeSession(e.cloudSessionId,t,i,a,0)}this.clearSession()}addToHistory(e){}}class Oe{static _canvas=null;static _ctx=null;static _particles=[];static _animId=null;static burst(e,t,i=60,a=["#FFD700","#22C55E","#3B82F6","#FFFFFF","#FF4500"]){this._init();const n=e??window.innerWidth/2,r=t??window.innerHeight/3;for(let s=0;s<i;s++){const l=Math.random()*Math.PI*2,c=Math.random()*12+4;this._particles.push({x:n,y:r,vx:Math.cos(l)*c,vy:Math.sin(l)*c-3,size:Math.random()*8+4,color:a[Math.floor(Math.random()*a.length)],alpha:1,rotation:Math.random()*360,rotSpeed:(Math.random()-.5)*15,shape:Math.random()>.4?"rect":"circle"})}this._animId||this._loop()}static _init(){this._canvas||(this._canvas=document.createElement("canvas"),this._canvas.id="confetti-canvas",this._canvas.style.position="fixed",this._canvas.style.top="0",this._canvas.style.left="0",this._canvas.style.width="100vw",this._canvas.style.height="100vh",this._canvas.style.pointerEvents="none",this._canvas.style.zIndex="9999",document.body.appendChild(this._canvas)),this._canvas.width=window.innerWidth,this._canvas.height=window.innerHeight,this._ctx=this._canvas.getContext("2d")}static _loop(){if(!(!this._ctx||!this._canvas)){this._ctx.clearRect(0,0,this._canvas.width,this._canvas.height);for(let e=this._particles.length-1;e>=0;e--){const t=this._particles[e];if(t.x+=t.vx,t.y+=t.vy,t.vy+=.25,t.vx*=.98,t.rotation+=t.rotSpeed,t.alpha-=.015,t.alpha<=0||t.y>window.innerHeight){this._particles.splice(e,1);continue}this._ctx.save(),this._ctx.globalAlpha=t.alpha,this._ctx.translate(t.x,t.y),this._ctx.rotate(t.rotation*Math.PI/180),this._ctx.fillStyle=t.color,t.shape==="rect"?this._ctx.fillRect(-t.size/2,-t.size/2,t.size,t.size*1.5):(this._ctx.beginPath(),this._ctx.arc(0,0,t.size/2,0,Math.PI*2),this._ctx.fill()),this._ctx.restore()}this._particles.length>0?this._animId=requestAnimationFrame(()=>this._loop()):this._animId=null}}}class he{static animate(e,t,i,a=1200,n=r=>Math.round(r).toLocaleString()){const r=performance.now(),s=l=>{const c=l-r,d=Math.min(c/a,1),g=1-Math.pow(1-d,3),m=t+(i-t)*g;e.textContent=n(m),d<1?requestAnimationFrame(s):e.textContent=n(i)};requestAnimationFrame(s)}}class Xe{static render(e){return`
        ...
        `,this._bindEvents();const s=document.getElementById("final-score-rolling");s&&(this._hasAnimated||he.animate(s,0,this._finalScore,800));const l=Math.max(0,this._saveManager.profile.xp-a),c=this._saveManager.profile.xp,d=C.getLevel(l),g=C.getLevel(c),m=document.getElementById("xp-gained-rolling");m&&(this._hasAnimated||he.animate(m,0,a,800)),this._hasAnimated=!0;const b=document.getElementById("level-display-left"),y=document.getElementById("level-display-right"),f=document.getElementById("xp-progress-fill");b&&(b.innerText=`Lvl ${d.level}`),y&&(y.innerText=`Lvl ${d.level+1}`),f&&(f.style.width=`${d.progressPercent}%`,setTimeout(()=>{g.level>d.level?(f.style.width="100%",setTimeout(()=>{f.style.transition="none",f.style.width="0%",b&&(b.innerText=`Lvl ${g.level}`),y&&(y.innerText=`Lvl ${g.level+1}`),setTimeout(()=>{f.style.transition="width 1s cubic-bezier(0.34, 1.56, 0.64, 1)",f.style.width=`${g.progressPercent}%`},50),this._audioManager.playVictoryFanfare(),Oe.burst(window.innerWidth/2,window.innerHeight/2,100);const u=document.getElementById("level-up-toast");u&&(u.style.display="block")},1500)):f.style.width=`${g.progressPercent}%`},500))}_bindEvents(){const e=window;document.getElementById("btn-home")?.addEventListener("click",()=>{this._audioManager.playClick(),e.ethioForceHome?e.ethioForceHome():(e.ethioCloseGame&&e.ethioCloseGame(),e.ethioReloadHome&&e.ethioReloadHome())}),document.getElementById("btn-play-again")?.addEventListener("click",()=>{this._audioManager.playClick(),e.ethioCloseGame&&e.ethioCloseGame(),e.ethioPlayAgain?e.ethioPlayAgain(this._gameId):this._onContinue()}),document.getElementById("btn-leaderboard")?.addEventListener("click",()=>{this._audioManager.playClick(),e.ethioCloseGame&&e.ethioCloseGame(),e.ethioNavigateToTab?e.ethioNavigateToTab("rankings"):this._onContinue()});const t=document.getElementById("review-modal"),i=document.getElementById("review-questions-container");document.getElementById("btn-review-game")?.addEventListener("click",()=>{this._audioManager.playClick(),t&&i&&(this._renderReviewQuestions(i),t.style.display="flex")}),document.getElementById("btn-close-review")?.addEventListener("click",()=>{this._audioManager.playClick(),t&&(t.style.display="none")})}_renderReviewQuestions(e){const t=window.ethioReviewData||{questions:[],choices:[]},i=t.questions||[],a=t.choices||[];if(i.length===0){e.innerHTML=`
            ...
            `;return}e.innerHTML=i.map((r,s)=>{const l=a[s]!==void 0?a[s]:-1,c=l===r.correctIndex;let d="",g="";l===-1?(g="#F97316",d=`<span style="font-size: var(--fds-font-xs); font-weight: 900; color: ${g}; background: rgba(249,115,22,0.15); padding: 2px 8px; border-radius: 4px;">
                    ...
                    ${o.currentLocale==="am"?"✗ የተሳሳተ":o.currentLocale==="om"?"✗ Dogoggora":"✗ Wrong"}
                </span>`);const m=r.options.map((u,v)=>{const x=v===r.correctIndex,k=v===l;let A="rgba(0,0,0,0.3)",S="rgba(255,255,255,0.06)",L="",z="";x&&k?(A="rgba(34,197,94,0.15)",S="#22C55E",L='<span style="color: #22C55E; font-weight: bold; margin-right: 8px;">✓</span>',z='<div style="background: rgba(34,197,94,0.2); color: #4ADE80; font-size: 9px; padding: 2px 6px; border-radius: 4px; font-weight: bold; text-transform: uppercase;">Your Answer</div>'):x?(A="rgba(34,197,94,0.15)",S="#22C55E",L='<span style="color: #22C55E; font-weight: bold; margin-right: 8px;">✓</span>',z='<div style="background: rgba(34,197,94,0.2); color: #4ADE80; font-size: 9px; padding: 2px 6px; border-radius: 4px; font-weight: bold; text-transform: uppercase;">Correct Answer</div>'):k&&(A="rgba(239,68,68,0.15)",S="#EF4444",L='<span style="color: #EF4444; font-weight: bold; margin-right: 8px;">✗</span>',z='<div style="background: rgba(239,68,68,0.2); color: #F87171; font-size: 9px; padding: 2px 6px; border-radius: 4px; font-weight: bold; text-transform: uppercase;">Your Answer</div>');const W=String.fromCharCode(65+v)+".";return`
                ...
                `}).join("");let b="";r.explanation&&(b=`
                    <div style="background: rgba(15,23,42,0.6); border: 1px solid rgba(56,189,248,0.3); border-radius: 8px; padding: 12px; margin-bottom: 12px;">
                        ...
                        <div style="font-size: var(--fds-font-xs); color: var(--fds-text-main); line-height: 1.4;">${r.explanation}</div>
                    </div>
                `);let y="";r.fact&&(y=`
                    <div style="background: rgba(15,23,42,0.6); border: 1px solid rgba(192,132,252,0.3); border-radius: 8px; padding: 12px; margin-bottom: 12px;">
                        ...
                        <div style="font-size: var(--fds-font-xs); color: var(--fds-text-main); line-height: 1.4;">${r.fact}</div>
                    </div>
                `);let f="";return r.learningTip&&(f=`
                    <div style="background: rgba(15,23,42,0.6); border: 1px solid rgba(250,204,21,0.3); border-radius: 8px; padding: 12px; margin-bottom: 12px;">
                        ...
                        <div style="font-size: var(--fds-font-xs); color: var(--fds-text-main); line-height: 1.4;">${r.learningTip}</div>
                    </div>
                `),`
                <div class="glass-card" style="border-radius: 12px; padding: 16px; margin-bottom: 16px; border-color: ${g}; text-align: left;">
                    ...
                    <div style="font-size: var(--fds-font-md); font-weight: 800; color: var(--fds-text-main); margin-bottom: 12px; line-height: 1.4;">${r.prompt}</div>
            ...
            `}).join(""),e.querySelectorAll(".glass-card").forEach((r,s)=>{const l=r.querySelector(".btn-review-like");l?.addEventListener("click",()=>{this._audioManager.playClick();const f=l.querySelector(".like-label"),u=l.querySelector(".heart-icon");l.classList.contains("liked")?(l.classList.remove("liked"),l.style.color="#94A3B8",f.innerText=o.currentLocale==="am"?"ውደድ":o.currentLocale==="om"?"Jaalladhu":"Like"):(l.classList.add("liked"),l.style.color="#EF4444",f.innerText=o.currentLocale==="am"?"ተወዷል":o.currentLocale==="om"?"Jaallatameera":"Liked",u&&(u.style.transform="scale(1.3)",setTimeout(()=>u.style.transform="scale(1)",200)))});const c=r.querySelector(".btn-review-comment"),d=r.querySelector(`#comment-drawer-${s}`),g=r.querySelector(`#comment-input-${s}`),m=r.querySelector(".btn-send-comment"),b=r.querySelector(`#comment-list-${s}`);c?.addEventListener("click",()=>{this._audioManager.playClick(),d&&(d.style.display=d.style.display==="none"?"block":"none",d.style.display==="block"&&g?.focus())}),m?.addEventListener("click",()=>{this._audioManager.playClick();const f=g?.value.trim();if(!f){U.show(o.currentLocale==="am"?"አስተያየት ባዶ ሊሆን አይችልም።":o.currentLocale==="om"?"Yaadni duwwaa ta'uu hin danda'u.":"Comment cannot be empty.","info");return}const u=document.createElement("div");u.style.cssText="background: rgba(0,0,0,0.2); padding: 6px 10px; border-radius: 6px;";const v=o.currentLocale==="am"?"እርስዎ:":o.currentLocale==="om"?"Isin:":"You:",x=o.currentLocale==="am"?"አሁን":o.currentLocale==="om"?"Amma":"Just now";u.innerHTML=`<strong style="color: #4ADE80;">${v}</strong> ${f} <span style="font-size: var(--fds-font-xs); color: var(--fds-text-dim); float: right;">${x}</span>`,b.appendChild(u),g.value="",b.scrollTop=b.scrollHeight,U.show(o.currentLocale==="am"?"አስተያየት ተለጥፏል!":o.currentLocale==="om"?"Yaadni maxxanfameera!":"Comment posted!","success")}),r.querySelector(".btn-review-share")?.addEventListener("click",async()=>{this._audioManager.playClick();const f=o.currentLocale==="am"?`⚽ በኢትዮ ቴሌኮም የእግር ኳስ ውድድር ላይ እየተወዳደርኩ ነው!
...
world-cup,1,Which country hosted 2022 World Cup?,Qatar,Brazil,Russia,South Africa,0" style="font-family: monospace; font-size: var(--fds-font-xs); margin-bottom: 16px;"></textarea>
        ...
        `}_bindEvents(){const e=this._uiManager.container;w.bind(e,()=>{this._audioManager.playClick(),this._onClose()}),e.querySelectorAll(".tab-btn").forEach(t=>{t.addEventListener("click",i=>{this._audioManager.playClick();const a=i.currentTarget.getAttribute("data-tab");a&&(this._activeTab=a,this._statusMessage="",this.render())})}),e.querySelector("#add-question-btn")?.addEventListener("click",async()=>{this._audioManager.playClick();const t=e.querySelector("#q-category")?.value,i=parseInt(e.querySelector("#q-difficulty")?.value||"2",10),a=parseInt(e.querySelector("#q-correct")?.value||"0",10),n=e.querySelector("#q-prompt-en")?.value.trim(),r=e.querySelector("#q-prompt-am")?.value.trim(),s=e.querySelector("#q-prompt-om")?.value.trim(),l=e.querySelector("#q-opt0-en")?.value.trim(),c=e.querySelector("#q-opt1-en")?.value.trim(),d=e.querySelector("#q-opt2-en")?.value.trim(),g=e.querySelector("#q-opt3-en")?.value.trim(),m=e.querySelector("#q-opt0-am")?.value.trim(),b=e.querySelector("#q-opt1-am")?.value.trim(),y=e.querySelector("#q-opt2-am")?.value.trim(),f=e.querySelector("#q-opt3-am")?.value.trim(),u=e.querySelector("#q-opt0-om")?.value.trim(),v=e.querySelector("#q-opt1-om")?.value.trim(),x=e.querySelector("#q-opt2-om")?.value.trim(),k=e.querySelector("#q-opt3-om")?.value.trim();if(!n||!l||!c||!d||!g){this._statusMessage="❌ Please fill in the English prompt and all 4 English options.",this.render();return}const A={category:t,difficulty:i,competition_id:t,prompt_en:n,prompt_am:r||null,prompt_om:s||null,options_en:[l,c,d,g],options_am:m&&b&&y&&f?[m,b,y,f]:null,options_om:u&&v&&x&&k?[u,v,x,k]:null,correct_index:a,is_active:!0};if(h){const{error:S}=await h.from("questions").insert(A);S?this._statusMessage=`❌ Cloud Insert Failed: ${S.message}`:this._statusMessage="✅ Question published to Cloud database successfully!"}else this._statusMessage="✅ Question added locally (Supabase offline).";this.render()}),e.querySelector("#import-csv-btn")?.addEventListener("click",async()=>{this._audioManager.playClick();const t=e.querySelector("#bulk-csv-area")?.value.trim();if(!t){this._statusMessage="❌ Please paste CSV content to import.",this.render();return}const i=t.split(`
`).map(r=>r.trim()).filter(r=>r.length>0);if(i.length<2){this._statusMessage="❌ CSV must contain a header row and at least 1 data row.",this.render();return}let a=0;const n=i.slice(1);for(const r of n){const s=r.split(",").map(l=>l.trim());if(s.length>=8){const[l,c,d,g,m,b,y,f]=s,u={category:l||"football-history",difficulty:parseInt(c||"1",10),competition_id:l||"football-history",prompt_en:d,options_en:[g,m,b,y],correct_index:parseInt(f||"0",10),is_active:!0};h&&await h.from("questions").insert(u),a++}}this._statusMessage=`✅ Successfully processed & imported ${a} questions!`,this.render()}),e.querySelector("#admin-add-comp-btn")?.addEventListener("click",()=>{const t=e.querySelector("#admin-comp-name"),i=e.querySelector("#admin-comp-badge"),a=e.querySelector("#admin-comp-desc");if(t&&t.value.trim()!==""){const n=t.value.toLowerCase().replace(/\s+/g,"-");I.addCompetition({id:n,name:t.value.trim(),nameEn:t.value.trim(),badge:i.value.trim()||"⚽",description:a.value.trim()||"Custom Competition",color:"#1e3a8a",questionCount:10}),this._audioManager.playClick(),this._statusMessage=`✅ Competition '${t.value.trim()}' Published Successfully!`,this.render()}})}}class D{static _instance=null;static getInstance(){return D._instance||(D._instance=new D),D._instance}async getLeaderboard(e,t="all_time",i=50){if(_.isOnline&&h)try{if(t==="daily"){const a=new Date().toISOString().split("T")[0],{data:n,error:r}=await h.rpc("get_daily_leaderboard",{p_date:a});if(!r&&n&&Array.isArray(n))return n.map((l,c)=>({rank:c+1,userId:l.user_id,username:l.username||"Anonymous Player",avatarUrl:l.avatar_url,eloRating:1200,score:l.score||0,matchesPlayed:1,wins:1}))}else{const{data:a,error:n}=await h.rpc("get_leaderboard",{p_competition_id:e||null,p_time_range:t,p_limit:i});if(!n&&a&&Array.isArray(a))return a.map(r=>({rank:r.rank,userId:r.user_id,username:r.username||"Anonymous Player",avatarUrl:r.avatar_url,eloRating:r.elo_rating||1200,score:r.score||0,matchesPlayed:r.matches_played||0,wins:r.wins||0}))}}catch(a){console.warn("[LeaderboardService] RPC query failed, returning empty list:",a)}return[]}async getUserRank(e,t){if(!e)return null;try{const a=(await this.getLeaderboard(t)).find(n=>n.userId===e);if(a)return a.rank}catch(i){console.warn("[LeaderboardService] Failed to get user rank:",i)}return null}async getMyDailyStats(){if(!h||!_.isOnline)return null;try{const{data:{user:e}}=await h.auth.getUser();if(!e)return null;const t=new Date().toISOString().split("T")[0],{data:i,error:a}=await h.rpc("get_daily_leaderboard",{p_date:t});if(a||!i||!Array.isArray(i))return null;const n=i.findIndex(r=>r.user_id===e.id);return n===-1?null:{rank:String(n+1),score:String(i[n].score||0)}}catch(e){return console.warn("[LeaderboardService] getMyDailyStats failed:",e),null}}}class Q{static _instance=null;static getInstance(){return Q._instance||(Q._instance=new Q),Q._instance}async getTodayChallenge(){if(_.isOnline&&h)try{const{data:t,error:i}=await h.rpc("get_daily_challenge");if(!i&&t){const a=t;if(a.available&&a.question_ids&&a.question_ids.length>0){const n=await H.getInstance().fetchQuestionsByIds(a.question_ids,o.currentLocale),r=a.completed||!1;return{id:a.id,themeEn:a.theme_en||"Daily Football Quiz Challenge",themeAm:a.theme_am||"የዕለቱ የእግር ኳስ ጥያቄ ተግዳሮት",themeOm:a.theme_om||"Qormaata Gaaffii Kubbaa Miilaa Guyyaa",bonusMultiplier:a.bonusMultiplier||1.5,completed:r,questions:n}}}}catch(t){console.warn("[DailyChallengeManager] Supabase fetch failed:",t)}return{themeEn:"Daily Champions Challenge",themeAm:"የዕለቱ የሻምፒዮኖች ተግዳሮት",themeOm:"Qormaata Chaampiyoonii Guyyaa",bonusMultiplier:1.5,completed:!1,questions:await H.getInstance().fetchQuestions("world-cup",10,o.currentLocale)}}}class it{static checkAndShow(e){const t="ETHIO_FOOTBALL_LAST_LOGIN",i=new Date().toISOString().split("T")[0];if(localStorage.getItem(t)===i)return;localStorage.setItem(t,i);const r=(e.profile.streakCount||0)+1;e.updateStreak(r);const s=100+r*25;e.addXp(s)}}class G{static _instance=null;_memoryCache=new Map;_isQuizActive=!1;static getInstance(){return G._instance||(G._instance=new G),G._instance}constructor(){}setQuizActive(e){this._isQuizActive=e}get isQuizActive(){return this._isQuizActive}async getOrFetch(e,t,i={}){const a=i.ttlMs??3e5,n=this.get(e);if(n&&!i.forceRefresh&&!this.isStale(e)||this._isQuizActive&&n)return n;try{const r=await t();return this.set(e,r,a),r}catch(r){if(n)return n;throw r}}get(e){return this._memoryCache.has(e)?this._memoryCache.get(e).data:null}set(e,t,i=300*1e3){this._memoryCache.set(e,{data:t,timestamp:Date.now(),ttlMs:i})}isStale(e){const t=this._memoryCache.get(e);return t?Date.now()-t.timestamp>t.ttlMs:!0}invalidate(e){this._memoryCache.delete(e)}clear(){this._memoryCache.clear()}}class re{static attach(e,t){let i=0,a=0,n=!1;const r=document.createElement("div");r.className="pull-to-refresh-indicator",r.style.cssText=`
            position: absolute;
            top: -50px;
            left: 50%;
        ...
        `,e.style.position="relative",e.appendChild(r),e.addEventListener("touchstart",s=>{G.getInstance().isQuizActive||e.scrollTop<=0&&(i=s.touches[0].clientY,n=!0)},{passive:!0}),e.addEventListener("touchmove",s=>{if(!n||G.getInstance().isQuizActive)return;a=s.touches[0].clientY;const l=a-i;if(l>0&&e.scrollTop<=0){const c=Math.min(l*.45,75);r.style.top=`${c-42}px`,r.style.opacity=`${Math.min(c/50,1)}`;const d=r.querySelector("svg");d&&(d.style.transform=`rotate(${c*4}deg)`)}},{passive:!0}),e.addEventListener("touchend",async()=>{if(!n||G.getInstance().isQuizActive)return;if(n=!1,a-i>110&&e.scrollTop<=0){r.style.top="16px";const c=r.querySelector("svg");c&&(c.style.transition="transform 1s linear",c.style.transform="rotate(1080deg)");const d=e.scrollTop;try{await t(),e.scrollTop=d}catch(g){console.error("[PullToRefresh] Refresh failed:",g)}}r.style.pointerEvents="none",r.style.top="-50px",r.style.opacity="0";const l=r.querySelector("svg");l&&(l.style.transition="none",l.style.transform="rotate(0deg)"),i=0,a=0})}}class at{_saveManager;_audioManager;_uiManager;_callbacks;_timerInterval=null;_autoScrollInterval=null;_resetHandler=null;constructor(e,t,i,a){this._saveManager=e,this._audioManager=t,this._uiManager=i,this._callbacks=a}render(){const e=this._uiManager.container,t=this._saveManager.profile,i=t.totalMatches||0,a=i>0?Math.round((t.totalWins||0)/i*100):0,n=t.streakCount||0,r=$.getInstance().getActiveSession();let s="";r&&r.matchType==="daily"&&(s+=`
                <div class="glass-card fade-in-up" style="padding: clamp(12px, 2vh, 16px); border-color: rgba(34,197,94,0.3); border-radius: 16px; display: flex; align-items: center; justify-content: space-between;">
                    <div>
                        ...
                        <div style="font-size: var(--fds-font-xs); color: var(--fds-text-dim); margin-top: 4px;">Round ${r.currentIndex+1} of ${r.totalQuestions}</div>
                    </div>
        ...
        `,this._startCountdownTimer(),this._bindEvents(),this._fetchDynamicData();const l=e.querySelector(".stadium-container");l&&re.attach(l,async()=>{this._audioManager.playClick(),await new Promise(c=>setTimeout(c,600)),this.render()}),it.checkAndShow(this._saveManager),this._resetHandler||(this._resetHandler=()=>{this.render()},window.addEventListener("ethio:dailyReset",this._resetHandler))}async _fetchDynamicData(){try{const r=(await Q.getInstance().getTodayChallenge()).completed,s=document.getElementById("home-daily-action");s&&(r?(s.innerHTML=`
                    ...
                    <div style="display: flex; justify-content: space-between; align-items: center; background: ${l[g]}; padding: 12px 16px; border-radius: 12px; margin-bottom: 8px;">
                        <div style="display: flex; align-items: center; gap: 12px;">
                            <span style="font-size: 18px; filter: drop-shadow(0 2px 4px rgba(0,0,0,0.3));">${s[g]}</span>
        ...
        `,this._bindEvents()}_bindEvents(){const e=this._uiManager.container;this._bannerInterval&&(clearInterval(this._bannerInterval),this._bannerInterval=null),this._showSettings||(this._bannerInterval=setInterval(()=>{const l=e.querySelector("#auth-banner-bg"),c=e.querySelector("#auth-banner-fg");l&&c&&(c.style.opacity="1",setTimeout(()=>{if(!l||!c)return;l.src=c.src,c.style.transition="none",c.style.opacity="0",this._currentBanner=this._currentBanner>=10?1:this._currentBanner+1;const d=this._currentBanner>=10?1:this._currentBanner+1;c.src=`/assets/banners/${d}.png`,c.offsetWidth,c.style.transition="opacity 0.8s ease-in-out"},800))},4e3)),e.querySelector("#phone-input")?.addEventListener("input",l=>{const c=l.target;c.value=c.value.replace(/[^0-9+]/g,""),c.value.indexOf("+")>0&&(c.value=c.value.replace(/\+/g,""))}),e.querySelector("#otp-input")?.addEventListener("input",l=>{const c=l.target,d=e.querySelector("#verify-otp-btn");d&&(c.value.trim().length===6?(d.disabled=!1,d.style.opacity="1",d.style.cursor="pointer"):(d.disabled=!0,d.style.opacity="0.5",d.style.cursor="not-allowed"))});const t=e.querySelector("#send-otp-btn");t&&t.addEventListener("click",async()=>{this._audioManager.playClick();const c=e.querySelector("#phone-input")?.value.trim()||"";if(!c){this._statusMessage=o.currentLocale==="am"?"እባክዎን ትክክለኛ የስልክ ቁጥር ያስገቡ።":o.currentLocale==="om"?"Maaloo lakkoofsa bilbilaa sirrii ta'e galchaa.":"Please enter a valid phone number.",this.render();return}const d=B.normalisePhone(c);this._pendingPhone=d,this._devOtpCode="",this._statusMessage=o.currentLocale==="am"?"የኦቲፒ መልዕክት በመላክ ላይ...":o.currentLocale==="om"?"OTP SMS ergaa jira...":"Sending OTP...",this.render();const g=await this._authManager.signInWithPhone(d);g.success?(this._phoneStep="INPUT_OTP",this._statusMessage="",this._fetchDevOtp(d)):this._statusMessage=g.error||(o.currentLocale==="am"?"ኮድ መላክ አልተቻለም።":o.currentLocale==="om"?"OTP erguun hin danda'amne.":"Failed to send OTP."),this.render()});const i=e.querySelector("#verify-otp-btn");i&&i.addEventListener("click",async()=>{this._audioManager.playClick();const c=e.querySelector("#otp-input")?.value.trim()||"";if(c.length!==6){this._statusMessage=o.currentLocale==="am"?"እባክዎን የ 6-አሃዝ ማረጋገጫ ኮድ ያስገቡ።":o.currentLocale==="om"?"Maaloo koodii mirkaneessaa dijiitii 6 galchaa.":"Please enter a 6-digit verification code.",this.render();return}this._statusMessage=o.currentLocale==="am"?"ኮድ በመፈተሽ ላይ...":o.currentLocale==="om"?"Koodii mirkaneessaa jira...":"Verifying code...",this.render();const d=await this._authManager.verifyOtp(this._pendingPhone,c);d.success?this._onSuccess():(this._statusMessage=d.error||(o.currentLocale==="am"?"የተሳሳተ የማረጋገጫ ኮድ።":o.currentLocale==="om"?"Koodii mirkaneessaa dogoggoraa.":"Invalid verification code."),this.render())});const a=e.querySelector("#change-phone-btn");a&&a.addEventListener("click",()=>{this._audioManager.playClick(),this._phoneStep="INPUT_PHONE",this._statusMessage="",this._devOtpCode="",this.render()});const n=e.querySelector("#auth-settings-btn");n&&n.addEventListener("click",()=>{this._audioManager.playClick(),this._showSettings=!0,this._settingsTab="main",this.render()});const r=e.querySelector("#auth-settings-back");r&&r.addEventListener("click",()=>{this._audioManager.playClick(),this._settingsTab!=="main"?this._settingsTab="main":this._showSettings=!1,this.render()}),e.querySelectorAll(".settings-tile[data-tab]").forEach(l=>{l.addEventListener("click",c=>{this._audioManager.playClick(),this._settingsTab=c.currentTarget.getAttribute("data-tab"),this.render()})}),e.querySelector(".sound-toggle")?.addEventListener("click",()=>{this._audioManager.toggleMute(),this._audioManager.playClick();const l=this._audioManager.isMuted;localStorage.setItem("ETHIO_FOOTBALL_MUTED",String(l));const c=localStorage.getItem("ETHIO_FOOTBALL_SETTINGS_V2");if(c)try{const d=JSON.parse(c);d.soundEffects=!l,localStorage.setItem("ETHIO_FOOTBALL_SETTINGS_V2",JSON.stringify(d))}catch{}this.render()}),e.querySelectorAll(".lang-item").forEach(l=>{l.addEventListener("click",c=>{const d=c.currentTarget.getAttribute("data-lang");o.setLocale(d),this._audioManager.playClick(),this._settingsTab="main",this.render()})}),e.querySelectorAll(".faq-item").forEach(l=>{l.addEventListener("click",c=>{const d=parseInt(c.currentTarget.getAttribute("data-idx")||"-1",10);this._faqExpandedIndex=this._faqExpandedIndex===d?-1:d,this._audioManager.playClick(),this.render()})});const s=e.querySelector("#auth-subscribe-btn");s&&s.addEventListener("click",()=>{this._audioManager.playClick(),window.location.href="sms:9401?body=OK"})}async _fetchDevOtp(e){if(h)for(let t=0;t<8;t++){await new Promise(i=>setTimeout(i,800));try{const{data:i}=await h.from("dev_otps").select("code").eq("phone",e).maybeSingle();if(i?.code){this._devOtpCode=String(i.code),this.render();const a=this._uiManager.container.querySelector("#otp-input");a&&(a.value=this._devOtpCode,a.dispatchEvent(new Event("input",{bubbles:!0})));return}}catch{return}}}}class ee{static instance;channels=new Map;listeners=new Map;constructor(){}static getInstance(){return ee.instance||(ee.instance=new ee),ee.instance}initUserChannels(e){if(!_.isOnline){console.warn("[RealtimeService] Offline mode: Cannot initialize channels.");return}const t=h;if(!t)return;this.cleanup();const i=t.channel(`profile-${e}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"users",filter:`id=eq.${e}`},c=>this.emit("profile_update",c)).subscribe();this.channels.set(`profile-${e}`,i);const a=t.channel(`notifications-${e}`).on("postgres_changes",{event:"INSERT",schema:"public",table:"notifications"},c=>{const d=c.new;(d.user_id===e||d.user_id===null)&&this.emit("new_notification",c)}).subscribe();this.channels.set(`notifications-${e}`,a);const n=t.channel(`messages-${e}`).on("postgres_changes",{event:"INSERT",schema:"public",table:"messages"},c=>{const d=c.new;(d.recipient_id===e||d.channel==="global")&&this.emit("new_message",c)}).subscribe();this.channels.set(`messages-${e}`,n);const r=t.channel(`rewards-${e}`).on("postgres_changes",{event:"INSERT",schema:"public",table:"rewards",filter:`user_id=eq.${e}`},c=>this.emit("new_reward",c)).subscribe();this.channels.set(`rewards-${e}`,r);const s=t.channel(`session-${e}`).on("postgres_changes",{event:"UPDATE",schema:"public",table:"game_sessions",filter:`user_id=eq.${e}`},c=>this.emit("session_update",c)).subscribe();this.channels.set(`session-${e}`,s);const l=t.channel("leaderboard").on("postgres_changes",{event:"UPDATE",schema:"public",table:"leaderboard_entries"},c=>this.emit("leaderboard_update",c)).subscribe();this.channels.set("leaderboard",l),console.log(`[RealtimeService] Channels initialized for user ${e}`)}on(e,t){this.listeners.has(e)||this.listeners.set(e,new Set),this.listeners.get(e).add(t)}off(e,t){if(t){const i=this.listeners.get(e);i&&(i.delete(t),i.size===0&&this.listeners.delete(e))}else this.listeners.delete(e)}emit(e,t){const i=this.listeners.get(e);i&&i.forEach(a=>{try{a(t)}catch(n){console.error(`[RealtimeService] Error executing listener for event ${e}:`,n)}})}cleanup(){const e=h;this.channels.forEach(t=>{e&&e.removeChannel(t)}),this.channels.clear(),this.listeners.clear(),console.log("[RealtimeService] Cleaned up all channels and listeners.")}}class st{_uiManager;_audioManager;_saveManager;_onClose;_activeTab="daily";_previousRank=null;constructor(e,t,i,a){this._uiManager=e,this._saveManager=t,this._audioManager=i,this._onClose=a}async render(){const e=this._uiManager.container;e.innerHTML=E.LoadingState(o.currentLocale==="am"?"ደረጃዎችን በማስገባት ላይ...":o.currentLocale==="om"?"Sadarkaa fe'aa jira...":"Loading rankings...");const t=this._saveManager.profile,i=C.getDivision(t.xp);let a=[];this._activeTab==="daily"?a=await D.getInstance().getLeaderboard(void 0,"daily"):a=(await(await de(async()=>{const{TournamentService:u}=await import("./TournamentService-D5VeP020.js");return{TournamentService:u}},__vite__mapDeps([0,1]))).TournamentService.getInstance().getLeaderboard(this._activeTab)).map(u=>({userId:u.userId,username:u.username,score:u.score,matchesPlayed:u.matchesPlayed}));const n=a.map(y=>{const f=y.username===t.username,v=/^\\+?[0-9]{9,}$/.test((y.username||"").replace(/[^0-9+]/g,""))?this._maskPhone(y.username):y.username||(o.currentLocale==="am"?"ያልታወቀ":o.currentLocale==="om"?"Namummaa Hin Beekamne":"Anonymous"),x=y.score||0,k=y.eloRating||0,A=C.getDivision(x);return{msisdn:v,score:x,eloRating:k,points:x,league:A.name,isMe:f}});n.sort((y,f)=>f.score-y.score);const r=n[0],s=n[1],l=n[2],c=n.slice(3),d=y=>{const f=this._activeTab===y;return`
                ...
                text-transform: uppercase;
                letter-spacing: 0.5px;
            `},g=n.findIndex(y=>y.isMe),m=g!==-1?g+1:"--";let b="";if(this._previousRank!==null&&m!=="--"&&this._previousRank!=="--"){const y=this._previousRank-m;y>0?b=`<span class="rank-diff-anim rank-diff-up">▲ +${y} Positions</span>`:y<0&&(b=`<span class="rank-diff-anim rank-diff-down">▼ ${y} Positions</span>`)}this._previousRank=m,e.innerHTML=`
            <div class="stadium-container ethio-bg-main" style="pointer-events: auto; padding-bottom: 60px; overflow-y: auto;">
                ...
                <div style="max-width: 900px; margin: 0 auto; padding: 16px;">
                    ...
                    ${n.length===0?E.EmptyState("🏆",o.currentLocale==="am"?"እስካሁን የተሰለፈ ተጫዋች የለም።":o.currentLocale==="om"?"Hamma ammaatti taphataan sadarkaa qabate hin jiru.":"No players ranked yet."):`
                    ...
                    <div style="display: flex; flex-direction: column; gap: 8px;" class="fade-in-up">
                        ${c.map((y,f)=>{const u=f+4,v=y.isMe;return`
                                <div class="glass-card" style="
                                    display: flex; 
                                    justify-content: space-between; 
                                    align-items: center; 
                                    padding: 12px 16px; 
                                    background: ${v?"rgba(34,197,94,0.15)":"rgba(15,23,42,0.7)"}; 
                                    border: 1px solid ${v?"#22C55E":"rgba(255,255,255,0.08)"}; 
                                    border-radius: 12px;
                                ">
                                    <div style="display: flex; align-items: center; gap: 12px;">
                                        <span style="font-size: var(--fds-font-sm); font-weight: 900; color: var(--fds-text-dim); min-width: 24px;">#${u}</span>
                                        <div>
                                            <div style="font-size: var(--fds-font-sm); font-weight: 900; color: ${v?"#4ADE80":"white"};">
                                                ${y.msisdn} ${v?`<span style="background: #22C55E; color: black; font-size: 9px; padding: 2px 6px; border-radius: 4px; font-weight: 900; margin-left: 6px;">${o.currentLocale==="am"?"እርስዎ":o.currentLocale==="om"?"ATI":"YOU"}</span>`:""}
                                            </div>
        ...
        `,this._bindEvents()}_bindEvents(){const e=this._uiManager.container;w.bind(e,()=>{this._audioManager.playClick(),this._onClose()}),e.querySelectorAll(".lb-tab-btn").forEach(i=>{i.addEventListener("click",a=>{this._audioManager.playClick();const n=a.currentTarget.getAttribute("data-tab");this._activeTab=n,this.render()})});const t=e.querySelector(".stadium-container");t&&re.attach(t,async()=>{this._audioManager.playClick(),await this.render()})}_maskPhone(e){let t=e.replace(/[^0-9]/g,"");return e.startsWith("+")?t=e.substring(1):t=e,t.startsWith("251")&&(t="251"+t.replace(/^0+/,"")),t.substring(0,4)+"****"+t.substring(t.length-2)}}class q{static instance;listeners=[];unreadCount=0;constructor(){this._initRealtime(),this._fetchUnreadCount()}static getInstance(){return q.instance||(q.instance=new q),q.instance}subscribeToBadgeUpdates(e){return this.listeners.push(e),e(this.unreadCount),()=>{this.listeners=this.listeners.filter(t=>t!==e)}}_notifyListeners(){this.listeners.forEach(e=>e(this.unreadCount))}async _fetchUnreadCount(){if(!h)return;const{data:{user:e}}=await h.auth.getUser();if(!e)return;const{count:t,error:i}=await h.from("messages").select("*",{count:"exact",head:!0}).eq("read",!1).or(`recipient_id.eq.${e.id},channel.eq.global`);!i&&t!==null&&(this.unreadCount=t,this._notifyListeners())}_initRealtime(){h&&h.channel("public:messages").on("postgres_changes",{event:"*",schema:"public",table:"messages"},()=>{this._fetchUnreadCount()}).subscribe()}getTotalUnreadCount(){return this.unreadCount}_mapRow(e){const t=o.currentLocale;let i=e.body_en;t==="am"&&e.body_am&&(i=e.body_am),t==="om"&&e.body_om&&(i=e.body_om);let a="Message";return e.channel==="global"?a="Announcement":e.channel==="system"?a="System Update":e.channel==="direct"&&(a="Direct Message"),{id:e.id,title:a,content:i,category:e.channel,priority:e.channel==="global"?"High":"Normal",createdAt:e.created_at,read:e.read}}async _fetchByChannel(e){if(!h)return[];const{data:{user:t}}=await h.auth.getUser();let i=h.from("messages").select("*").eq("channel",e).order("created_at",{ascending:!1}).limit(50);if(e==="direct"||e==="system"){if(!t)return[];i=i.eq("recipient_id",t.id)}const{data:a,error:n}=await i;return n||!a?[]:a.map(r=>this._mapRow(r))}async getAllMessages(){if(!h)return[];const{data:{user:e}}=await h.auth.getUser();let t=h.from("messages").select("*").order("created_at",{ascending:!1}).limit(100);e?t=t.or(`recipient_id.eq.${e.id},channel.eq.global`):t=t.eq("channel","global");const{data:i,error:a}=await t;return a||!i?[]:i.map(n=>this._mapRow(n))}async getAnnouncements(){return this._fetchByChannel("global")}async getPersonalMessages(){return this._fetchByChannel("direct")}async getSupportTickets(){return this._fetchByChannel("system")}async markAsRead(e){if(!h)return;const{error:t}=await h.from("messages").update({read:!0}).eq("id",e);t||this._fetchUnreadCount()}}class M{static renderCard(e,t){return`
        ...
        `}static renderNavRow(e,t,i,a,n=!0,r,s=!1){return`
            <div class="ethio-nav-row profile-menu-tile" data-action="${i}" style="${s?"border-bottom: none;":""}">
                ...
                ${r?`<div id="${r}" class="ethio-nav-badge" style="display: none;"></div>`:""}
        ...
        `}}class lt{_uiManager;_saveManager;_audioManager;_callbacks;_unsubscribeBadge=null;constructor(e,t,i,a){this._uiManager=e,this._saveManager=t,this._audioManager=i,this._callbacks=a,this._unsubscribeBadge=q.getInstance().subscribeToBadgeUpdates(()=>{const n=document.getElementById("profile-msg-badge");if(n){const r=q.getInstance().getTotalUnreadCount();r>0?(n.innerText=r>99?"99+":r.toString(),n.style.display="inline-block"):n.style.display="none"}})}destroy(){this._unsubscribeBadge&&this._unsubscribeBadge()}render(){const e=this._uiManager.container;e.innerHTML=E.SkeletonProfile(),setTimeout(()=>{this._renderActual()},300)}_renderActual(){const e=this._uiManager.container,t=this._saveManager.profile,i=C.getDivision(t.xp);e.innerHTML=`
        ...
        `,this._bindEvents();const a=q.getInstance().getTotalUnreadCount(),n=document.getElementById("profile-msg-badge");n&&(a>0?(n.innerText=a>99?"99+":a.toString(),n.style.display="inline-block"):n.style.display="none"),D.getInstance().getMyDailyStats().then(r=>{const s=document.getElementById("profile-daily-rank");s&&(s.textContent=r?`#${r.rank}`:"Unranked")}).catch(()=>{const r=document.getElementById("profile-daily-rank");r&&(r.textContent="Unranked")})}_bindEvents(){const e=this._uiManager.container,t=document.getElementById("profile-action-modal"),i=document.getElementById("prof-modal-content"),a=document.getElementById("btn-close-prof-modal"),n=l=>{t&&i&&(i.innerHTML=l,t.style.display="flex")};a?.addEventListener("click",()=>{this._audioManager.playClick(),t&&(t.style.display="none")}),e.querySelectorAll(".profile-menu-tile").forEach(l=>{l.addEventListener("click",c=>{const g=c.currentTarget.getAttribute("data-action");if(g)switch(this._audioManager.playClick(),g){case"stats":this._callbacks.onStatistics();break;case"leaderboard":this._callbacks.onLeaderboard();break;case"subscription":this._callbacks.onSubscription();break;case"messages":this._callbacks.onMessages();break;case"settings":this._callbacks.onSettings();break;case"help":this._callbacks.onHelp();break;case"about":this._callbacks.onAbout();break;case"privacy":this._callbacks.onPrivacy();break;case"terms":this._callbacks.onTerms();break;case"invite":this._callbacks.onInvite();break;case"achievements":this._callbacks.onAchievements();break;case"awards":this._callbacks.onAwards();break;case"identity":this._callbacks.onIdentity();break;case"faq":this._callbacks.onFaq();break;case"logout":n(`
                        ...
                        `),document.getElementById("btn-cancel-logout")?.addEventListener("click",()=>{this._audioManager.playClick(),t&&(t.style.display="none")}),document.getElementById("btn-confirm-logout")?.addEventListener("click",async m=>{const b=m.currentTarget;if(b.style.opacity!=="0.5"){this._audioManager.playClick(),b.style.opacity="0.5",b.style.pointerEvents="none",b.innerHTML="Logging out...";try{await B.getInstance().signOut(),localStorage.removeItem("ETHIO_FOOTBALL_AUTH_V2"),localStorage.removeItem("ETHIO_FOOTBALL_SAVE_V1"),window.location.replace(window.location.origin+window.location.pathname)}catch(y){console.error("Logout error:",y),n(`
        ...
        `,w.bind(e,()=>{this._audioManager.playClick(),this._onBack()}),this._updateTabUI()}_updateTabUI(){const e=o.currentLocale,t=[{id:"all",label:{en:"All",am:"ሁሉም",om:"Hunda"}},{id:"unread",label:{en:"Unread",am:"ያልተነበቡ",om:"Kan Hin Dubbifamne"}},{id:"global",label:{en:"Announcements",am:"ማስታወቂያዎች",om:"Beeksisa"}},{id:"direct",label:{en:"Inbox",am:"የገቢ መልዕክቶች",om:"Ergaa"}},{id:"system",label:{en:"Support",am:"ድጋፍ",om:"Gargaarsa"}}],i=document.getElementById("mc-tab-bar");if(!i)return;i.innerHTML=t.map(n=>{const r=n.id===this._currentTab,s=n.id==="unread"||n.id==="direct"||n.id==="global"||n.id==="all"?q.getInstance().getTotalUnreadCount():0,l=(n.id==="unread"||n.id==="direct")&&s>0;return r?`
            ...
            `);try{const i=q.getInstance();this._messages=await i.getAllMessages()}catch(i){console.error("Failed to fetch messages",i),this._currentRequestId===e&&t&&(t.innerHTML=`
                ...
                `;return}e.innerHTML=a.map(r=>{const s=new Date(r.createdAt).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),c={global:"📢",direct:"📩",system:"⚙️"}[r.category]||"✉️";return`
                <div class="glass-card mc-item" data-id="${r.id}" style="
                    ...
                    position: relative;
                    transition: transform 0.2s, background-color 0.2s;
                    border: 1px solid ${r.read?"rgba(255,255,255,0.08)":"rgba(34, 197, 94, 0.4)"};
                    background: rgba(15, 23, 42, 0.7);
                    backdrop-filter: blur(12px);
                    -webkit-backdrop-filter: blur(12px);
                    box-shadow: ${r.read?"none":"0 4px 16px rgba(34, 197, 94, 0.1)"};
                    align-items: center;
                ">
                    <!-- Category Icon -->
                    <div style="
                        ...
                        height: 48px;
                        border-radius: 12px;
                        background: ${r.read?"rgba(255,255,255,0.05)":"rgba(34, 197, 94, 0.1)"};
                        border: 1px solid ${r.read?"rgba(255,255,255,0.1)":"rgba(34, 197, 94, 0.3)"};
                        display: flex;
                        align-items: center;
                        justify-content: center;
                        font-size: 24px;
            ...
            `}).join(""),e.querySelectorAll(".mc-item").forEach(r=>{r.addEventListener("click",async s=>{if(this._isOpeningMessage)return;const l=s.currentTarget.getAttribute("data-id");if(l){this._isOpeningMessage=!0,this._audioManager.playClick();try{const c=this._messages.find(d=>d.id===l);c&&!c.read&&(await q.getInstance().markAsRead(l),c.read=!0),this._showFullMessage(l)}finally{this._isOpeningMessage=!1}}})})}_showFullMessage(e){const t=this._messages.find(r=>r.id===e);if(!t)return;const i=new Date(t.createdAt).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),a=new Date(t.createdAt).toLocaleDateString(),n=document.createElement("div");n.style.cssText=`
        ...
        `,n='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,0.2)" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18l6-6-6-6"/></svg>',r=d=>`
            ...
            <div class="stadium-container ethio-bg-main" style="pointer-events: auto;">
                ...
                <div style="max-width: 600px; margin: 0 auto; padding: 24px 16px 120px 16px;">
                    ...
                    <div class="glass-card" style="margin-bottom: 24px; border-radius: 16px; padding: 0; overflow: hidden; border: 1px solid rgba(255,255,255,0.08); background: rgba(15, 23, 42, 0.6); backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px);">
                        ${a("👤",o.currentLocale==="am"?"የእኔ መገለጫ":o.currentLocale==="om"?"Profile Koo":"My Profile",i,n,"tile-profile")}
                        ${a("🌍",o.currentLocale==="am"?"ቋንቋ":o.currentLocale==="om"?"Afaan":"Language",s,n,"tile-language")}
                        ${a("🔔",o.currentLocale==="am"?"ማሳወቂያዎች":o.currentLocale==="om"?"Beeksisa":"Notifications","",r(l),"tile-notifications")}
                        <div style="border-bottom: none;">
                            ${a("🔊",o.currentLocale==="am"?"የድምፅ ውጤቶች":o.currentLocale==="om"?"Sagalee":"Sound Effects",this._settings.soundEffects?o.currentLocale==="am"?"የበራ":o.currentLocale==="om"?"Kan Baname":"Enabled":o.currentLocale==="am"?"የጠፋ":o.currentLocale==="om"?"Kan Cufame":"Muted",r(this._settings.soundEffects),"tile-sound")}
                        </div>
                    </div>
                    ...
                    <div class="glass-card" style="margin-bottom: 32px; border-radius: 16px; padding: 0; overflow: hidden; border: 1px solid rgba(255,255,255,0.08); background: rgba(15, 23, 42, 0.6); backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px);">
                        ${a("❓",o.currentLocale==="am"?"እገዛ እና ድጋፍ":o.currentLocale==="om"?"Gargaarsa & Deeggarsa":"Help & Support","",n,"tile-help")}
                        ${a("📜",o.currentLocale==="am"?"ውሎች እና ሁኔታዎች":o.currentLocale==="om"?"Waliigaltee & Haalawwan":"Terms & Conditions","",n,"tile-terms")}
                        ${a("🔒",o.currentLocale==="am"?"የግላዊነት ፖሊሲ":o.currentLocale==="om"?"Imaammata Dhuunfaa":"Privacy Policy","",n,"tile-privacy")}
                        <div style="border-bottom: none;">
                            ${a("ℹ️",o.currentLocale==="am"?"ስለ ኢትዮ ፋንታሲ":o.currentLocale==="om"?"Waa'ee Ethio Fantasy":"About EthioFantasy",`v${Be.version}`,n,"tile-about")}
                        </div>
                    </div>
        ...
        `,this._bindSubScreenBack(e),e.querySelectorAll(".lang-item").forEach(n=>{n.addEventListener("click",r=>{const l=r.currentTarget.getAttribute("data-lang");l&&(this._audioManager.playClick(),o.setLocale(l),T.refresh(),this.render())})})}_renderNotificationsScreen(e,t){const i=(n,r)=>{const s=this._settings.notifications[n];return`
        ...
        `,this._bindSubScreenBack(e),e.querySelectorAll(".sound-item").forEach(s=>{s.addEventListener("click",l=>{const d=l.currentTarget.getAttribute("data-val")==="true";this._settings.soundEffects=d,this._saveSettings(),this._audioManager.playClick(),this.render()})})}_renderHelpScreen(e,t){const i='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,0.2)" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18l6-6-6-6"/></svg>',a=[{id:"account",name:o.currentLocale==="am"?"መለያ":o.currentLocale==="om"?"Herrega":"Account",desc:"Account creation, recovery and security",icon:"👤"},{id:"subscription",name:o.currentLocale==="am"?"ምዝገባ":o.currentLocale==="om"?"Kaffaltii":"Subscription",desc:"Premium access and daily billing",icon:"💳"},{id:"unsubscription",name:o.currentLocale==="am"?"ምዝገባ መሰረዝ":o.currentLocale==="om"?"Haquu":"Unsubscription",desc:"How to opt out or cancel service",icon:"🛑"},{id:"dailyChallenge",name:o.currentLocale==="am"?"የዕለት ተግዳሮት":o.currentLocale==="om"?"Qormaata Guyyaa":"Daily Challenge",desc:"Rules and bonuses for daily plays",icon:"📅"},{id:"tournament",name:o.currentLocale==="am"?"ውድድር":o.currentLocale==="om"?"Dorgommii":"Tournament",desc:"Joining and competing in live events",icon:"🏆"},{id:"rewards",name:o.currentLocale==="am"?"ሽልማቶች":o.currentLocale==="om"?"Badhaasa":"Rewards",desc:"Claiming cash prizes and coins",icon:"🎁"},{id:"gameplay",name:o.currentLocale==="am"?"የጨዋታ ሁኔታ":o.currentLocale==="om"?"Tapha":"Gameplay",desc:"How to answer questions and score",icon:"⚽"},{id:"leaderboard",name:o.currentLocale==="am"?"ደረጃ ሰሌዳ":o.currentLocale==="om"?"Sadarkaa":"Leaderboard",desc:"ELO rating and division climbing",icon:"📊"},{id:"profile",name:o.currentLocale==="am"?"መገለጫ":(o.currentLocale==="om","Profile"),desc:"Managing your player identity",icon:"👤"},{id:"notifications",name:o.currentLocale==="am"?"ማሳወቂያዎች":o.currentLocale==="om"?"Beeksisa":"Notifications",desc:"SMS alerts and system updates",icon:"🔔"},{id:"technicalIssues",name:o.currentLocale==="am"?"ቴክኒካዊ ጉዳዮች":o.currentLocale==="om"?"Rakkina Sirnaa":"Technical Issues",desc:"Report bugs or connection problems",icon:"🔧"}],n={account:[{q:"How is my account created?",a:"Your account is automatically created when you authenticate with your Ethio Telecom mobile phone number. There is no password required."},{q:"Can I delete my account?",a:"To delete your account data, please contact Ethio Telecom customer service or submit a support ticket via the app."}],subscription:[{q:"What is Premium Subscription?",a:"Premium subscription gives you unlimited daily plays, full access to all leagues, and entry into the weekly cash prize draws for 2 Birr/day."},{q:"How do I pay for subscription?",a:"Subscription fees are automatically deducted from your Ethio Telecom airtime balance daily."}],unsubscription:[{q:"How do I unsubscribe?",a:'You can cancel your active subscription anytime by going to Settings > Account > Profile and choosing Unsubscribe, or by sending "STOP" to the Ethio Telecom shortcode 8282.'}],dailyChallenge:[{q:"What is the Daily Challenge?",a:"The Daily Challenge is a special daily set of 10 trivia questions on hot football topics. Completing it awards double reward coins and a 1.5x XP bonus!"},{q:"How many times can I play the Daily Challenge?",a:"You can play the Daily Challenge once per calendar day. It resets every night at midnight EAT."}],tournament:[{q:"How do tournaments work?",a:"Tournaments are knockout brackets held every weekend. Players register during the week and compete live in 1v1 match phases to progress."},{q:"What are the tournament entry requirements?",a:"Premium subscribers can enter tournaments for free. Basic and free players must pay a 100 coin registration fee."}],rewards:[{q:"What rewards can I win?",a:"You can win in-game coins, profile XP, custom football badges, and real cash prizes credited directly to your Ethio Telecom mobile account balance."},{q:"When are weekly prizes distributed?",a:"Weekly prizes are processed and sent every Monday at 10:00 AM EAT based on the final Sunday night division standings."}],gameplay:[{q:"How do I play a match?",a:"Read the question carefully and tap the correct option before the timer runs out. Fast answers score Goals, while incorrect ones are Saved by the goalkeeper!"},{q:"How does the match timer work?",a:"You have 30 seconds per question in Solo Matches, and 20 seconds in Live 1v1 Matches. Answering quicker increases your possession stat!"}],leaderboard:[{q:"How are leaderboard points calculated?",a:"Leaderboard standings are based on ELO ratings. You win ELO points by defeating opponents in Live 1v1 Matches and scoring high accuracy in Solo Matches."},{q:"How often does the leaderboard reset?",a:"Division leaderboards reset weekly on Sunday at midnight EAT, after which the top players are promoted and rewards are dispatched."}],profile:[{q:"Why can't I edit my username?",a:"To comply with Ethio Telecom VAS portal guidelines, player profiles are verified and tied securely to your MSISDN. Manually changing names is restricted."}],notifications:[{q:"What notifications will I receive?",a:"You will receive SMS alerts for tournament kick-offs, daily challenge reminders, and subscription renewals. You can toggle these settings anytime."}],technicalIssues:[{q:"The app is freezing. What should I do?",a:"Ensure you have a stable network connection (3G/4G/LTE/5G). Try refreshing the app page by swiping down, or clearing your mobile browser cache."}],privacy:[{q:"How is my data used?",a:"We collect your phone number and game statistics solely to manage your game state and calculate rankings. We never share your data with third parties."}],terms:[{q:"Are there age restrictions?",a:"Yes, you must be 18 years or older, or have parental consent, and be an active Ethio Telecom subscriber to compete for cash rewards."}]};if(this._showContactSupportForm){e.innerHTML=`
            ...
            `,this._bindSubScreenBack(e),document.getElementById("btn-back-help")?.addEventListener("click",()=>{this._audioManager.playClick(),this._showContactSupportForm=!1,this.render()}),document.getElementById("btn-submit-support")?.addEventListener("click",async()=>{this._audioManager.playClick();const l=document.getElementById("support-message")?.value.trim(),c=document.getElementById("support-category"),d=c?c.value:"General Feedback";if(!l){U.show(o.currentLocale==="am"?"እባክዎን ከማስገባትዎ በፊት መልእክት ያስገቡ።":o.currentLocale==="om"?"Maree ergamuu dura ergaa galchaa.":"Please enter a message before submitting.","warning");return}const g=document.getElementById("support-form-container");if(g){g.innerHTML=`
                    ...
                    `;const m=await ie.getInstance().createTicket(d,l),b=m.success?`EF-${m.ticketId.substring(0,8).toUpperCase()}`:"EF-"+Math.floor(1e5+Math.random()*9e5);g.innerHTML=`
                        <div style="text-align: center; padding: 16px;">
                            ...
                            <div style="font-size: var(--fds-font-xs); font-weight: 700; color: var(--fds-text-main); background: rgba(255,255,255,0.08); padding: 6px; border-radius: 6px; font-family: monospace; display: inline-block;">REF: ${b}</div>
                        </div>
                    `}});return}if(this._helpCategory){const l=this._faqsCache.length>0?this._faqsCache:n[this._helpCategory]||[],c=l.map((f,u)=>`
                <div class="glass-card" style="border-radius: 12px; margin-bottom: 12px; border-color: rgba(255,255,255,0.08); overflow: hidden;">
                    <div class="faq-header" data-idx="${u}" style="display: flex; justify-content: space-between; align-items: center; padding: 16px; cursor: pointer; background: rgba(255,255,255,0.02);">
                        <div style="font-size: var(--fds-font-sm); font-weight: 800; color: var(--fds-text-main);">${f.q}</div>
                    ...
                    <div class="faq-body" id="faq-body-${u}" style="max-height: 0; overflow: hidden; transition: max-height 0.2s ease-out; background: rgba(0,0,0,0.2);">
                        <div style="padding: 16px; font-size: var(--fds-font-sm); color: var(--fds-text-muted); line-height: 1.5;">${f.a}</div>
                    </div>
                </div>
            `).join(""),d=a.find(f=>f.id===this._helpCategory),g=d?d.name:this._helpCategory,m=`
                <div style="text-align: center; padding: 40px 16px;">
            ...
            `,this._bindSubScreenBack(e),document.getElementById("btn-back-help")?.addEventListener("click",()=>{this._audioManager.playClick(),this._helpCategory=null,this._faqsCache=[],this.render()}),document.getElementById("faq-search-input")?.addEventListener("input",f=>{const u=f.target.value.toLowerCase();e.querySelectorAll("#faq-list-wrapper > .glass-card").forEach(x=>{const k=(x.querySelector(".faq-header > div")?.textContent||"").toLowerCase(),A=(x.querySelector(".faq-body > div")?.textContent||"").toLowerCase();k.includes(u)||A.includes(u)?x.style.display="block":x.style.display="none"})}),e.querySelectorAll(".faq-header").forEach(f=>{f.addEventListener("click",u=>{this._audioManager.playClick();const v=u.currentTarget,x=v.getAttribute("data-idx"),k=e.querySelector(`#faq-body-${x}`),A=v.querySelector(".faq-icon");k&&A&&(k.style.maxHeight==="0px"||!k.style.maxHeight?(k.style.maxHeight=k.scrollHeight+"px",A.innerText="➖"):(k.style.maxHeight="0px",A.innerText="➕"))})});return}const r=a.map(l=>`
        ...
        `,this._bindSubScreenBack(e)}_goBack(){if(this._subScreen!==this._defaultSubScreen)this._subScreen=this._defaultSubScreen;else if(!(this._helpCategory!==null||this._showContactSupportForm)){this._onBack();return}this._helpCategory=null,this._showContactSupportForm=!1,this.render()}_bindSubScreenBack(e){w.bind(e,()=>{this._audioManager.playClick(),this._goBack()})}_maskPhone(e){let t=e.replace(/[^0-9+]/g,"");return t.startsWith("+")&&(t=t.substring(1)),t.startsWith("251")&&(t="251"+t.replace(/^0+/,"")),t.substring(0,4)+"****"+t.substring(t.length-2)}}class F{static _instance=null;constructor(){}static getInstance(){return F._instance||(F._instance=new F),F._instance}async getNotifications(e){if(!_.isOnline)return[];const t=h;if(!t)return[];try{const{data:{user:i}}=await t.auth.getUser();if(!i)return[];let a=t.from("notifications").select("*").or(`user_id.eq.${i.id},user_id.is.null`).order("created_at",{ascending:!1});e&&(a=a.eq("category",e));const{data:n,error:r}=await a;return r?(console.warn("[NotificationService] Error fetching notifications:",r),[]):n||[]}catch(i){return console.warn("[NotificationService] Failed to get notifications:",i),[]}}async getUnreadCount(){if(!_.isOnline)return 0;const e=h;if(!e)return 0;try{const{data:{user:t}}=await e.auth.getUser();if(!t)return 0;const{count:i,error:a}=await e.from("notifications").select("*",{count:"exact",head:!0}).or(`user_id.eq.${t.id},user_id.is.null`).eq("read",!1);return a?(console.warn("[NotificationService] Error fetching unread count:",a),0):i||0}catch(t){return console.warn("[NotificationService] Failed to get unread count:",t),0}}async markAsRead(e){if(!_.isOnline)return;const t=h;if(t)try{const{error:i}=await t.from("notifications").update({read:!0}).eq("id",e);i&&console.warn("[NotificationService] Error marking as read:",i)}catch(i){console.warn("[NotificationService] Failed to mark as read:",i)}}async markAllAsRead(){if(!_.isOnline)return;const e=h;if(e)try{const{data:{user:t}}=await e.auth.getUser();if(!t)return;const{error:i}=await e.from("notifications").update({read:!0}).or(`user_id.eq.${t.id},user_id.is.null`).eq("read",!1);i&&console.warn("[NotificationService] Error marking all as read:",i)}catch(t){console.warn("[NotificationService] Failed to mark all as read:",t)}}subscribeToNewNotifications(e){if(!_.isOnline)return()=>{};const t=h;if(!t)return()=>{};let i=null;return t.auth.getUser().then(({data:{user:a}})=>{if(!a)return;const n=h;n&&(i=n.channel(`public:notifications:user_id=eq.${a.id}`).on("postgres_changes",{event:"INSERT",schema:"public",table:"notifications"},r=>{const s=r.new;(s.user_id===a.id||s.user_id===null)&&e(s)}).subscribe())}),()=>{const a=h;i&&a&&a.removeChannel(i)}}}class mt{_uiManager;_audioManager;_onBack;_activeTab="all";_notifications=[];_unsubscribeRealtime=null;constructor(e,t,i){this._uiManager=e,this._audioManager=t,this._onBack=i,this._unsubscribeRealtime=F.getInstance().subscribeToNewNotifications(a=>{this._notifications.unshift(a),this.render()}),this._loadNotifications()}async _loadNotifications(){const e=F.getInstance();this._notifications=await e.getNotifications(),this.render()}render(){const e=this._uiManager.container,t=o.currentLocale,i=this._notifications.filter(l=>this._activeTab==="all"?!0:this._activeTab==="unread"?!l.read:l.category===this._activeTab),n=[{id:"all",label:{en:"All",am:"ሁሉም",om:"Hunda"}},{id:"unread",label:{en:"Unread",am:"ያልተነበቡ",om:"Kan Hin Dubbifamne"}},{id:"daily",label:{en:"Daily",am:"የዕለት",om:"Guyyaa"}},{id:"tournament",label:{en:"League",am:"ሊግ",om:"Liigii"}},{id:"rewards",label:{en:"Rewards",am:"ሽልማቶች",om:"Badhaasa"}},{id:"announcements",label:{en:"System",am:"ስርዓት",om:"Sirna"}},{id:"subscription",label:{en:"Billing",am:"ክፍያ",om:"Kaffaltii"}}].map(l=>{const c=l.id===this._activeTab,d=l.id==="unread"?this._notifications.filter(g=>!g.read).length:l.id==="all"?this._notifications.length:this._notifications.filter(g=>g.category===l.id).length;return`
            ...
            `}).join(""),r=i.length>0?i.map(l=>{const d={daily:"📅",tournament:"🏆",rewards:"🎁",announcements:"📢",system:"⚙️",subscription:"💳"}[l.category]||"🔔",g=t==="am"&&l.title_am?l.title_am:t==="om"&&l.title_om?l.title_om:l.title_en,m=t==="am"&&l.body_am?l.body_am:t==="om"&&l.body_om?l.body_om:l.body_en,b=new Date(l.created_at).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"});return`
        ...
        `,v=(S,L)=>M.renderCard(`<div style="display: flex; flex-direction: column;">${L}</div>`,S),x=(S,L)=>M.renderCard(`<div style="padding: 20px 16px 8px 16px;">${L}</div>`,S);let k="";a>0?k=x("VISUAL ANALYTICS",`
                ${f("Win Rate",r,"var(--fds-gold-primary)")}
                ${f("Overall Accuracy",l,"var(--fds-green-pitch)")}
            `):k=x("VISUAL ANALYTICS",`
            ...
            <div class="stadium-container ethio-bg-main" style="pointer-events: auto; overflow-y: auto; padding-bottom: 120px;">
                ...
                <div style="max-width: 600px; margin: 0 auto; padding: 24px 16px;">
                    ...
                    ${v("OVERVIEW",`
                        ...
                        ${u("Accuracy",`${l}%`)}
                        <div style="border-bottom: none;">${u("Points / Rank Point",`${b} XP`)}</div>
                    `)}
        ...
        `}_bindTabs(){document.querySelectorAll(".ach-tab").forEach(r=>{r.addEventListener("click",s=>{const c=s.currentTarget.getAttribute("data-tab");c&&c!==this._activeTab&&(this._audioManager.playClick(),this._activeTab=c,this._renderContent())})});const t=document.querySelectorAll(".ach-card"),i=document.getElementById("ach-detail-modal"),a=document.getElementById("ach-modal-content"),n=document.getElementById("btn-close-ach-modal");t.forEach(r=>{r.addEventListener("click",s=>{const c=s.currentTarget.getAttribute("data-id"),d=this._achievements.find(g=>g.id===c);if(d&&i&&a){this._audioManager.playClick();const g=o.currentLocale==="am"?d.titleAm:o.currentLocale==="om"?d.titleOm:d.titleEn,m=o.currentLocale==="am"?d.descriptionAm:o.currentLocale==="om"?d.descriptionOm:d.descriptionEn,b=Math.min(100,Math.round(d.progress/d.maxProgress*100)),y=d.isUnlocked?"linear-gradient(90deg, #4ADE80, #22C55E)":"linear-gradient(90deg, #FBBF24, #F59E0B)";a.innerHTML=`
                        ...
                        <div style="width: 100%; max-width: 300px; background: rgba(0,0,0,0.4); border-radius: 12px; padding: 16px; margin-bottom: 24px; border: 1px solid rgba(255,255,255,0.05);">
                            ...
                            <div class="ach-progress-bg" style="height: 8px; background: rgba(255,255,255,0.1); margin-bottom: 16px; margin-top: 0;">
                                <div class="ach-progress-fill" style="width: ${b}%; background: ${y};"></div>
                            </div>
        ...
        `,w.bind(e,()=>{this._audioManager.playClick(),this._onBack()})}}class wt{_uiManager;_audioManager;_onBack;_activeCategory=null;_faqsCache=[];constructor(e,t,i,a){this._uiManager=e,this._audioManager=i,this._onBack=a,window.ethioOnBackPress=()=>(this._audioManager.playClick(),this._activeCategory?(this._activeCategory=null,this._faqsCache=[],this.render()):this._onBack(),!0)}destroy(){window.ethioOnBackPress=null}render(){const e=this._uiManager.container,t='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,0.2)" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18l6-6-6-6"/></svg>',i=[{id:"account",name:"Account",icon:"👤"},{id:"subscription",name:"Subscription",icon:"💳"},{id:"gameplay",name:"Gameplay",icon:"⚽"},{id:"dailyChallenge",name:"Daily Challenge",icon:"📅"},{id:"tournament",name:"Tournament",icon:"🏆"},{id:"rewards",name:"Rewards",icon:"🎁"},{id:"technicalIssues",name:"Technical Issues",icon:"🔧"}],a={account:[{q:"How is my account created?",a:"Your account is automatically created when you authenticate with your Ethio Telecom mobile phone number. There is no password required."},{q:"Can I delete my account?",a:"To delete your account data, please contact Ethio Telecom customer service or submit a support ticket via the app."}],subscription:[{q:"What is Premium Subscription?",a:"Premium subscription gives you unlimited daily plays, full access to all leagues, and entry into the weekly cash prize draws for 2 Birr/day."},{q:"How do I pay for subscription?",a:"Subscription fees are automatically deducted from your Ethio Telecom airtime balance daily."}],gameplay:[{q:"How do I play a match?",a:"Read the question carefully and tap the correct option before the timer runs out. Fast answers score Goals, while incorrect ones are Saved by the goalkeeper!"},{q:"How does the match timer work?",a:"You have 30 seconds per question in Solo Matches, and 20 seconds in Live 1v1 Matches. Answering quicker increases your possession stat!"}],dailyChallenge:[{q:"What is the Daily Challenge?",a:"The Daily Challenge is a special daily set of 10 trivia questions on hot football topics. Completing it awards double reward coins and a 1.5x XP bonus!"},{q:"How many times can I play the Daily Challenge?",a:"You can play the Daily Challenge once per calendar day. It resets every night at midnight EAT."}],tournament:[{q:"How do tournaments work?",a:"Tournaments are knockout brackets held every weekend. Players register during the week and compete live in 1v1 match phases to progress."},{q:"What are the tournament entry requirements?",a:"Premium subscribers can enter tournaments for free. Basic and free players must pay a 100 coin registration fee."}],rewards:[{q:"What rewards can I win?",a:"You can win in-game coins, profile XP, custom football badges, and real cash prizes credited directly to your Ethio Telecom mobile account balance."},{q:"When are weekly prizes distributed?",a:"Weekly prizes are processed and sent every Monday at 10:00 AM EAT based on the final Sunday night division standings."}],technicalIssues:[{q:"The app is freezing. What should I do?",a:"Ensure you have a stable network connection (3G/4G/LTE/5G). Try refreshing the app page by swiping down, or clearing your mobile browser cache."}]};if(this._activeCategory){const s=this._faqsCache.length>0?this._faqsCache:a[this._activeCategory]||[],l=s.map((y,f)=>`
                <div class="glass-card faq-card" style="border-radius: 12px; margin-bottom: 12px; border: 1px solid rgba(255,255,255,0.08); background: rgba(15, 23, 42, 0.6); backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); overflow: hidden;">
                    <div class="faq-header" data-idx="${f}" style="display: flex; justify-content: space-between; align-items: center; padding: 16px; cursor: pointer; background: rgba(255,255,255,0.02);">
                    ...
                    <div class="faq-body" id="faq-body-${f}" style="max-height: 0; overflow: hidden; transition: max-height 0.25s ease-out; background: rgba(0,0,0,0.3);">
                        <div style="padding: 16px; font-size: 14px; color: var(--fds-text-dim); line-height: 1.6; font-weight: 600;">${y.a}</div>
                    </div>
                </div>
            `).join(""),c=i.find(y=>y.id===this._activeCategory),d=c?c.name:this._activeCategory,g=`
                <div style="text-align: center; padding: 40px 16px;">
                    <div style="font-size: 48px; margin-bottom: 16px; opacity: 0.5;">📋</div>
                    <div style="font-size: 16px; font-weight: 800; color: white; margin-bottom: 8px;">No FAQs Available</div>
            ...
            `,w.bind(e,()=>{this._audioManager.playClick(),this._activeCategory=null,this._faqsCache=[],this.render()}),document.getElementById("faq-search-input")?.addEventListener("input",y=>{const f=y.target.value.toLowerCase();e.querySelectorAll(".faq-card").forEach(v=>{const x=(v.querySelector(".faq-header > div")?.textContent||"").toLowerCase(),k=(v.querySelector(".faq-body > div")?.textContent||"").toLowerCase();x.includes(f)||k.includes(f)?v.style.display="block":v.style.display="none"})}),e.querySelectorAll(".faq-header").forEach(y=>{y.addEventListener("click",f=>{this._audioManager.playClick();const u=f.currentTarget,v=u.getAttribute("data-idx"),x=e.querySelector(`#faq-body-${v}`),k=u.querySelector(".faq-icon");x&&k&&(e.querySelectorAll(".faq-body").forEach(A=>{if(A!==x&&A.style.maxHeight!=="0px"){A.style.maxHeight="0px";const S=A.id.replace("faq-body-",""),L=e.querySelector(`.faq-header[data-idx="${S}"] .faq-icon`);L&&(L.innerHTML="➕")}}),x.style.maxHeight==="0px"||!x.style.maxHeight?(x.style.maxHeight=x.scrollHeight+"px",k.innerHTML="➖"):(x.style.maxHeight="0px",k.innerHTML="➕"))})});return}const n=i.map(s=>`
        ...
        `,w.bind(e,()=>{this._audioManager.playClick(),this._onBack()})}}const At=EventTarget.prototype.addEventListener;EventTarget.prototype.addEventListener=function(p,e,t){if(p==="click"){const i=e;e=async function(a){const n=a.currentTarget;if(n&&n.nodeType===Node.ELEMENT_NODE){if(n.hasAttribute("disabled")||n.hasAttribute("data-ethio-processing")){a.preventDefault(),a.stopImmediatePropagation();return}n.setAttribute("data-ethio-processing","true");const r=n.style.pointerEvents;n.style.pointerEvents="none";try{const s=i.call(this,a);s instanceof Promise&&await s}finally{setTimeout(()=>{n.removeAttribute("data-ethio-processing"),n.style.pointerEvents=r},300)}}else i.call(this,a)}}return At.call(this,p,e,t)};async function Et(){const p=new Ue;await p.initialize();const e=B.getInstance(p.saveManager),t=G.getInstance(),i=ae.getInstance(),a=new We(p.uiManager);a.registerGame(new et),q.getInstance().subscribeToBadgeUpdates(u=>{T.setBadge("profile",u)});const n=window;n.ethioAudio=p.audioManager,n.ethioSave=p.saveManager,n.ethioAuth=e,n.ethioCache=t,n.ethioEvents=i;let r={home:["home"],play:["play"],standings:["standings"],profile:["profile"]},s="home",l=null;try{window.history.replaceState({root:!0},""),window.history.pushState({trap:!0},"")}catch{}const c=async(u,v=!0)=>{if(l&&typeof l.destroy=="function"&&l.destroy(),p.audioManager.stopAllGameplaySounds(),l=null,v){const x=r[s]||[];x.length>0&&x[x.length-1]!==u&&x.push(u)}switch(u){case"home":T.setActiveTab("home"),s="home",t.setQuizActive(!1);const x=new at(p.saveManager,p.audioManager,p.uiManager,{onKickOff:async()=>{t.setQuizActive(!0),a.getRegisteredGames().find(V=>V.metadata.id==="football-quiz").setCompetition("walia-ibex"),r[s].push("quiz_game"),await a.launchGame("football-quiz")},onLiveMatch:()=>c("matchmaking"),onDailyChallenge:()=>{c("play_single_path",!1)},onCompetitions:()=>d("standings"),onLeaderboard:()=>d("standings"),onAchievements:()=>d("profile"),onAdminPanel:()=>c("admin"),onSettings:()=>c("settings"),onNotifications:()=>c("notifications"),onViewStats:()=>c("stats"),onMessages:()=>c("messages"),onCasualPlay:async()=>{const O=a.getRegisteredGames().find(V=>V.metadata.id==="football-quiz");O.setCompetition("all"),O.matchType="casual",r[s].push("quiz_game"),await a.launchGame("football-quiz")}});l=x,x.render();break;case"play":T.setActiveTab("play"),s="play",t.setQuizActive(!1);const k=new nt(p.uiManager,p.audioManager,{onCasualPlay:async O=>{const V=a.getRegisteredGames().find(Pe=>Pe.metadata.id==="football-quiz");V.setCompetition(O&&O!=="random"?O:"all"),V.matchType="casual",r[s].push("quiz_game"),await a.launchGame("football-quiz")}});l=k,k.render();break;case"standings":T.setActiveTab("standings"),s="standings",t.setQuizActive(!1);const A=new st(p.uiManager,p.saveManager,p.audioManager,m);l=A,await A.render();break;case"play_single_path":t.setQuizActive(!0);const S=await Q.getInstance().getTodayChallenge(),L=a.getRegisteredGames().find(O=>O.metadata.id==="football-quiz");!S.completed&&S.questions.length>0?(L.setCompetition(S.questions[0]?.category||"world-cup"),L.setPreloadedQuestions(S.questions),L.matchType="daily",L.dailyChallengeId=S.id,r[s].push("quiz_game"),await a.launchGame("football-quiz")):(de(()=>Promise.resolve().then(()=>Je),void 0).then(O=>O.Toast.show(o.currentLocale==="am"?"የዕለቱ ውድድር አልቋል! 내일 ይሞክሩ":"Daily challenge already completed! Come back tomorrow.","error")),t.setQuizActive(!1),d("home"));break;case"profile":T.setActiveTab("profile"),s="profile",t.setQuizActive(!1);const z=new lt(p.uiManager,p.saveManager,p.audioManager,{onAchievements:()=>c("achievements"),onStatistics:()=>c("stats"),onLeaderboard:()=>d("standings"),onSubscription:()=>c("subscription"),onMessages:()=>c("messages"),onSettings:()=>c("settings"),onHelp:()=>c("help"),onAbout:()=>c("about"),onPrivacy:()=>c("privacy"),onTerms:()=>c("terms"),onAwards:()=>c("awards"),onInvite:()=>c("invite"),onIdentity:()=>c("identity"),onFaq:()=>c("faq")});l=z,z.render();break;case"messages":t.setQuizActive(!1);const W=new dt(p.uiManager,p.audioManager,m);l=W,W.render();break;case"settings":t.setQuizActive(!1);const K=new ge(p.uiManager,p.saveManager,p.audioManager,m,"main");l=K,K.render();break;case"help":t.setQuizActive(!1);const oe=new ge(p.uiManager,p.saveManager,p.audioManager,m,"help");l=oe,oe.render();break;case"achievements":t.setQuizActive(!1);const se=new yt(p.uiManager,p.saveManager,p.audioManager,m);l=se,se.render();break;case"awards":t.setQuizActive(!1);const N=new bt(p.uiManager,p.audioManager,m);l=N,N.render();break;case"invite":t.setQuizActive(!1);const fe=new xt(p.uiManager,p.saveManager,p.audioManager,m);l=fe,fe.render();break;case"identity":t.setQuizActive(!1);const ve=new _t(p.uiManager,p.saveManager,p.audioManager,m);l=ve,ve.render();break;case"faq":t.setQuizActive(!1);const ye=new wt(p.uiManager,p.saveManager,p.audioManager,m);l=ye,ye.render();break;case"about":t.setQuizActive(!1);const be=new kt(p.uiManager,p.saveManager,p.audioManager,m);l=be,be.render();break;case"privacy":t.setQuizActive(!1);const xe=new ge(p.uiManager,p.saveManager,p.audioManager,m,"privacy");l=xe,xe.render();break;case"terms":t.setQuizActive(!1);const _e=new St(p.uiManager,p.saveManager,p.audioManager,m);l=_e,_e.render();break;case"notifications":t.setQuizActive(!1);const we=new mt(p.uiManager,p.audioManager,m);l=we,we.render();break;case"admin":t.setQuizActive(!1);const ke=new tt(p.uiManager,p.audioManager,m);l=ke,ke.render();break;case"matchmaking":t.setQuizActive(!1);const Se=new ct(p.uiManager,p.audioManager,p.saveManager,async O=>{n.ethioLiveMatchInfo=O,c("live_match")},m);l=Se,await Se.render();break;case"live_match":t.setQuizActive(!0);const le=n.ethioLiveMatchInfo;if(!le){m();return}const qe=await H.getInstance().fetchQuestionsByIds(le.questionIds,o.currentLocale),Ae=new ut(p.uiManager,p.audioManager,p.saveManager,le.liveMatchId,le.opponent,qe,m);l=Ae,Ae.startMatch();break;case"stats":t.setQuizActive(!1);const Ee=new ft(p.uiManager,p.saveManager,p.audioManager,m);l=Ee,Ee.render();break;case"subscription":t.setQuizActive(!1);const Le=new vt(p.uiManager,p.audioManager,m);l=Le,Le.render();break}},d=u=>{const v=r[u],x=v[v.length-1];if(s===u){if(x===u)return;r[u]=[u],c(u,!0);return}s=u,c(x,!0)};n.ethioReloadHome=()=>d("home"),n.ethioHandleBack=()=>{m()},n.ethioCloseGame=()=>{t.setQuizActive(!1);const u=r[s]||[];u.length>0&&(u[u.length-1]==="quiz_game"||u[u.length-1]==="match_stats")&&u.pop();const v=u.length>0?u[u.length-1]:s;c(v,!1)},n.ethioForceHome=()=>{t.setQuizActive(!1);const u=r[s]||[];u.length>0&&(u[u.length-1]==="quiz_game"||u[u.length-1]==="match_stats")&&u.pop(),r.home=["home"],s="home",c("home",!0)},i.on("RELOAD_CURRENT_VIEW",()=>{t.isQuizActive||(console.log("[Bootstrap] Reloading current view upon event trigger."),c(s,!1))}),document.addEventListener("visibilitychange",()=>{document.visibilityState==="visible"&&!t.isQuizActive&&(console.log("[Bootstrap] App resumed. Triggering background refresh for stale data."),i.emit("DATA_REFRESHED"))});const g=()=>{const u=navigator.onLine;let v=document.getElementById("ethio-offline-banner");u?(v&&(v.style.background="var(--fds-green-pitch)",v.innerHTML="<span>✅</span><span>Connection restored! Refreshing data...</span>",setTimeout(()=>{v?.remove()},2e3)),t.isQuizActive||(console.log("[Bootstrap] Network restored. Triggering reconnection data sync."),i.emit("NETWORK_RESTORED"),i.emit("RELOAD_CURRENT_VIEW"))):v||(v=document.createElement("div"),v.id="ethio-offline-banner",v.style.cssText=`
                ...
                `,v.innerHTML="<span>⚠️</span><span>No internet connection. Paused. Reconnecting...</span>",document.body.appendChild(v))};window.addEventListener("online",g),window.addEventListener("offline",g);const m=()=>{const u=r[s]||[];if(typeof window.ethioOnBackPress=="function"&&window.ethioOnBackPress())return;p.audioManager.playClick();const v=document.querySelector('#session-recovery-overlay, #ethio-exit-modal, #ethio-leave-modal, .glass-card-modal, [id*="modal"]');if(v){v.remove();return}if(t.isQuizActive){b();return}if(u.length>1){u.pop();const x=u[u.length-1];(x==="quiz_game"||x==="match_stats")&&u.pop();const k=u.length>0?u[u.length-1]:s;c(k,!1)}else s==="home"?y():d("home")},b=()=>{if(document.getElementById("ethio-leave-modal"))return;const v=document.createElement("div");v.id="ethio-leave-modal",v.style.cssText=`
        ...
        `,document.body.appendChild(v),document.getElementById("leave-btn-continue")?.addEventListener("click",()=>{p.audioManager.playClick(),v.remove()}),document.getElementById("leave-btn-leave")?.addEventListener("click",()=>{p.audioManager.playClick(),v.remove(),t.setQuizActive(!1);const x=r[s]||[];x.length>0&&x[x.length-1]==="quiz_game"&&x.pop();const k=x.length>0?x[x.length-1]:s;c(k,!1)})},y=()=>{if(document.getElementById("ethio-exit-modal"))return;const v=document.createElement("div");v.id="ethio-exit-modal",v.style.cssText=`
            position: fixed; top: 0; left: 0; width: 100vw; height: 100vh;
            background: rgba(2, 6, 23, 0.88); backdrop-filter: blur(16px);
            z-index: 99999; display: flex; align-items: center; justify-content: center;
            padding: 20px; box-sizing: border-box; pointer-events: auto;
        ...
        `,document.body.appendChild(v),document.getElementById("exit-btn-stay")?.addEventListener("click",()=>{p.audioManager.playClick(),v.remove()}),document.getElementById("exit-btn-confirm")?.addEventListener("click",()=>{p.audioManager.playClick(),v.remove(),window.navigator?.app?.exitApp?window.navigator.app.exitApp():window.Android?.exitApp?window.Android.exitApp():window.close()})};window.addEventListener("popstate",u=>{u.preventDefault();try{window.history.pushState({trap:!0},"")}catch{}m()}),window.addEventListener("keydown",u=>{(u.key==="Escape"||u.key==="Back")&&m()}),n.ethioReloadHome=()=>d("home"),n.ethioNavigateToTab=u=>d(u),n.ethioPlayAgain=async u=>{t.setQuizActive(!0),a.getRegisteredGames().find(x=>x.metadata.id==="football-quiz").setCompetition(u),r[s]||(r[s]=[s]),r[s].push("quiz_game"),await a.launchGame("football-quiz")},T.render(u=>{d(u)});let f=null;return e.subscribe(u=>{const v=u?.id!==f;if(f=u?.id||null,!u)console.log("[Bootstrap] User signed out. Invalidating cache."),t.clear(),T.hide(),new ot(p.uiManager,p.audioManager,e,()=>{}).render();else if(console.log("[Bootstrap] User authenticated. Refreshing profile & channels:",u.username),T.show(),ee.getInstance().initUserChannels(u.id),i.emit("PROFILE_UPDATED",u),v){$.getInstance().getActiveSession()&&$.getInstance().clearSession(),r={home:["home"],play:["play"],standings:["standings"],profile:["profile"]},s="home",c("home",!1);try{window.history.replaceState({root:!0},""),window.history.pushState({trap:!0},"")}catch{}}}),console.log("[Bootstrap] ⚽ Smart Caching & Refresh Strategy initialized."),p}async function Lt(){try{await Et()}catch(p){console.error(p);const e=document.createElement("div");e.style.color="red",e.style.position="absolute",e.style.top="10px",e.style.left="10px",e.style.backgroundColor="white",e.style.padding="10px",e.style.fontFamily="monospace",e.innerText=`Runtime Error: ${p.message||p}
