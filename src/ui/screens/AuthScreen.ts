        ...
        root.innerHTML = `
            ...
            ">
                ...
                <div style="
                    ...
                    text-align: center;
                ">
                    <h1 style="font-size: 28px; font-weight: 800; color: #111827; margin: 0 0 24px 0;">Sign In</h1>
                    ...
                    <div style="display: flex; align-items: stretch; margin-bottom: ${isOtpStep ? '24px' : '32px'}; border: 1px solid #D1D5DB; border-radius: 12px; overflow: hidden; background: #FFFFFF; opacity: ${isOtpStep ? '1' : '0.6'};">
                        <input type="text" id="otp-input" maxlength="6" placeholder="6-digit code" ${isOtpStep ? '' : 'disabled'} style="
                    ...
                    <div style="margin-top: 16px;">
                        <a href="#" style="color: #16A34A; text-decoration: underline; font-size: 14px; font-weight: 600;">Terms & Conditions</a>
                    </div>
